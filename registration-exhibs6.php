<?php
	...
	for($j = 1; $j <= $lmt; $j ++) {
		...
		if ($num_row > 0) {
			...
			echo "<script language='javascript'>window.location = ('registration-exhibs5.php?ret=retds4fu324rn_ed24d3it&en=" .$en . "&a=" .$a . "&assoc_name=" .$assoc_name."');</script>";
			exit;
		}
	...
	echo "<script language='javascript'>window.location = 'registration-exhibs7.php?en=$en&assoc_name=$assoc_name';</script>";
	exit;
?>