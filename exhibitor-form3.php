	...
	<div class="col-md-12">
		...
		<div class="portlet light bordered" id="registration_form_2">
			...
			<div class="portlet-body form">
				...
				<form action="exhibitor-form4.php?>" class="form-horizontal" name="reg_registration_form_2" id="reg_registration_form_2" method="post" onsubmit="return validate_registration_form_4();">
				                        ...
				                        <div class="col-md-12">
				                            ...
				                            <div class="portlet light bordered">
				                                ...
				                                <div class="portlet-body">
													...
													<?php if($qr_chk_exb_ans ['assoc_nm'] == $ASSOC_NAME_EXHIBITOR) { ?>
				                                    	...
				                                    	<table class="table table-striped table-bordered table-hover">
				                                            ...
				                                            <tbody>	
																...
																<?php }
																	...
																	if(!empty($qr_chk_exb_ans ['exhi_profile'])) { ?>
																...
																<?php if($qr_chk_exb_ans['booth_no'] != '') { ?>

				                                                <tr>

				                                                    <td> <strong>Booth No</strong> </td>

				                                                    <td> <?php echo $qr_chk_exb_ans['booth_no']; ?> </td>
				                                                ...
				                                                <tr>
				                                                    ...
				                                                    <td> <strong>Organisation Address 1</strong> </td>
				...
				<tr>
					...
					<td> 
						...
						<?php if(!empty($qr_chk_exb_ans['logo'])) {?>

							<a href="<?php echo $qr_chk_exb_ans['logo']; ?>" target="_blank">View Logo <i class="fa fa-eye"></i></a>
						...
						<div class="form-actions">
							...
							<div class="row">
								...
								<div class="col-md-offset-3 col-md-9">
									...
									<a href="exhibitor-form.php?rt=retds4fn324rn_ed24d3it" class="btn default">
