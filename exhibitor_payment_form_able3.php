		...
		<div class="portlet light bordered" id="registration_form_4">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Exhibitor at ABLE PAVILION
					</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="exhibitor_payment_form_able4.php" class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">
														...
														<table class="table table-striped table-bordered table-hover">
															<tbody>
																...
																<tr>
																	...
																	<td> <?php echo $qr_gt_user_data_ans_row['booth_size']; ?> </td>
																</tr>
																<tr>
																...
																<?php if($qr_gt_user_data_ans_row['user_type'] == 'ABLE StartUp Exhibitor') {?>
																<tr>
																	<td> <strong>Organisation Registration Certificate </strong> </td>
																	<td> <a href="<?php echo $qr_gt_user_data_ans_row['ci_certf']; ?>" target="_blank">Click Here to View</a> </td>
																</tr>
																<?php }?>
																<tr>
																...
																<tr>
																	...
																	<td> <?php echo $qr_gt_user_data_ans_row['website']; ?> </td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td> <?php echo $qr_gt_user_data_ans_row['cp_desig']; ?> </td>
																</tr>
																<?php /*
										                                            	<tr>
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									<a href="exhibitor_payment_form_able.php?rt=retds4fn324rn_ed24d3it" class="btn default">
