...
if ($ret == "retds4fu324rn_ed24d3it") {
    ...
    if ((!isset($_SESSION["vercode_reg"])) || ($_SESSION["vercode_reg"] == '')) {
        ...
        echo "<script language='javascript'>window.location=('registration-assoc.php');</script>";
        echo "<script language='javascript'>document.location=('registration-assoc.php');</script>";
        exit;
    }
...
/* $assoc_name = @$_GET['assoc_name'];
 if($assoc_name == 'STPI') {
 echo "<script language='javascript'>window.location = 'registration-assoc.php?assoc_name=SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI)';</script>";
 exit;
 } */
?>
	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if(date('Y-m-d H:i') >= '2019-11-15 19:00' && !empty($discountDetail)) {?>
				<form action="registration-assoc2.php<?php echo !empty($ret) ? '?ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_1" id="reg_registration_form_1" method="post" onsubmit="return validate_registration_form_2();">
