	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_2">
			...
			<div class="portlet-body form">
				<form action="speaker-profile2.php" class="form-horizontal" name="reg_registration_form_1"
					id="reg_registration_form_1" enctype="multipart/form-data" method="post"
					onsubmit="return validate_reg_registration_form_1();">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<div class="form-group">
										<label class="control-label col-md-3"> Select Your Session Track <span
												class="required"> * </span>
										</label>
										<div class="col-md-6">
											<select class="form-control" id="session_track" name="session_track"
												required>
												<option value=""> -Select Your Session Track- </option>
												<?php $sessTrackList = array(
													'TREND STAGE (IT, Deeptech & Trends)',
									...
									<div class="form-group">
										...
										<div class="col-md-2">
											<select class="form-control" id="speaker_title" name="speaker_title"
												required>
										...
										<div class="col-md-2">
											<input name="speaker_fname" type="text" class="form-control"
												id="speaker_fname" placeholder="First Name" required />
										</div>
										<div class="col-md-2">
											<input name="speaker_lname" type="text" class="form-control"
												id="speaker_lname" placeholder="Last Name" required />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6">
											<input name="speaker_desig" type="text" class="form-control" id="desig"
												required />
											<span class="help-block">(If you don't belong to any organization then write
												'Not Applicable')
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3"> Organisation <span class="required"> *
										</span>
									</label>
									<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input name="speaker_email_1" type="email" class="form-control"
											id="speaker_email_1" required />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-2">
										<input name="speaker_mob_cntry_code" type="text" class="form-control"
											id="speaker_mob_cntry_code"
											onkeyup="check_num(event,'speaker_mob_cntry_code')" maxlength="4"
											placeholder="Country Code" required />
									</div>
									<div class="col-md-4">
										<input name="speaker_mob" type="text" class="form-control" id="speaker_mob"
											onkeyup="check_num(event,'speaker_mob')" maxlength="10"
											placeholder="Mobile Number" required />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">LinkedIn Profile link<span class="required"> *
										</span>
									</label>
									<div class="col-md-6">
										<input name="linkedin_link" type="text" class="form-control " id="linkedin_link"
											required />
										<span class="help-block">Note: If you don't have linkedIn profile link then
											write as Not-Applicable</span>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<select class="form-control" name="speaker_country" id="country"
											required="required">
											<option value=""></option>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input name="speaker_photo" type="file" id="photo" required accept="image/*"
											onchange="checkFileType(this);" />
										<br>
										Note: <br>1. Photos dimension should be <strong>width:400px & height:
											400px</strong><br>2. Photos size should be <strong>less than 4MB</strong>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-6">
										<textarea rows="3" cols="" class="form-control" name="shrt_bgrphy_fl"
											id="shrt_bgrphy_fl" required></textarea>
										<span class="help-block">Total word count: <span id="display_count">0</span>
											words. Words left: <span id="word_left">80</span></span>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="well well-lg">
											<label class="control-label1 col-md-9">
												Would you be interested in exploring B2B Partnering possibilities
												through the Interlinx B2B Portal at BTS2025?</label>
											<div class="col-md-3">
												<div class="md-radio-inline">
													<div class="md-radio">
														<input type="radio" id="delegate_flag-yes" name="delegate_flag"
													...
													<div class="md-radio">
														<input type="radio" id="delegate_flag-no" name="delegate_flag"
											...
											<label>
												<i>Note: By selecting 'Yes,' you are committing to actively engage in
													B2B Partnering - InterlinX. This entails keeping your profile
													up-to-date, promptly responding to meeting and message requests, and
													honoring any meeting commitments.</i>
											</label>
										</div>
									</div>
									<?php /*?>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												<input name="vercode" type="text" class="form-control dips-name-textbox"
													id="vercode" maxlength="10" required />
												<input name="vercode_sp2" type="hidden"
													class="form-control dips-name-textbox" id="vercode_sp2"
													value="<?php echo $text; ?>" />
