...
if($res['assoc_name'] != ''){
	...
	if($res['assoc_name'] == 'France' ||$res['assoc_name'] == 'Australia' ||$res['assoc_name'] == 'Finland' ||$res['assoc_name'] == 'Denmark' ||$res['assoc_name'] == 'South Korea' ||$res['assoc_name'] == 'UK' ||$res['assoc_name'] == 'Sweden' ||$res['assoc_name'] == 'Netherlands' ||$res['assoc_name'] == 'Israel' ||$res['assoc_name'] == 'European Union' ||$res['assoc_name'] == 'Lithuania' ||$res['assoc_name'] == 'Germany' ||$res['assoc_name'] == 'Switzerland' ||$res['assoc_name'] == 'Japan' ||$res['assoc_name'] == 'South America/ Europe/Asia') {
		$label = 'GIA Partner';
	}
