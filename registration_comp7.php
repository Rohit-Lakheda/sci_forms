   ...
   <div class="col-md-12">
      <div class="portlet light bordered" id="registration_form_4">
         ...
         <div class="portlet-body form">
            <form action="registration_comp8.php?assoc_nm=<?php echo $assoc_nm . '&' . $cata_type;?>"  class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">
...
<script>
   ...
   function go_back() {
   	window.location=('registration_comp5.php?ret=retds4fu324rn_ed24d3it&<?php echo $cata_type;?>');
   }
