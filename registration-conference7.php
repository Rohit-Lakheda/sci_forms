  ...
  <div class="col-md-12">
    <div class="portlet light bordered" id="registration_form_4">
      ...
      <div class="portlet-body form">
        <form action="registration-conference8.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?>" class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">
...
<script>
  ...
  function go_back() {
  	window.location=('registration-conference5.php?ret=retds4fu324rn_ed24d3it&?en=<?php echo $en;?>&a=<?php echo $a;?>&assoc_name=<?php echo $assoc_name;?>');
  }
