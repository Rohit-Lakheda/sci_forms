<?php
	...
	{ 
		...
		if(!empty($assoc_name)) {
			echo "<script language='javascript'>window.location = 'registration-premium.php?en=$en&assoc_name=$assoc_name';</script>";
		} else {
			echo "<script language='javascript'>window.location = 'registration-premium.php?en=$en';</script>";
		}
		exit; 
	}
		...
		<div class="portlet light bordered" id="registration_form_3">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Delegate Registration Form for premium delegate
					</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="registration-premium6.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_3" id="reg_registration_form_3" method="post" onsubmit="return validate_registration_form_3();">
						...
						<div class="form-body">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									<table class="table table-hover1 table-bordered teriff-table main-tariff-table">
										<thead>
									...
									<table class="table table-hover1 table-bordered teriff-table col-md-7">
										<tbody>
											<tr bgcolor="#2fa0dd" style="color: #fff;">
											...
											<tr>
												<td colspan="10">
													- You can access the entire BTS Summit -Inaugural, Plenary Talks, Technical Sessions in IT, Start-up, Biotech, and GIA Tracks,  STPI IT Export Awards, Smart Bio Awards, and Start-up Unicorns Felicitation, Rural IT Quiz, Bio Quiz, and Biotech Posters etc.<br/>
													- B2B Partnering : (One 2 One business meetings can be organized by using the advanced partnering tool. It will allow you to arrange partnering meetings with all the premium delegates virtually. You can self-schedule meetings in advance and meet your potential business partners, collaborators, customers during the 3 days during the event.)<br/>
												</td>
											</tr>
										</tbody>
									</table>
									...
									<div class="form-group form-md-radios" id="pay">
										...
										<div class="col-md-9">
											<div class="md-radio indian-tariff">
												<input type="radio" id="gpay" name="paymode" class="md-radiobtn" value="Google pay" >
												<label for="gpay">
												<span></span>
											...
											<div class="md-radio-inline">
												<div class="md-radio indian-tariff">
													<input type="radio" id="Cc" name="paymode" class="md-radiobtn" value="Credit Card" >
													<label for="Cc">
													<span></span>
													<span class="check"></span>
...
<script>
    ...
    function go_back11() {
    	...
    	window.location=('registration-premium3.php?ret=retds4fu324rn_ed24d3it&en=' + en + a + assoc_nameurl2);
    }
</script>
