		...
		<div class="portlet light bordered" id="registration_form_1">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Bengaluru Skill 2019 Speaker Registration Form</span>
				</div>
			</div>
			<div class="portlet-body form">
				<?php if(date('Y-m-d H:i') <= '2019-11-20 20:00') {?>
				<form action="skill-speakers-registration2.php<?php echo !empty($ret) ? '?ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_1" id="reg_registration_form_1" method="post" enctype="multipart/form-data" onsubmit="return validate_registration()">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									<div class="form-group">
										<label class="control-label col-md-3"> Sector <span class="required"> * </span>
										</label>
										<div class="col-md-6">
											<select id="sector" name="sector" class="form-control" required="required" onchange="eventSessShow(this);" >
													<?php $countryList = array('Bengaluru Skill 2019'=>'Bengaluru Skill 2019');
									...
									<!-- <div class="form-group">
										...
										<div class="col-md-6">
										  <input type="text" class="form-control" placeholder="Session Title" name="speaker_session_title" id="speaker_session_title"  value="<?php if(isset($_SESSION['speaker_session_title'])) { echo $_SESSION['speaker_session_title']; }else{echo @$qr_gt_user_data_ans_row['speaker_session_title']; } ?>" required="required" />
										</div>
									</div> -->
									...
									<div class="form-group">
										...
										<div class="col-md-2"><input type="text" class="form-control" placeholder="First Name" name="speaker_fname" id="speaker_fname"  value="<?php if(isset($_SESSION['speaker_fname'])) { echo $_SESSION['speaker_fname']; }else{echo @$qr_gt_user_data_ans_row['speaker_fname']; } ?>" required="required"></div>
										<div class="col-md-2"><input type="text" class="form-control" placeholder="Middle Name" name="speaker_mname" id="speaker_mname" value="<?php if(isset($_SESSION['speaker_mname'])) { echo $_SESSION['speaker_mname']; }else{ echo @$qr_gt_user_data_ans_row['speaker_mname']; } ?>"></div>
										<div class="col-md-2"><input type="text" class="form-control" placeholder="Last Name" name="speaker_lname"  id="speaker_lname" value="<?php if(isset($_SESSION['speaker_lname'])) { echo $_SESSION['speaker_lname']; }else{ echo @$qr_gt_user_data_ans_row['speaker_lname']; } ?>"></div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Speaker Email <span class="dips-required"> * </span></label>
										<div class="col-md-6">
											<input type="email" class="form-control" name="speaker_email_1" id="speaker_email_1" value="<?php if(isset($_SESSION['speaker_email_1'])) { echo $_SESSION['speaker_email_1']; }else{ echo @$qr_gt_user_data_ans_row['speaker_email_1']; } ?>" required="required" />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control" name="speaker_org" id="speaker_org" value="<?php if(isset($_SESSION['speaker_org'])) { echo $_SESSION['speaker_org']; }else{ echo @$qr_gt_user_data_ans_row['speaker_org']; } ?>"  />
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">Speaker Designation <span class="required"> * </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" name="speaker_desig" id="speaker_desig" value="<?php if(isset($_SESSION['speaker_desig'])) { echo $_SESSION['speaker_desig']; }else{ echo @$qr_gt_user_data_ans_row['speaker_desig']; } ?>" required="required" />
										</div>
									</div>
									<!-- <div class="form-group">
										<label class="col-md-3 control-label">Profile Tag line</label>
										<div class="col-md-6">
											<input type="text" class="form-control" name="speaker_profile_tag_line" id="speaker_profile_tag_line" value="<?php if(isset($_SESSION['speaker_profile_tag_line'])) { echo $_SESSION['speaker_profile_tag_line']; }else{ echo @$qr_gt_user_data_ans_row['speaker_profile_tag_line']; } ?>" />
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<textarea name="para_desc_1" id="para_desc_1" rows="" cols="" class="form-control"  maxlength="750" onkeyup="totalCount();"><?php if(isset($_SESSION['para_desc_1'])) { echo $_SESSION['para_desc_1']; }else{ echo @$qr_gt_user_data_ans_row['para_desc_1']; } ?></textarea>
