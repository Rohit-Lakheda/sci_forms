		...
		<div class="portlet light bordered" id="enq_form_1">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> FREE Business Exhibition Visitor Registration
						Form
					</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form id="visitor_form1" name="form1" class="form-horizontal" method="post"
					action="visitor_pass_form2.php?assoc_nm_vp=<?php echo $temp_assoc_nm_vp; ?>"
					onsubmit="return  validate_vpass('<?php echo $EVENT_NAME; ?>');">
						...
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-3"><input type="text" class="form-control" placeholder="Name"
										name="fname" type="text" id="fname" maxlength="100" required="required"></div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Email Address <span class="dips-required"> *
									</span></label>
								<div class="col-md-5">
									<input class="form-control" name="email" type="email" id="email" maxlength="150"
										required />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-3 control-label">LinkedIn Profile <span class="dips-required"> *
									</span></label>
								<div class="col-md-5">
									<input class="form-control" name="linkedin" type="text" id="linkedin" required />
								</div>
							</div>
							<!-- <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-5" style="margin-top: -20px;">
									<span type="tel" id="mobileCountryCode"
									...
									<input name="fone" type="text" id="fone" class="form-control" maxlength="20"
										required onkeyup="check_num(event, 'fone');" style="padding-left: 92px;" />
								</div>
							</div>
							<!-- <div class="form-group">
							...
							<div class="form-group">
								<label class="control-label col-md-3"> Purpose of Visit? <span class="required"> *
									</span></label>
								<div class="col-md-9">
											...
											<div class="md-checkbox-inline">
												...
												for ($index = $index; $index < $length; $index++) {
													...
													<div class="md-checkbox">
														<input type="checkbox" name="purpose<?php echo $id; ?>"
															id="purpose<?php echo $id; ?>"
															value="<?php echo $VISITOR_WNT_INFO_ARR[$index]; ?>"
															class="md-check" <?php echo $checked; ?> 		<?php if ($VISITOR_WNT_INFO_ARR[$index] == 'Other') { ?>onclick="show_othr_fun('purpose<?php echo $id; ?>');" <?php } ?>>
														<label for="purpose<?php echo $id; ?>">
															<span></span>
															<span class="check"></span>
															<span class="box"></span>
															<?php echo $VISITOR_WNT_INFO_ARR[$index]; ?></label>
													</div>
													<?php if ($VISITOR_WNT_INFO_ARR[$index] == 'Other') { ?>
														<span class="" id="div_enq_other"
															style="display: none; margin-top: -42px; width: 35%; margin-left: 77px;">
															<input name="other_v" id="other_v" class="form-control"
																placeholder="Other" type="text">
														</span>
													<?php }
												} ?>
											</div>
							...
							<div class="form-group">
								<label class="control-label col-md-3">Do You Wish to Receive Info from
									<?php echo $EVENT_NAME; ?>?<span class="required"> * </span> </label>
								<div class="col-md-9">
									<div class="md-radio-inline">
										<div class="md-radio">
											<input type="radio" id="feedback1" name="feedback" class="md-radiobtn"
												value="Yes" checked="checked" required="required">
											<label for="feedback1">
												<span></span>
												<span class="check"></span>
										...
										<div class="md-radio">
											<input type="radio" id="feedback2" name="feedback" class="md-radiobtn"
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="input-group">
										<input name="vercodevp" class="form-control" id="vercodevp" maxlength="10"
											required="" autocomplete="off" type="text">
										<input name="test" id="test" value="<?php echo $_SESSION["vercodevp"]; ?>"
											type="hidden">
										<span class="input-group-addon"
											style="background-image: url('images/verify_img_bg.JPG'); text-align: center; font-size: 32px; padding: 0 15px 1px;"><?php echo $_SESSION["vercodevp"]; ?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-offset-2 col-md-8">
								<div class="note note-success">
									<p><strong>Note:</strong> <br />
										<strong>Please carry your business card during your visit to the
											exhibition.</strong><br />
										For any additional information or clarification, contact us on <br />
										<?php ?>Event Secretariat: <?php echo $EVENT_SECRT_ADDR; ?><br />
										<?php ?>
										Email: <a href="mailto:<?php echo $EVENT_ENQUIRY_EMAIL; ?>"
											target="_blank"><?php echo $EVENT_ENQUIRY_EMAIL; ?></a> <br />
									</p>
								</div>
							</div>
						</div>
