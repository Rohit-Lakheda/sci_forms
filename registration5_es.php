...
$assoc_name = mysqli_real_escape_string($link,htmlspecialchars(@$_GET['assoc_name']));
	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_3">
			...
			<div class="portlet-body form">
				<form
					action="registration6_es.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name']; ?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>"
					class="form-horizontal" name="reg_registration_form_3" id="reg_registration_form_3" method="post"
					onsubmit="return validate_registration_form_3();">
						...
						<div class="form-body">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									<table class="table table-hover1 table-bordered teriff-table main-tariff-table hide"
										style="display: none;">
										<thead>
										...
										<tbody>
											<tr class="" style="background-color: #e1e1e1;">
												...
												<td colspan="3" class="align-td">Conference Delegate<br />(Access to
													entire summit)</td>
											...
											<tr class="indian-tariff" style="background-color: #e1e1e1;">
												<?php /*?><td colspan="2" class="align-td">All Access</td>*/ ?>
												<td colspan="3" class="align-td">Premium Delegate<br />(B2B Partnering +
													Access to entire summit)</td>
											...
											<tr class="international-tariff"
												style="background-color: #e1e1e1;display: none;">
												<?php /*<td colspan="2" class="align-td">All Access</td>*/ ?>
												<td colspan="2" class="align-td">International Premium
													Delegate<br />(B2B Partnering + Access to entire summit)</td>
									...
									<table class="table table-hover1 table-bordered teriff-table hide"
										style="display: none;">
										<tbody>
											<tr bgcolor="#2fa0dd" style="color: #fff;">
											...
											<tr bgcolor="#2fa0dd" style="color: #fff;">
												<td width="20%" style="font-size: 14px;font-weight: 600px;">Category
												</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">One 2 One
													Business Meetings**</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">Inaugural/
													Keynote/ Plenary/Cultural Programme</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">Special
													Programme India - US Conclave Bengaluru Next</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">Conference/
													On Demand Sessions</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">
													International Exhibition</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">Industry
													Awards IT/Biotech/ Start-ups</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">Quiz
													Competition IT/Biotech</td>
												<td width="10%" style="font-size: 14px;font-weight: 600px;">Biotech
													Posters Walkway of Discovery</td>
											</tr>
											...
											<tr>
												<td colspan="10">
													- **One 2 One business meetings will be organised by using the
													advanced partnering tool will allow you to arrange partnering
													meetings virtually. You can self-schedule meetings in advance and
													meet your potential business partners, collaborators, customers
													during the 3 full days of partnering during the event.<br />
												</td>
											</tr>
										</tbody>
									</table>
									...
									<p><strong>Important:</strong> Please use a
										unique email address for each delegate to ensure you receive
										all badges correctly.</p>
									<?php for ($i = 1; $i <= $lmt; $i++) { ?>
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Job Title <span class="dips-required"> *
												</span></label>
											<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Mobile Number <span class="dips-required">
													* </span></label>
											<div class="col-md-6" style="margin-top: -18px;">
												...
												<input class="form-control" name="cellno<?php echo $i; ?>" type="text"
													id="cellno<?php echo $i; ?>" maxlength="10"
													value="<?php echo !empty($mobile[1]) ? @$mobile[1] : ''; ?>" required
													onkeyup="check_num(event, 'cellno<?php echo $i; ?>');"
										...
										<div class="form-group hide" style="display: none;">
											<label class="control-label col-md-3"> Delegate Category <span class="required">
												</span>
											</label>
											<div class="col-md-6" style="margin-top: 8px;">
												<?php
												if ($qr_gt_user_data_ans_row['nationality'] == 'Indian Organization') {
													// Check if all 3 days are non-empty
													if (!empty($qr_gt_user_data_ans_row['day1']) && !empty($qr_gt_user_data_ans_row['day2']) && !empty($qr_gt_user_data_ans_row['day3'])) {
														?>
														<input type="hidden" id="catagory<?php echo $i; ?>"
															name="catagory<?php echo $i; ?>" value="Full Delegate" />
														Full Delegate
														<?php
													} else {
														// If any day is empty
														?>
														<input type="hidden" id="catagory<?php echo $i; ?>"
															name="catagory<?php echo $i; ?>" value="Single Day Delegate" />
														Single Day Delegate
														<?php
													}
												}
									...
									<div class="form-group form-md-radios" id="pay">
										...
										<div class="col-md-9">
											<div class="md-radio-inline">
												<?php if ($qr_gt_user_data_ans_row['nationality'] == "Indian Organization") {
													...
													<div class="md-radio indian-tariff">
														...
														<label for="Cc">
															...
															<span class="box"></span> CCAvenue Payment - Credit Card / Debit
															Card / Net Banking / Google pay / Phonepe / Paytm
														</label>
														<span class="help-block indian-tariff">Please Note:
															<?php echo $CC_IND_PROCESSING_CHARGE_PER; ?>% processing charges
															is applicable for CCAVenue payment mode.</span>
													</div>
												...
												<?php if ($qr_gt_user_data_ans_row['nationality'] == "International Organization") {
													?>
													<div class="md-radio international-tariff">
														<input type="radio" id="paypal" name="paymode" class="md-radiobtn"
