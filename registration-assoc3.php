<?php
	...
	{  
		...
		if(!empty($assoc_name)) {
			...
			echo "<script language='javascript'>window.location = 'registration-assoc.php?en=$en';</script>";
		}
		exit; 
	}
	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_2">
			...
			<div class="portlet-body form">
				<form action="registration-assoc4.php?a=<?php echo $a;?>" class="form-horizontal" name="reg_registration_form_2" id="reg_registration_form_2" method="post" onsubmit="return validate_registration_form_2();">
...
<script>
    ...
    function go_back11() {
    	...
    	if(assoc_name != '') {
    		...
    		window.location = ('registration-assoc.php?ret=retds4fu324rn_ed24d3it' + assoc_nameurl + '&en=' + en);
    	} else {
    		if(a != '') {
    			a = '&a=' + a;		
    		}
    		window.location = ('registration-assoc.php?ret=retds4fu324rn_ed24d3it' + a + assoc_nameurl + '&en=' + en);
    	}
