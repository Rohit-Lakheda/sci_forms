...
if (($temp_exhi_name == "") || ($temp_addr1 == "") || ($temp_city == "")  || ($temp_state == "")  || ($temp_zip == "") || ($temp_email == "")) {
	...
	echo "<script language='javascript'>window.location = 'exhibitor_payment_form.php?rt=retds4fn324rn_ed24d3it';</script>";
	exit;
}
...
mysqli_query($link,"INSERT INTO " . $EVENT_DB_FORM_EXHIBITOR_DIR_PAYMENT_TBL_DEMO . "(sector,subsector,exhibitor_name,reg_id,reg_date,reg_time,ci_certf)" .
	" VALUES('$temp_exhi_sector','$temp_exhi_subsector', '$temp_exhi_name','$reg_id','$temp_reg_date','$temp_reg_time','$filePath') ") or die(mysqli_error($link));
