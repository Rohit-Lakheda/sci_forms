...
function sendPaymentData($tinNo, $link) {
    ...
    $sql = "SELECT * FROM `it_2024_exhibitors_dir_payment_tbl` WHERE tin_no = '$escapedTinNo'";
    // echo $sql;
    // die;
    // $sql = "SELECT * FROM `it_2024_reg_tbl` WHERE tin_no = '$escapedTinNo'";
    ...
    $apiURL = 'https://bengalurutechsummit.com/web/it_forms/api/api_webhook.php';
...
$tin = "TIN-BTS2024-EXH-87080";
sendPaymentData($tin, $link);

//close dbcon with custom close function
