...
// $postData = json_decode(file_get_contents('php://input'), true);
    ...
    if ($postData) {
        ...
        //escape html string
        mysqli_real_escape_string($link,$exhibitor_name);

        // $exhibitor_name = htmlspecialchars($exhibitor_name);
        ...
        mysqli_real_escape_string($link,$exhi_profile);
        //trim html character from this
        // $exhi_profile = htmlspecialchars($exhi_profile);
        $booth_no = $postData['booth_no'];
        $fascia_name = $postData['fascia_name'];
        mysqli_real_escape_string($link,$fascia_name);
        //trim html character from this
        // $fascia_name = htmlspecialchars($fascia_name);
