	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d') <= '2024-07-30') { ?>
					<form action="exhibitor_payment_form_op2.php<?php echo !empty($ret) ? '?rt=' . $ret : ''; ?>" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" onsubmit="return validate_ex();">
									...
									<div class="tab-pane active">
												...
												<table class="table table-bordered tariff-table" style="border: thin solid #dddddd; box-shadow: 5px 5px 5px 0 rgb(219, 219, 219);">
													<thead>
														<tr bgcolor="#E39101" style="color: #fff;">
															<th colspan="6" style="text-align: center;">Exhibition Tariff</th>
														</tr>
														<tr bgcolor="#2fa0dd" style="color: #fff;">
															<th class="align-td" style="text-align:center;" align="center">OPTION</th>
															<th class="align-td" align="center" style="text-align:center;">BOOTH SPACE</th>
															<th class="align-td" align="center" style="text-align:center;">PRICE / SQM IN INR</th>
													...
													<tbody>
														<tr class="indian-tariff" style="background-color: #e1e1e1;">
															<td class="align-td" align="center" style="display:none1;">1</td>
										...
										<div class="main-form">
											<div class="form-group">
												<label class="control-label col-md-3"> Select Booth Space <span class="required"> * </span> </label>
												<div class="col-md-6">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<select id="booth_size" name="booth_size" class="form-control" required="required">
														<option value="">-- Select --</option>
													</select>
												</div>
											</div>
											...
											<?php
											$countryList = array(
												'9' => '9sqm (9sqm x Rs. 12,000) Raw Space = 1,08,000 + 18% GST',
												'9s' => '9sqm (9sqm x Rs. 13,000) Shell Space = 1,17,000 + 18% GST',
												'15' => '15sqm (15sqm x Rs. 12,000) Raw Space = 1,80,000 + 18% GST',
												'15s' => '15sqm (15sqm x Rs. 13,000) Shell Space = 1,95,000 + 18% GST',
												'18' => '18sqm (18sqm x Rs. 12,000) Raw Space = 2,16,000 + 18% GST',
												'18s' => '18sqm (18sqm x Rs. 13,000) Shell Space = 2,34,000 + 18% GST',
												'27' => '27sqm (27sqm x Rs. 12,000) Raw Space = 3,24,000 + 18% GST',
												'27s' => '27sqm (27sqm x Rs. 13,000) Shell Space = 3,51,000 + 18% GST',
												'36' => '36sqm (36sqm x Rs. 12,000) Raw Space = 4,32,000 + 18% GST',
												'36s' => '36sqm (36sqm x Rs. 13,000) Shell Space = 4,68,000 + 18% GST',
												'48' => '48sqm (48sqm x Rs. 12,000) Raw Space = 5,76,000 + 18% GST',
												'48s' => '48sqm (48sqm x Rs. 13,000) Shell Space = 6,24,000 + 18% GST',
												'54' => '54sqm (54sqm x Rs. 12,000) Raw Space = 6,48,000 + 18% GST',
												'54s' => '54sqm (54sqm x Rs. 13,000) Shell Space = 7,02,000 + 18% GST',
												'72' => '72sqm (72sqm x Rs. 12,000) Raw Space = 8,64,000 + 18% GST',
												'72s' => '72sqm (72sqm x Rs. 13,000) Shell Space = 9,36,000 + 18% GST',
												'100' => '100sqm (100sqm x Rs. 12,000) Raw Space = 12,00,000 + 18% GST',
												'100s' => '100sqm (100sqm x Rs. 13,000) Shell Space = 13,00,000 + 18% GST',

												'108' => '108sqm (108sqm x Rs. 12,000) Raw Space = 12,96,000 + 18% GST',
												'108s' => '108sqm (108sqm x Rs. 13,000) Shell Space = 14,04,000 + 18% GST',

												'120' => '120sqm (120sqm x Rs. 12,000) Raw Space = 14,40,000 + 18% GST',
												'120s' => '120sqm (120sqm x Rs. 13,000) Shell Space = 15,60,000 + 18% GST',

												'144' => '144sqm (144sqm x Rs. 12,000) Raw Space = 17,28,000 + 18% GST',
												'144s' => '144sqm (144sqm x Rs. 13,000) Shell Space = 18,72,000 + 18% GST',

												'216' => '216sqm (216sqm x Rs. 12,000) Raw Space = 25,92,000 + 18% GST',
												'216s' => '216sqm (216sqm x Rs. 13,000) Shell Space = 28,08,000 + 18% GST',

												'240' => '240sqm (240sqm x Rs. 12,000) Raw Space = 28,80,000 + 18% GST',
												'240s' => '240sqm (240sqm x Rs. 13,000) Shell Space = 31,20,000 + 18% GST',

												'264' => '264sqm (264sqm x Rs. 12,000) Raw Space = 31,68,000 + 18% GST',
												'264s' => '264sqm (264sqm x Rs. 13,000) Shell Space = 34,32,000 + 18% GST',

												'270' => '270sqm (270sqm x Rs. 12,000) Raw Space = 32,40,000 + 18% GST',
												'270s' => '270sqm (270sqm x Rs. 13,000) Shell Space = 35,10,000 + 18% GST',

												'360' => '360sqm (360sqm x Rs. 12,000) Raw Space = 43,20,000 + 18% GST',
												'360s' => '360sqm (360sqm x Rs. 13,000) Shell Space = 46,80,000 + 18% GST',

												'450' => '450sqm (450sqm x Rs. 12,000) Raw Space = 54,00,000 + 18% GST',
												'450s' => '450sqm (450sqm x Rs. 13,000) Shell Space = 58,50,000 + 18% GST'
											);
											?>
													...
													<select id="sector" name="sector" class="form-control" required="required">
														...
														<?php } else { ?>
															...
															<?php $countryList = array(
																'OEMs & Body Builders' => 'OEMs & Body Builders',
																'Aggregators' => 'Aggregators',
																'Technology & Infotainment' => 'Technology & Infotainment',
																'Accessories' => 'Accessories',
																'Paint & Glass' => 'Paint & Glass',
																'Tyres' => 'Tyres',
																'Component' => 'Component',
																'BFSI & Fintech' => 'BFSI & Fintech',
																'Electric Mobility' => 'Electric Mobility',
																'After Market' => 'After Market',
																'Tourism' => 'Tourism',
																'Central Government' => 'Central Government',
																'Tours and Travels' => 'Tours and Travels',
																'State Gov, STUs And SPVs' => 'State Gov, STUs And SPVs',
																'Car Mfg.' => 'Car Mfg.',
																'AC' => 'AC',
																'Oil & Lube' => 'Oil & Lube',
																'Seats' => 'Seats',
																'Start Up Pavilion' => 'Start Up Pavilion',
																'Transport Dep' => 'Transport Dep'
															);
											...
											*/ ?>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<select id="delegate_type" name="delegate_type" class="form-control" required="required">
														<option value="">-- Select --</option>
										...
										<div class="form-group">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">Invoice Address <span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="text" name="addr1" id="addr1" rows="" cols="" required="required" class="form-control" value="<?php echo @$_SESSION['sess_addr1']; ?>">
												</div>
											</div>
											<div class="form-group">
												<label class="control-label col-md-3">City, State, Postal Code<span class="dips-required"> * </span></label>
												<div class="col-md-2"><input type="text" class="form-control" name="city" id="city" value="<?php echo $_SESSION['sess_city']; ?>" placeholder="City" onkeyup="check_char(event,'city');" required="required" /></div>
												<div class="col-md-2"><input type="text" class="form-control" name="state" id="state" value="<?php echo $_SESSION['sess_state']; ?>" placeholder="State" required="required" onkeyup="check_char(event,'state');" /></div>
												<div class="col-md-2"><input type="text" class="form-control" name="zip" id="zip" value="<?php echo $_SESSION['sess_zip']; ?>" placeholder="Postal Code" required="required" /></div>
											</div>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="pan_number" id="pan_number" value="<?php echo strtoupper($_SESSION['pan_number']); ?>" maxlength="12" required oninput="this.value = this.value.toUpperCase()"/>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" class="form-control" name="cp_desig" id="cp_desig" value="<?php echo @$_SESSION['sess_cp_desig']; ?>" required="required" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">Sales Executive Name <span style="font-size:11px;">&nbsp;(From Prawaas Team)</span> <span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="sales_exec" id="sales_exec" value="<?php echo @$_SESSION['sales_exec']; ?>" required="required" />
												</div>
											</div>
										...
										<h4>Please enter details of stall manning people 2:</h4>
											...
											<input type="hidden" id="Cc" name="paymode" class="md-radiobtn" value="Credit Card" checked>
											<?php /*?>
