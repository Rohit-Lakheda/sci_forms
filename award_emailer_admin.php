		...
		<form id='form1' action='' method='post'>
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
			  ...
			  <a href='".$EVENT_WEBSITE_LINK."' target='_blank'><img src='".$EVENT_LOGO_LINK."' title='".$EVENT_NAME."' alt='".$EVENT_NAME."'  border='0' align='middle'/></a>
			  </td>
            </tr>
            <tr> 
              <td width='125' height='10' valign='top' class='style4'></td>
              <td colspan='3' valign='top' class='style4'><strong>".$EVENT_NAME." ".$EVENT_YEAR." RSVP Confirmation.</strong></td>
            </tr>
