...
if (empty($tin_no)) {
  if ((!isset($_SESSION["vercode_reg"])) || ($_SESSION["vercode_reg"] == '')) {
    ...
    echo "<script language='javascript'>document.location=('registration_es.php');</script>";
    exit;
  }
}
                ...
                <div class="tab-pane active">
                                ...
                                <table class="table well table-condensed table-striped">
                                  <tbody>
                                    <tr>
                                      ...
                                      <?php } else { ?>
                                          <p>
                                            Please send your Cheque/DD in favour of <?php echo $EVENT_CHEQUE_PAYBLE_AT_NAME; ?>
                                            payable at <?php echo $EVENT_CHEQUE_PAYBLE_AT; ?>.<br />
                                            Along with the copy of your registration receipt and send to<br />
                                ...
                                <tbody>
                                  <tr>
                                    <td style='color: rgb(103, 144, 231);'>
                                      <strong><?php echo $qr_gt_user_data_ans_row['user_type']; ?></strong></td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                  ...
                  <div class="note note-danger">
                    ...
                    <p>Please DO NOT print this page. This page print not accepted in event.
                      <br />You need to click on <strong>Print</strong> button OR <a class="alert-link"
                        href="reg_pay_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no']; ?>" target="_blank">Click
                        here </a>to generate printable receipt.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="form-actions">
              <div class="row">
                <div class="col-md-offset-3 col-md-9">
                  <a href="reg_pay_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no']; ?>"
                    class="btn blue sbold uppercase green-jungle" type="submit" name="make_payment" value="1">
