		...
		<form id='form1' action='' method='post'>
		  <table width='100%'  cellspacing='0' cellpadding='0'>
            ...
            <tr>
              ...
              <td width='98%'  align='left'><p class='style3'>Dear ".$nm.",<br />
               We appreciate for the time spent to complete the  process of Speaker information submission. 
		 We have received your information and shall get back to you if we need any more information.<br />
                Thanking You,</p>
