...
$str_exb_admin = $str_exb_admin . "<tr>
  ...
  if($temp_booth_area == "Startup Booth"){
    $str_exb_admin = $str_exb_admin .  "<tr>
    <td align='left' valign='top' class='text'>Booth Type </td>
    <td align='center' valign='middle' class='text'>:</td>
    <td align='left' valign='top' class='text'>&nbsp;".$temp_booth_area." </td>
  </tr> ";
  }
  else{
...
$str_exb_admin = $str_exb_admin . "
 ...
 $str_exb_admin .= " <tr>
  ...
  <tr>
    <td align='left' valign='top' class='text'>Exhibitor Sector </td>
    <td align='center' valign='top' class='text'>:</td>
    <td align='left' valign='top' class='text'>&nbsp;".str_replace('#', ',', $exhi_profile)."</td>
  </tr>
  ...
  <tr>
    <td colspan='3' align='left' valign='top' class='text'><table width='100%' border='1' cellspacing='0' cellpadding='0'>
      <tr>
      ...
      </tr>";//<td align='left' valign='top'><strong>Category</strong></td>
	...
	if( ($title!="") && ($fname!="") && ($lname!="") && ($desig!="") ){
	 $str_exb_admin =  $str_exb_admin."<tr>
		...
		<td align='left' valign='top'>".$mob."</td>
        
      </tr>";//<td align='left' valign='top'>".$category."</td>
	  } 
	}
      $str_exb_admin =  $str_exb_admin."
    </table></td>
