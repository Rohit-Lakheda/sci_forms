<?php
	...
	if($qr_gt_user_data_ans_row['user_type'] == "IBioM StartUps Exhibitor") {
		$ex_iBIOMLOGO = true;
	}
	                            ...
	                            <div class="portlet light bordered" id="registration_form_4">
	                                <div class="portlet-title">
	                                    <div class="caption">
											...
											<?php if($qr_gt_user_data_ans_row['user_type'] == "Startup Exhibitor") {
													echo 'Exhibitor at Startup Zone	';
												} else if($qr_gt_user_data_ans_row['user_type'] == "Able Exhibitor") {
													echo 'Exhibitor at ABLE PAVILION';
												} else if($qr_gt_user_data_ans_row['user_type'] == "IBioM StartUps Exhibitor") {
													echo 'Exhibitor at IBioM StartUps';
												}?>
