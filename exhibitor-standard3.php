	                            ...
	                            <div class="portlet light bordered" id="registration_form_4">
	                                <div class="portlet-title">
	                                    <div class="caption">
	                                        ...
	                                        <span class="caption-subject font-red bold uppercase">Standard Exhibitor Delegate registration form</span>
	                                    </div>
	                                </div>
	                                <div class="portlet-body form">
	                                    <form action="exhibitor-standard4.php" class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">
															                              ...
															                              <thead>
															                                <tr>
															                                  ...
															                                  <th>
															                                    ...
															                                    Amount (<?php echo $del_detail['amt_ext'];?>) 
															                                  </th><?php */?>
															                                </tr>
															                              </thead>
															                              <tbody>
															                                <?php for($i=1; $i<=$del_detail['sub_delegates']; $i++) { ?>
															                                <tr>
															                                  <td>
															                                    <?php echo $i; ?>
															                                  </td>
															                                  <td>
															                                    <?php echo $del_detail['title'.$i]." ".$del_detail['fname'.$i]." ".$del_detail['lname'.$i]; ?>
															                                  </td>
															                                  <td>
															                                    <?php echo $del_detail['email'.$i]; ?>
															                                  </td>
															                                  <td>
															                                    <?php echo $del_detail['cellno'.$i]; ?>
															                                  </td>
															                                 <td>
															                                    <?php echo $del_detail['cata'.$i]; ?>
															                                  </td>
															                                   <?php /*?>
															                                  <td>
															                                    <?php echo $del_detail['job_title'.$i]; ?>
															                                  </td><td>
															                                    <?php echo $del_detail['amt'.$i]; ?>
															                                  </td><?php */?>
															                                </tr>
															                                <?php }?>
															                              </tbody>
	                                            ...
	                                            <div class="form-actions">
	                                                <div class="row">
	                                                    <div class="col-md-offset-3 col-md-9">
	                                                    	<a href="exhibitor-standard.php?rt=retds4fn324rn_ed24d3it" class="btn default">
