	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if(date('Y-m-d H:i') <= '2019-11-20 17:00') {?>
										...
										<div class="col-md-9">
											<div class="md-radio-inline">
												<div class="md-radio <?php if($assoc_name == 'Student-Coordinator') {?>hide<?php }?>">
													<input type="radio" id="Industry" name="cata_m" class="md-radiobtn" value="Industry" <?php if($assoc_name != 'Student-Coordinator') {?>checked="checked"<?php }?> onclick="assignSingleDay();" required="required">
													<label for="Industry">
													<span></span>
													<span class="check"></span>
												...
												<div class="md-radio <?php if($assoc_name == 'SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI)') {?>hide<?php }?>">
													<input type="radio" id="Student" name="cata_m" class="md-radiobtn" value="Student" onclick="assignSingleDay();" required="required" <?php if($assoc_name == 'Student-Coordinator') {?>checked="checked"<?php }?>>
													<label for="Student">
													<span></span>
													<span class="check"></span>
												...
												<div class="md-radio <?php if($assoc_name == 'SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI)' || $assoc_name == 'Student-Coordinator') {?>hide<?php }?>">
													<input type="radio" id="Poster" name="cata_m" class="md-radiobtn" value="Poster" onclick="assignSingleDay();" required="required">
													<label for="Poster">
													<span></span>
													<span class="check"></span>
													<span class="box"></span> Poster 
													</label>
												</div>
											</div>
										</div>
											...
											<table class="table table-striped table-hover1 table-bordered teriff-table">
												<thead>
													<tr bgcolor="#2fa0dd" style="color: #fff;">
														...
														<th colspan="1">REGISTRATION SLABS*</th>
														<?php /*<th colspan="2">Actual Tariff</th>*/?>
														<th colspan="2">EARLY BIRD DISCOUNT TARIFF**</th></th>
														<?php /*<th>Special Offer(Till 30th Sept,2019)</th>
														<th>Offer (1st Oct - 31st Oct,2019)</th>
														<th>Offer (1st Nov - 18th Nov,2019)</th>*/?>
													</tr>
												...
												<tbody>
													...
													<tr class="international-tariff first-row" >
														<td colspan="1">-</td>
														<td colspan="1">International Delegates</td>
														<?php /*<td colspan="2" class="success1">USD 300</td>*/?>
														<td colspan="2" class="success1">USD 300</td>
													...
													<tr>
														<td colspan="6">
															<p><strong>Please note</strong><br/>
																...
																- Spot registration will be charged @ Rs. 5,000 plus 18% GST
                                                                <?php /*
                                                                - On Spot registrations will be available at the Event Venue @ Bengaluru Palace based on the availability of seats.<br/>	<span class="indian-tariff">
                                                                * Rates For International Delegates are USD 300<br/></span>*/?>	
																<?php /*if(empty($assoc_name)) {?>
																<span style="color:#f00;">The above offer is valid only if the payment is made along with registration.</span><br/>
																<br/><span style="">For early bird Registration Slabs 201-300 you are alse entitled for a free Philips BT50B Wireless Speaker worth Rs. 2000 Free.</span><br/>
													...
													<tr>
														<td colspan="3">
															<strong>Full Delegate & Students Entitlements</strong><br/>
															1. Delegate Kit<br/>
															2. 3 Day access to the technical sessions<br/>
															3. Lunch & Coffee for all 3 days<br/>
															* Attendance to the Evening Programmes on 19<sup>th</sup> and 20<sup>th</sup> Nov like Thought Leaders Conclave, STPI IT Export Awards, Bio-Excellence Awards Function is by Invitation only. These programmes are not covered in Delegate entitlement.
														</td>
														<td colspan="3">
															<strong>Single Day & Single Day Student Delegate</strong><br/>
															1. Delegate Kit<br/>
															2. Access to the particular day's session<br/>
															3. Lunch & Coffee on that particular day<br/>
															*  Attendance to the Evening Programmes on 18<sup>th</sup> and 19<sup>th</sup> Nov like Thought Leaders Conclave, STPI IT Export Awards, Bio-Excellence Awards Function is by Invitation only. These programmes are not covered in Delegate entitlement.
														</td>
													</tr>
												</tbody>
											</table>
...
<script src="js/registration.js?sagar"></script>
<script>
