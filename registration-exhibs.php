...
if ($ret == "retds4fu324rn_ed24d3it") {
	...
	if ((!isset($_SESSION["vercode_reg"])) || ($_SESSION["vercode_reg"] == '')) {
		...
		echo "<script language='javascript'>document.location=('registration-exhibs.php');</script>";
		exit;
	}
...
if($assoc_name == 'STPI') {
	echo "<script language='javascript'>window.location = 'registration-exhibs.php?assoc_name=SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI)';</script>";
	exit;
}
?>
...
<div class="row">
 ...
 <?php 
			...
			<div class="portlet-body form">
				...
				<form action="registration-exhibs2.php<?php echo !empty($ret) ? '?ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_1" id="reg_registration_form_1" method="post" onsubmit="return validate_registration_form_2();">
						...
						<div class="form-body" <?php echo date('Y-m-d H:i');?>>
							...
							<div class="tab-content main-form-div" id="main-form-div" >
								<div class="tab-pane active">
									...
									<input type="hidden" value="2" name="total_dele" id="total_dele" />
