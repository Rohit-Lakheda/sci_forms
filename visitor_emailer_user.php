...
<div id='container'>
		...
		<form id='form1' action='' method='post'>
		  <table width='100%'  cellspacing='0' cellpadding='0'>
            ...
            <tr>
              <td>&nbsp;</td>
              <td align='center' valign='middle'><a href='".$EVENT_WEBSITE_LINK."' target='_blank'><img src='".$EVENT_LOGO_LINK."' title='".$EVENT_NAME."' alt='".$EVENT_NAME."' border='0' align='middle'/></a></td>
            </tr>
            <tr>
              <td width='3%'  align='left'>&nbsp;</td>
              <td width='98%'  align='left'><p class='style3'>Dear ".$_POST['title']." ".$_POST['name'].",<br />
                <p>  Thank you for submitting your details. </p><br/>
				<p><strong>Sector Name: " . $res['sector']. " </strong></p>
				<p><strong>Visitor Name: " . $res['title']." ".$res['fname']." ".$res['lname']. " </strong></p>
				<p><strong>Pass No:</strong><strong>" . $res['pass_no']. "</strong></p><br/>
