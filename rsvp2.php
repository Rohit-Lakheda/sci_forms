...
$qr_gt_user_data_id1      = mysqli_query($link,"SELECT * FROM " . $RSVP_TBL_NAME . " WHERE email = '$email' AND participant='$participant'");
...
$qr = mysqli_query($link,"INSERT INTO $RSVP_TBL_NAME(name,org,desig,email,mob,city,comment,reg_id,participant,ddate,ttime,rsvp_location,country,association_name,event_identity) VALUES('$namers','$org','$desig','$email','$mob','$city','$comment','$ses','$participant','$ddate','$ttime','$RSVP_CITY','$country','$association_name','$Event_Identity')") or die(mysqli_error($link));
