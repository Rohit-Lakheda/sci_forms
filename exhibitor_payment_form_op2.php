...
$tan_no = mysqli_real_escape_string($link,htmlspecialchars(@$_POST['tan_no'], ENT_QUOTES, 'UTF-8'));
...
if($tan == 'Registered'){
	...
	$temp_tan_number = $_SESSION['tan_number'] = mysqli_real_escape_string($link,htmlspecialchars(@$_POST['tan_number'], ENT_QUOTES, 'UTF-8'));

} else if ($tan == 'Unregistered') {

	$temp_tan_number = 'Not Applicable';

}
// print_r($_SESSION);
// print_r($temp_tan_number);

// echo $temp_tan_number; exit;
...
$boothSizes = [
    ...
    '9' => [
        ...
        'selection_amt' => 108000,

        'booth_area' => '9sqm (9sqm x Rs. 12,000) Raw Space = 1,08,000 + 18% GST',
    ...
    '9s' => [
        ...
        'booth_area' => '9sqm (9sqm x Rs. 13,000) Shell Space = 1,17,000 + 18% GST',
    ...
    '15' => [
        ...
        'selection_amt' => 180000,

        'booth_area' => '15sqm (15sqm x Rs. 12,000) Raw Space = 1,80,000 + 18% GST',
    ...
    '12s' => [
        ...
        'selection_amt' => 156000,

        'booth_area' => '12sqm (12sqm x Rs. 13,000) Shell Space = 1,56,000 + 18% GST',
    ...
    '15s' => [
        ...
        'booth_area' => '15sqm (15sqm x Rs. 13,000) Shell Space = 1,95,000 + 18% GST',
    ...
    '18' => [
        ...
        'selection_amt' => 216000,

        'booth_area' => '18sqm (18sqm x Rs. 12,000) Raw Space = 2,16,000 + 18% GST',
    ...
    '18s' => [
        ...
        'booth_area' => '18sqm (18sqm x Rs. 13,000) Shell Space = 2,34,000 + 18% GST',
    ...
    '27' => [
        ...
        'selection_amt' => 324000,

        'booth_area' => '27sqm (27sqm x Rs. 12,000) Raw Space = 3,24,000 + 18% GST',
    ...
    '27s' => [
        ...
        'booth_area' => '27sqm (27sqm x Rs. 13,000) Shell Space = 3,51,000 + 18% GST',
    ...
    '30' => [
        ...
        'selection_amt' => 360000,

        'booth_area' => '30sqm (30sqm x Rs. 12,000) Raw Space = 3,60,000 + 18% GST',
    ...
    '36' => [
        ...
        'selection_amt' => 432000,

        'booth_area' => '36sqm (36sqm x Rs. 12,000) Raw Space = 4,32,000 + 18% GST',
    ...
    '36s' => [
        ...
        'booth_area' => '36sqm (36sqm x Rs. 13,000) Shell Space = 4,68,000 + 18% GST',
    ...
    '48' => [
        ...
        'selection_amt' => 576000,

        'booth_area' => '48sqm (48sqm x Rs. 12,000) Raw Space = 5,76,000 + 18% GST',
    ...
    '48s' => [
        ...
        'booth_area' => '48sqm (48sqm x Rs. 13,000) Shell Space = 6,24,000 + 18% GST',
    ...
    '54' => [
        ...
        'selection_amt' => 648000,

        'booth_area' => '54sqm (54sqm x Rs. 12,000) Raw Space = 6,48,000 + 18% GST',
    ...
    '54s' => [
        ...
        'booth_area' => '54sqm (54sqm x Rs. 13,000) Shell Space = 7,02,000 + 18% GST',
    ...
    '72' => [
        ...
        'selection_amt' => 864000,

        'booth_area' => '72sqm (72sqm x Rs. 12,000) Raw Space = 8,64,000 + 18% GST',
    ...
    '72s' => [
        ...
        'booth_area' => '72sqm (72sqm x Rs. 13,000) Shell Space = 9,36,000 + 18% GST',
    ...
    '100' => [
        ...
        'selection_amt' => 1200000,

        'booth_area' => '100sqm (100sqm x Rs. 12,000) Raw Space = 12,00,000 + 18% GST',
    ...
    '100s' => [
        ...
        'booth_area' => '100sqm (100sqm x Rs. 13,000) Shell Space = 13,00,000 + 18% GST',
    ...
    '108' => [
        ...
        'selection_amt' => 1296000,

        'booth_area' => '108sqm (108sqm x Rs. 12,000) Raw Space = 12,96,000 + 18% GST',
    ...
    '108s' => [
        ...
        'booth_area' => '108sqm (108sqm x Rs. 13,000) Shell Space = 14,04,000 + 18% GST',
    ...
    '126' => [
        ...
        'booth_area' => '126sqm (126sqm x Rs. 12,000) Raw Space = 1,512,000 + 18% GST',
    ...
    '135' => [
        ...
        'selection_amt' => 1620000,

        'booth_area' => '135sqm (135sqm x Rs. 12,000) Raw Space = 16,20,000 + 18% GST',
...
$sql = "UPDATE " . $EVENT_DB_FORM_EXHIBITOR_DIR_PAYMENT_TBL_DEMO . " SET cp_title='$temp_cp_title',cp_fname='$temp_cp_fname',
			...
			state='$temp_state',country='$temp_country',zip='$temp_zip',phone='$fone',gst_number='$temp_gst_number',tan_no='$temp_tan_number',paymode='$temp_paymode',
...
/*mysqli_query($link,"insert into ".$EVENT_DB_FORM_REG_DEMO."(org_reg_type,nationality,curr,gr_type,sub_delegates,paymode,pay_status,amt_ext,reg_id,reg_date,reg_time,sector,tin_no,pin_no, cata) values 
    ...
    */
	...
	if($assoc_nm == "IESA"){
		...
		echo "<script language='javascript'>window.location = 'exhibitor_payment_form_op3_up.php';</script>";
