													...
													<div class="table-scrollable">
														...
														<table class="table table-striped table-bordered table-hover">
															...
															<tbody>
																...
																//trim the booth size after spcae

																$booth_size2 = explode(" ", $qr_gt_user_data_ans_row['booth_size']);

																$booth_size2 = $booth_size2[0];

																if($booth_size2 <4 ){

																	$booth_size2 = $qr_gt_user_data_ans_row['booth_space'];

																}else{

																	$booth_size2 = $qr_gt_user_data_ans_row['booth_size'];
