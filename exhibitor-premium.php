	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase">
						Premium Exhibitor Delegate registration form
			...
			<div class="portlet-body form">
				...
				<form action="exhibitor-premium2.php<?php echo !empty($ret) ? '?rt=' . $ret : ''; ?>" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" onsubmit="return validate_ex();">
...
<script>
	jQuery(document).ready(function() {  
		...
		<?php } ?>
		<?php if(!empty($_SESSION['del_cellnoCountryCodeIso5'])) { ?>
			$("#del-mobile-country-code5").intlTelInput({preferredCountries: [ "<?php echo $_SESSION['del_cellnoCountryCodeIso5'];?>" ]});
		<?php } else {?>
			$("#del-mobile-country-code5").intlTelInput();
		<?php } ?>
		<?php if(!empty($_SESSION['del_cellnoCountryCodeIso6'])) { ?>
			$("#del-mobile-country-code6").intlTelInput({preferredCountries: [ "<?php echo $_SESSION['del_cellnoCountryCodeIso6'];?>" ]});
		<?php } else {?>
			$("#del-mobile-country-code6").intlTelInput();
		<?php } ?>
