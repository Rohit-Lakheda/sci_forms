<?php
	...
	if(isset($_POST['make_payment'])) {
	    ...
	    for ($i = 1; $i <= $qr_gt_user_data_ans_row['sub_delegates']; $i++) {
			...
			//break;
			//############################################################################
	        if( ($qr_gt_user_data_ans_row['cata' . $i] == 'Premium Delegate') || ($qr_gt_user_data_ans_row['cata' . $i] == 'International Premium Delegate') ) {
	   ...
	   //$recipients = array('', 'test.interlinks@gmail.com','', 'mayuri.ladi@interlinks.in');
	    ...
	    if(($qr_gt_user_data_ans_row['paymode'] == 'Credit Card' || $qr_gt_user_data_ans_row['paymode'] == 'Debit Card' || $qr_gt_user_data_ans_row['paymode'] == 'i Banking' || $qr_gt_user_data_ans_row['paymode'] == 'Google pay') && $qr_gt_user_data_ans_row['pay_status'] == 'Not Paid') {
	    	/*//echo "<script language='javascript'>window.location = 'registration-exhibp9.php?id=" . $qr_gt_user_data_ans_row['tin_no'] . "';</script>";*/
			session_destroy();
	    ...
	    /* if($_POST['make_payment'] == 1) {
	    	...
	    	if($qr_gt_user_data_ans_row['paymode'] == 'Credit Card' || $qr_gt_user_data_ans_row['paymode'] == 'Debit Card' || $qr_gt_user_data_ans_row['paymode'] == 'i Banking') {
		    	echo "<script language='javascript'>window.location = 'registration-exhibp9.php';</script>";
		    	exit;
	    	}
	    } */
	}
	
	echo "<script language='javascript'>alert('Sorry, your registration-exhibp has been failed!');</script>";
	echo "<script language='javascript'>window.location = 'registration-exhibp.php';</script>";
	exit;
?>