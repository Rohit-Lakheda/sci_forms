  ...
  */
	...
	if ($ret == "retds4fn324rn_ed24d3it") {
		...
		if ((! isset ( $_SESSION ["vercode_ex"] )) || ($_SESSION ["vercode_ex"] == '')) {
			...
			echo "<script language='javascript'>window.location = ('exhibitor_spoc.php?assoc_nm=$assoc_nm');</script>";
			exit ();
		}
		...
		<div class="portlet light bordered" id="registration_form_1">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Exhibitor Personnel Form </span>
				</div>
			</div>
			<div class="portlet-body form">
				<?php if(date('Y-m-d') <= '2022-11-18') {?>
				<form action="exhibitor_spoc2.php?assoc_nm=<?php echo $assoc_nm; ?>" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" onsubmit="return validate_ex();" enctype="multipart/form-data">
