...
// exit;
	...
	if (($_SESSION ["vercode_ex"] == '')) {
		...
		echo "<script language='javascript'>window.location = ('exhibitor_spoc.php');</script>";
		exit ();
	}
	...
	echo "<script language='javascript'>window.location= 'exhibitor_spoc6.php?exhi=E34XH3IDf6gyy77&exhibitor_id=" . $exhibitor_id_ex . "';</script>";
	exit;
