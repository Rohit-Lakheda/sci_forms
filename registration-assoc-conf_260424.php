...
/* $assoc_name = @$_GET['assoc_name'];
 if($assoc_name == 'STPI') {
 echo "<script language='javascript'>window.location = 'registration-assoc-conf.php?assoc_name=SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI)';</script>";
 exit;
 } */
?>
		...
		<div class="portlet light bordered" id="registration_form_1">
				...
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase">
						<?php if (isset($_GET['a']) && !empty($_GET['a']) && $_GET['a'] == 'F5X3SB') { ?>
							Complimentary MEDIA delegate registration
						<?php } else { ?>
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d H:i') <= '2024-11-19 19:00' && !empty($discountDetail)) { ?>
					<form action="registration-assoc-conf2.php<?php echo !empty($ret) ? '?ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_1" id="reg_registration_form_1" method="post" onsubmit="return validate_registration_form_2();">
									...
									<?php */ ?>
										...
										<div class="col-md-6">
											...
											<?php if (!empty($discountDetail) && $discountDetail['promo_code'] != 'T3JSW1N1') { ?>
												<div class="form-group">
													...
													<?php } else if ($discountDetail['promo_code'] == '') { ?>
														<label class="col-md-3 control-label">Tag/ Association Name/ Dignitary Name<span class="dips-required"> </span></label>
													<?php } else { ?>
														<label class="col-md-3 control-label">Tag/ Association Name/ Dignitary Name<span class="dips-required"> </span></label>
													<?php } ?>
											...
											<div class="form-group form-md-radios hide" id="reg_type">
												...
												<div class="col-md-9">
													<div class="md-radio-inline">
														<?php /*?><span class="help-block"><i>Note: Discount will get added at last step of registration.</i></span><div class="md-radio" id="Single_Day_button">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												...
												<?php } else { ?>
													<table class="table table-hover1 table-bordered teriff-table col-md-offset-1 col-md-7 main-tariff-table hide" style="display: none;">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
													...
													<table class="table table-hover1 table-bordered teriff-table col-md-offset-1 col-md-7 " style="display: none1;">
														<tbody>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
...
<script src="js/registration-pfree.js?sagar"></script>
