	                                                ...
	                                                <div class="tab-content">
														<div class="tab-pane active">
                    										...
                    										<div class="row">
																...
																<?php /*?><h4 class="form-section">Registration Category</h4>
																<div class="row">
																	<div class="col-md-6">
																...
																<?php /*?><h4 class="form-section">Organisation Information</h4>
																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group">
															...
															<div class="note note-danger">
																...
																<p>Please DO NOT print this page. This page print not accepted in event.
																	<br />You need to click on <strong>Print</strong> button OR <a class="alert-link" href="reg_comp.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>" target="_blank">Click here </a>to generate printable receipt.
																</p>
															</div>
														</div>
													</div>
	                                            ...
	                                            <div class="form-actions">
	                                                <div class="row">
	                                                    <div class="col-md-offset-3 col-md-9">
															<a href="reg_comp.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>" class="btn blue sbold uppercase green-jungle" type="submit" name="make_payment" value="1">
