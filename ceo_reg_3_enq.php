...
<table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1" style=" margin-top:20px; margin-left:400px;">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><strong class="small_button">&nbsp;<?php echo $EVENT_NAME;?> <?php echo $EVENT_YEAR;?>:</strong><strong>Expression of Interest to attend CEO Conclave</strong></div>
		  ...
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              <td valign='top' class="blue_text_no_padding" style="padding-left:5px;" >                
                ...
                <?php 
				echo $CEO_REG_RECIPIENTS_USER_MSG;
				?>
