                ...
                <div class="tab-pane active">
                  ...
                  <div class="note note-danger">
                    ...
                    <p>Please DO NOT print this page. This page print not accepted in event.
                      <br />You need to click on <strong>Print</strong> button OR <a class="alert-link" href="reg_pay_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>&t=tejp" target="_blank">Click here </a>to generate printable receipt.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="form-actions">
              <div class="row">
                <div class="col-md-offset-3 col-md-9">
                  <a href="reg_pay_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>&t=tejp" class="btn blue sbold uppercase green-jungle" type="submit" name="make_payment" value="1">
