	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_3">
			...
			<div class="portlet-body form">
				<form action="registration-conference6.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_3" id="reg_registration_form_3" method="post" onsubmit="return validate_registration_form_3();">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<div class="form-group hide" style="display: none;">
										...
										<div class="col-md-6" style="margin-top: 8px;">Conference Delegate
											<input type="hidden" id="catagory<?php echo $i; ?>" name="catagory<?php echo $i; ?>" value="Conference Delegate" />
...
<script>
    ...
    function go_back11() {
    	...
    	window.location=('registration-conference.php?ret=retds4fu324rn_ed24d3it&en=' + en + a + assoc_nameurl2);
    }
</script>
