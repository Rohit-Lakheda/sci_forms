            ...
            <div class="page-header-inner container">
                ...
                <div class="page-logo">
                    <a href="<?php echo $EVENT_WEBSITE_LINK;?>" target="_blank">
                        <img src="<?php echo $EVENT_LOGO_LINK;?>" alt="logo" class="logo-default dips-logo" width="72%"/> 
                    </a>
                </div>
                <!-- END LOGO -->
            </div>
	                                  				...
	                                  				<div class="tab-content">
														<div class="tab-pane active">
															<div class="note note-success">
						                                        <h4 class="block">Greetings from BengaluruITE.BIZ 2016 !!</h4>
                                                                <p> Thank you for submitting your information. We look forward to meeting you at BengaluruITE.biz 2016.<br/><br/><br/>
