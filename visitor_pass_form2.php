...
$email = mysqli_escape_string($link,htmlspecialchars(@$_POST['email']));
if ($email == "") {
...
$chk_no = 0;
$chk_no_sql = "SELECT * FROM $VSTR_TBL_NAME WHERE email = '$email' AND sector='$sector' AND event_year='$EVENT_YEAR'"; //echo $chk_no_sql;exit;
...
if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose1'])) != "") {
	$enq1 = $enq1 . @$_POST['purpose1'] . ",";
	$purpose1 = $_POST['purpose1'];
}

if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose2'])) != "") {
	$enq1 = $enq1 . @$_POST['purpose2'] . ",";
	$purpose2 = $_POST['purpose2'];
}

if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose3'])) != "") {
	$enq1 = $enq1 . @$_POST['purpose3'] . ",";
	$purpose3 = $_POST['purpose3'];
}

if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose4'])) != "") {
	$enq1 = $enq1 . @$_POST['purpose4'] . ",";
	$purpose4 = $_POST['purpose4'];
}

if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose5'])) != "") {
	$enq1 = $enq1 . @$_POST['purpose5'] . ",";
	$purpose5 = $_POST['purpose5'];
}

if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose6'])) != "") {
	$enq1 = $enq1 . @$_POST['purpose6'];
	$purpose6 = $_POST['purpose6'];
}

if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose7'])) != "") {
	$enq1 = $enq1 . @$_POST['purpose7'] . ",";
	$purpose7 = $_POST['purpose7'];
}

if (mysqli_escape_string($link,htmlspecialchars(@$_POST['purpose8'])) != "") {
...
$temp_mda_type = mysqli_escape_string($link,htmlspecialchars(@$_REQUEST['mda_type']));
if (@$_POST['find_us'] == "Others") {
	$know_from = "Others" . '-' . mysqli_escape_string($link,htmlspecialchars(@$_POST['other_txtbx_find_us']));
} else {
	$know_from = mysqli_escape_string($link,htmlspecialchars(@$_POST['find_us']));
}
...
// $data['category_id'] = "1895";
// $data['qsn_366'] = "Business Visitor";
...
elastic_mail($str_career, $str_career_bdy, $VSTR_RECIPIENTS_ADMIN_MAIL);
...
elastic_mail($VSTR_FROM_SUBJECT_USER_MAIL, $VSTR_FROM_BODY_ADMIN_MAIL, $recipients);
