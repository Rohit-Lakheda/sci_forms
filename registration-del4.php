<?php
	...
	*****/
	...
	if( ($org == "") || ($addr1 == "") || ($city == "")  || ($state == "")  || ($country == "")  || ($pin == "") || (@$_POST['fone'] == "")){
		...
		echo "<script language='javascript'>window.location = 'registration-del3.php?assoc_name=$assoc_name';</script>";
		exit; 
	}
	...
	echo "<script language='javascript'>window.location = 'registration-del5.php?en=$en&assoc_name=$assoc_name';</script>";
	exit;
?>