...
(function(factory) {
   ...
   ********************/
        ...
        _setFlag: function(countryCode, isInit) {
            ...
            //alert(this.telInput.attr('data-fax-iso-code-hidden-field-name'));
            $('#' + this.telInput.attr('data-fax-iso-code-hidden-field-name')).val(this.selectedCountryData.dialCode);
            $('#' + this.telInput.attr('data-fax-iso-code-hidden-field-name') + 'Iso').val(countryCode);
            if (this.options.separateDialCode) {
