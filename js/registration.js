...
function validate_registration_form_2() {
	...
	if(document.getElementById("Full_Day").checked == false) {	
		alert("Please select type of registration.");
        document.getElementById("Full_Day").focus();
        return false;
	}
	...
	if (document.getElementById("Indian").checked == true) {
		...
		if ((document.getElementById("Cc").checked == false) && (document.getElementById("Cheque").checked == false) && (document.getElementById("BT").checked == false) && (document.getElementById("Dc").checked == false) && (document.getElementById("paypal").checked == false)) {
			alert("Please select the Payment Mode.");
			document.getElementById("Cc").focus();
			return false;
		}
