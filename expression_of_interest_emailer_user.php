...
<div id='container'>
		...
		<form id='form1' action='' method='post'>
		  <table width='100%'  cellspacing='0' cellpadding='0'>
            ...
            <tr>
              <td>&nbsp;</td>
              <td align='center' valign='middle'><a href='".$EVENT_WEBSITE_LINK."' target='_blank'><img src='".$EVENT_LOGO_LINK."' title='".$EVENT_NAME."' alt='".$EVENT_NAME."' border='0' align='middle' style='width: 100%;'/></a></td>
            </tr>
            <tr>
              <td width='3%'  align='left'>&nbsp;</td>
              <td width='98%'  align='left'><p class='style3'>Dear ".$_POST['fname'].",<br />
               Thank you for registration of Expression of Interest (EoI) for attending the CEO Conclave @ ".$EVENT_NAME." " . $EVENT_YEAR ."<br /><br />
                Thanking You,</p>
