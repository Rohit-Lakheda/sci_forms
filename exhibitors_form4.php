<?php
	...
	$reg_id = $qr_chk_exb_ans['srno'] . $temp_reg_id;
	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_2">
			...
			<div class="portlet-body form">
				<form action="exhibitors_form5.php?assoc_nm=<?php echo $assoc_nm;?>" class="form-horizontal" name="reg_registration_form_2" id="reg_registration_form_2" method="post" onsubmit="return validate_registration_form_4();">
				                                ...
				                                <div class="portlet-body">
				                                    <div class="table-scrollable">
				                                    	<table class="table table-striped table-bordered table-hover">
				                                            <tbody>
				                                             	<?php if(!empty($qr_chk_exb_ans ['exhi_profile'])) { ?>
																	<tr>
																...
																<?php if(!empty($qr_chk_exb_ans ['order_no'])) {?>
				                                                <tr>
				                                                    <td> <strong>Elevate Winner ID</strong> </td>
				                                                    <td> <?php echo $qr_chk_exb_ans ['order_no']; ?> </td>
				                                                </tr>
																<?php }?>
				                                             	<tr>
																...
																<?php if(!empty($qr_chk_exb_ans['assoc_nm'])) { ?>
																	<tr>
					                        ...
					                        <div class="col-md-12">
					                            ...
					                            <div class="portlet light bordered">
					                                <div class="portlet-title">
					                                    <div class="caption">
					                                    	<i class="fa fa-info-circle font-dark"></i>
					                                        <span class="caption-subject">Exhibitor/Sponsor Information</span>
					                                    </div>
					                                </div>
					                                <div class="portlet-body">
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									...
									<button type="submit" class="btn sbold uppercase green-jungle" id="sumbit-btn"> Continue
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-body">
										<h3>Please wait while you redirecting to Confirmation page...<br/> Do not "close the window" or press "refresh" or "browser back button".</h3>
									</div>
								</div>
							</div>
						</div>
...
<script>
	...
	<?php } else {?>
		function go_back(){
			window.location=('exhibitors_form.php?rt=retds4fn324rn_ed24d3it&assoc_nm=<?php echo $assoc_nm;?>&ret=retds4fu324rn_ed24d3it');
		 }
	<?php } ?>
