...
<?php $pageStyleCss = '<link href="assets/telephoneWithFlags/css/intlTelInput.css" rel="stylesheet" type="text/css" />'; 
		...
		<div class="col-md-12">
			<div class="portlet light bordered" id="enq_form_1">
				...
				<div class="portlet-body form">
					<form id="visitor_form1" name="form1" class="form-horizontal" method="post" action="visitor_pass_form-inst2.php?assoc_nm_vp=<?php echo $temp_assoc_nm_vp;?>" onsubmit="return  validate_vpass('<?php echo $EVENT_NAME;?>');">
						...
						<div class="form-wizard">
							<div class="form-body">
								...
								<div class="form-group">
									<label class="col-md-3 control-label">College / Institute Name <span class="dips-required"> * </span></label>
									<div class="col-md-5">
								...
								<div class="form-group hide">
									...
									<div class="col-md-5">
										<input class="form-control" name="job_title" type="text" id="job_title" value="Student"/>
									</div>
								</div>
								<?php /*<!-- <div class="form-group">
								...
								<div class="form-group">
				                	...
				                	<div class="col-md-5" style="margin-top: -20px;">
										...
										<input name="fone" type="text" id="fone" class="form-control" maxlength="20" onkeyup="check_num(event, 'fone');" style="padding-left: 92px;" />
									</div>
								</div>
								<!-- <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<select class="form-control" name="know1" id="find_us" onchange="disp_other_k();">
											...
											<?php $find_usList = array("Brochure","Colleague","Link on Site","Previous Attendee","Internet search","Sales Call","Association","Direct Mailer","News Paper Ad","Trade Publication","Invitation from Exhibitor","Hoarding","Others");
                                ...
                                <div class="col-md-offset-2 col-md-8">
									<div class="note note-success">
										<p><strong>Note:</strong> <br />
											...
											Event Secretariat: <?php echo $EVENT_SECRT_ADDR;?><br />
	...
	<script src="js/visiter-pass-inst.js"></script>
	<script>
