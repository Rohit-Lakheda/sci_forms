<?php
$INTERLINX_LOGO_LINK = "https://www.bengalurutechsummit.com/web/IT2019/images/Interlinx-logo.jpg";
$interlink = $EVENT_INTERLINX_LINK;
/*if (strpos($qr_gt_user_inx_login_data_ans['tin_no'], 'TIN-BIB') !== false) {
	$interlink = 'https://www.bengalurutechsummit.com/web/BIO2019/';
}*/
		...
		<form id='form11' action='' method='post'>
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
			  ...
			  <a href='".$EVENT_WEBSITE_LINK."' target='_blank'><img src='".$EVENT_LOGO_LINK1."' title='".$EVENT_NAME." ".$EVENT_YEAR."' alt='".$EVENT_NAME." ".$EVENT_YEAR."' border='0' align='middle' width='40%'/></a>
			 </td>
            </tr>
            <tr>
              <td valign='top' class='style4'></td>
            ...
            <tr>
			  ...
			  We are pleased to inform you that you now have access to InterlinX- The Online Partnering Tool, which will enable you to: 
              <ol style='font-size: 14px;'>
              	...
              	<li>InterlinX tool also provides you with a facility to send or receive message(s) to/from other delegates.</li>
              	
              </ol>
			  <center>So what are you waiting for? Go ahead and make new connections!</center>
              <p><strong>Note: </strong><i>Kindly note that InterlinX-Tool is only a medium to enhance your chances of meeting the delegates of your preference, However InterlinX-Tool does not guarantee any meetings.</i>
              </p>
              <p>&nbsp;</p>
              <p><strong>Please find below your login details:</strong><br/>
              	<a href='".$interlink."' target='_blank'>Click Here</a> to login to ".$EVENT_NAME." ".$EVENT_YEAR." InterlinX.<br/>
              ...
              <p>Should you have any queries. Please do mail us at <a href='mailto:tejas.rashinkar@interlinks.in'>tejas.rashinkar@interlinks.in</a>
              </p>
            ...
            <tr>
              <td colspan='4' valign='top' class='style4'>
              <p>Best Regards,<br/>
              " . $EVENT_NAME . "-" . $EVENT_YEAR . " - InterlinX Secretariat</p></td>
            </tr>
          </table>
		  <p class='submit'>&nbsp;</p>								
  </form>		
		...
		<form id='form1' action='' method='post'>
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
			  ...
			  <a href='".$EVENT_INTERLINX_LINK."' target='_blank'><img src='".$EVENT_INTERLINX_LOGO."' title='".$EVENT_NAME." InterlinX ' alt='".$EVENT_NAME." InterlinX' border='0' align='middle'/></a>
			 </td>
              <td width='239' align='center' valign='middle' class='style4'><a href='".$EVENT_WEBSITE_LINK."' target='_blank'><img src='".$EVENT_LOGO_LINK."' title='".$EVENT_NAME." ".$EVENT_YEAR."' alt='".$EVENT_NAME." ".$EVENT_YEAR."' border='0' width='100%' align='middle'/></a></td>
            ...
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'>Username :  ".$qr_gt_user_inx_login_data_ans['user_name']."</td>
            </tr>
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'></td>
            ...
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'>Password :  ".$qr_gt_user_inx_login_data_ans['pass1']."</td>
            </tr>
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'></td>
            ...
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'><a href='".$EVENT_INTERLINX_LINK."' target='_blank'>Click Here</a> to login to ".$EVENT_NAME." ".$EVENT_YEAR." InterlinX.</td>
            </tr>
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'></td>
            ...
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'>Thank You </td>
            </tr>
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'></td>
            ...
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'><p>Team ".$EVENT_NAME." ".$EVENT_YEAR." Partnering</p></td>
            </tr>
          </table>
		  <p class='submit'>&nbsp;</p>								
  </form>		
