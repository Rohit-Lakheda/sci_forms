											...
											<table class="table table-bordered tariff-table" style="border: thin solid #dddddd; box-shadow: 5px 5px 5px 0 rgb(219, 219, 219);">
												<thead>
													...
													<tr  bgcolor="#2fa0dd" style="color: #fff;">
														<th class="align-td">OPTION</th>
														<th class="align-td">BOOTH SIZE(SQM)</th>
														<th class="align-td">PRICE /SQM IN INR</th>
														<th class="align-td">TOTAL COST IN INR</th>
														<th class="align-td">SPECIAL OFFER</th>
													</tr>
												</thead>
												<tbody>
													<tr class="indian-tariff" style="background-color: #e1e1e1;" >
														<td class="align-td">1</td>
														<td class="align-td">4</td>
														<td class="align-td">12000</td>
														<td class="align-td">48,000</td>
														<td class="align-td">20,000</td>
		                                            </tr>
													<tr class="indian-tariff" style="background-color: #e1e1e1;" >
														<td class="align-td">2</td>
														<td class="align-td">6</td>
														<td class="align-td">12000</td>
														<td class="align-td">72,000</td>
														<td class="align-td">30,000</td>
		                                            </tr>
													...
													<tr>
														<td colspan="6">
															<p><strong>Note:</strong><br/>
																- GST Applicable @ 18%</p>
																<?php /**Less than 5 years old company </p>
															<p><strong>Entitlements</strong><br>		
																...
																&bull;&nbsp;One Complimentary Premium Delegate Registration (Access to B2B Partnering).<br/>
																&bull;&nbsp;Standard Delegate Registration free to access entire summit like Inaugural, Plenary Talks, technical sessions, Awards, Quiz and Special Programme etc.
																</p>*/?>
														</td>
													</tr>
												</tbody>												
									...
									<div class="main-form">
    									...
    									<div class="form-group form-md-radios">
    										...
    										<div class="col-md-9">
    											<div class="md-radio-inline">
    												<div class="md-radio">
    													<input type="radio" id="booth_size1" name="booth_size" class="md-radiobtn" value="4" required="required">
    												...
    												<div class="md-radio">
    													<input type="radio" id="booth_size2" name="booth_size" class="md-radiobtn" value="6" required="required">
											...
											<div class="col-md-6">
												<select id="subsector" name="subsector" class="form-control" required="required" onchange="showOtherDiv();">
													...
													<?php //$countryList = array('Information Technology'=>'Information Technology', 'Bio Technology'=>'Bio Technology');
														$countryList = array('IT','IoT','AI & ML','AR & VR','BlockChain','Digital Learning','Electronics','FinTech','Robo & Drone','Gaming','Mobility','IT Services','BioTech','AgriTech','MedTech','Healthtech','SmartTech','Other');
										...
										<h4>Please enter details of stall manning people 1:</h4>
										<div class="form-group">
										...
										<h4>Please enter details of stall manning people 2:</h4>
											...
											<?php /*<div class="form-group">
												...
												<div class="col-md-6">
													<label><input type="checkbox" id="sameas" onchange="addvalues();"/>IsPremium  delegate same as conference delegate</label>
												</div>
											</div>*/?>
											<div class="form-group">
