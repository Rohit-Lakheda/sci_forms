<?php
	...
	{ 
		...
		if(!empty($assoc_name)) {
			echo "<script language='javascript'>window.location = 'registration-exhibp.php?en=$en&assoc_name=$assoc_name';</script>";
		} else {
			echo "<script language='javascript'>window.location = 'registration-exhibp.php?en=$en';</script>";
		}
		exit; 
	}
		...
		<div class="portlet light bordered" id="registration_form_3">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Premium Exhibition Complimentary Premium Delegates Registration Form
					</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="registration-exhibp6.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_3" id="reg_registration_form_3" method="post" onsubmit="return validate_registration_form_3();">
						...
						<div class="form-body">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<div class="form-group form-md-radios hide" style="display: none;" id="pay">
...
<script>
    ...
    function go_back11() {
    	...
    	window.location=('registration-exhibp.php?ret=retds4fu324rn_ed24d3it&en=' + en + a + assoc_nameurl2);
    }
</script>
