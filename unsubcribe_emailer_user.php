<?php  
	...
	$unsub_emailer_mail_msg_user = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
		...
		<form id='form1' action='' method='post'>
		  <table width='100%'  cellspacing='0' cellpadding='0'>
            ...
            <tr>
              ...
              <td width='98%'  align='left'>".$UNSBCRB_FORM_EVENT_FROM_BODY_USER_MAIL."</td>
            </tr>
