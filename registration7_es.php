  ...
  <div class="col-md-12">
    <div class="portlet light bordered" id="registration_form_4">
      ...
      <div class="portlet-body form">
        <form action="registration8_es.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name']; ?>"
                          ...
                          <div class="table-scrollable">
                            <?php if ($qr_gt_user_data_ans_row['paymode'] == "Bank Transfer") { ?>
                              <table class="table table-striped table-bordered table-hover">
                                <tbody>
                                  <tr>
                                    <td colspan="2" class="success">Delegates are requested to Bank Transfer the
                                  ...
                                  <?php if ($qr_gt_user_data_ans_row['nationality'] == 'Indian Organization') { ?>
                                    <?php if ($qr_gt_user_data_ans_row['sector'] == "Bio Technology") { ?>
                                      ...
                                      <tr>
                                        <td>Bank Address :</td>
                                        <td>No.1/1, KSFC Bhavan, Thimmaiah Road, Millers Tank Bed, Bangalore - 560 052, INDIA.
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td colspan="2" style="color: red;">Incase of payment through IMPS. IMPS Transaction
                                          ID along with Date of Payment to be sent to <a
                                            href="mailto:ramakrishna.mokkapati@mmactiv.com">ramakrishna.mokkapati@mmactiv.com</a>/<a
                                            href="mailto:srisha.accounts@mmactiv.com">srisha.accounts@mmactiv.com</a></td>
                                      </tr>
                                    <?php } else { ?>
                                      <tr>
                                        <td>Account Name :</td>
                                ...
                                <table class="table well table-condensed table-striped">
                                  <tbody>
                                    <tr>
                                      ...
                                      <?php if ($qr_gt_user_data_ans_row['sector'] == "Bio Technology") { ?>
                                          <p>
                                            Please send your Cheque/DD in favour of BANGALORE INDIA BIO payable at Bengaluru,
                                            India.<br>
                                            Along with the copy of your registration receipt and send to<br>
                                            <strong>Address :</strong><br>#9, UNI Building,3rd Floor, <br> Thimmaiah Road,
                                            Millers Tank Bund, <br>Vasanthnagar, Bengaluru - 560 052, India<br>Tel:
                                            +91.80.4113 1912/3<br>Website: <a href="http://www.bengaluruindiabio.in"
                                              target="_blank">www.bengaluruindiabio.in</a>
                                          </p>
                                      <?php } else { ?>
                                          <p>
                          ...
                          <div class="portlet-body">
                            <div class="table-scrollable">
                              <table class="table table-striped table-bordered table-hover">
                                <tbody>
                                  <tr>
                                    <td style='color: rgb(103, 144, 231);'>
                                      <strong><?php echo $qr_gt_user_data_ans_row['user_type']; ?></strong>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                              ...
                              <tbody>
                                <?php for ($i = 1; $i <= $qr_gt_user_data_ans_row['sub_delegates']; $i++) { ?>
                                  <tr>
                                    ...
                                    <?php if ($qr_gt_user_data_ans_row['cata' . $i] == 'Full Delegate') { ?>
                                      <td>
                                    ...
                                    <?php } else { ?>
                                      <td>
                                        <?php
                                        // Start by displaying the value in 'cata$i'
                                        echo $qr_gt_user_data_ans_row['cata' . $i];

                                        // Initialize an array to store available days
                                        $days = [];

                                        // Check if each day is available, and add to the array if it is
                                        if (!empty($qr_gt_user_data_ans_row['day1'])) {
                                          $days[] = $qr_gt_user_data_ans_row['day1'];
                                        }
                                        if (!empty($qr_gt_user_data_ans_row['day2'])) {
                                          $days[] = $qr_gt_user_data_ans_row['day2'];
                                        }
                                        if (!empty($qr_gt_user_data_ans_row['day3'])) {
                                          $days[] = $qr_gt_user_data_ans_row['day3'];
                                        }

                                        // If there are any available days, join them with commas and display
                                        if (count($days) > 0) {
                                          echo " (" . implode(", ", $days) . ")";
                                        }
                                        ?>
                    ...
                    <div class="col-md-12">
                      <div class="well well-lg">
                        <label class="control-label1 col-md-9">
                          Would you be interested in exploring B2B Partnering possibilities through the Interlinx B2B
                          Portal at BTS2024?</label>
                        <div class="col-md-3">
                          <div class="md-radio-inline">
                            <div class="md-radio">
                              <input type="radio" id="delegate_flag-yes" name="delegate_flag" class="md-radiobtn"
                                value="Yes">
                            ...
                            <div class="md-radio">
                              <input type="radio" id="delegate_flag-no" name="delegate_flag" class="md-radiobtn"
                                value="No">
                        ...
                        <label>
                          <i>Note: By selecting 'Yes,' you are committing to actively engage in B2B Partnering -
                            InterlinX. This entails keeping your profile up-to-date, promptly responding to meeting and
                            message requests, and honoring any meeting commitments.</i>
                        </label>
                      </div>
                    </div>
                    <div class="col-md-12">
                          ...
                          <div class="md-checkbox">
                            ...
                            <label for="agree">
                              ...
                              I have read and agreed to the all the <a
                                href="https://bengalurutechsummit.com/privacy-policy.php" target="_blank">terms &
                                conditions and privacy policy</a> of Bengaluru Tech Summit <?php echo $EVENT_YEAR; ?>
                              (BTS <?php echo $EVENT_YEAR; ?>).
                            </label>
                          </div>
                        </div>
                      </div>
...
<script>
  ...
  function go_back() {
    window.location = ('registration5_es.php?ret=retds4fu324rn_ed24d3it&?en=<?php echo $en; ?>&a=<?php echo $a; ?>&assoc_name=<?php echo $assoc_name; ?>');
  }

  function validate_registration_form_4() {
    if ((document.getElementById("delegate_flag-yes").checked == false) && document.getElementById("delegate_flag-no").checked == false) {
      alert('Please select Would you be interested in exploring B2B Partnering possibilities through the Interlinx B2B Portal at BTS2023?');
      document.getElementById("delegate_flag-yes").focus();
      return false;
    }
