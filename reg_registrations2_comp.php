<?php  
	...
	if(($grp == "Single")&&($exhi!= "E34XH3IDf6gyy77")){
		$total_dele = 1; 
	}
	elseif(($exhi== "E34XH3IDf6gyy77")||($grp == "Group")){
	...
	*/
	...
	echo "<script language='javascript'>window.location = 'reg_registrations3_comp.php?exhi=$exhi&exhibitor_id=$exhibitor_id&exhi_log=r34tr1';</script>";		
