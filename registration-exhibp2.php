<?php
	...
	if( ($org == "") || ($city == "") || ($country == "")  || (@$_POST['fone'] == "")){
	    ...
	    echo "<script language='javascript'>window.location = 'registration-exhibp.php?assoc_name=$assoc_name';</script>";
	    exit;
	}
	...
	/*exit;
	//echo "<script language='javascript'>window.location = 'registration-exhibp3.php?en=$en&assoc_name=$assoc_name';</script>";
	//exit;*/
	$gst_number = '';
	if($gst=='Registered'){
