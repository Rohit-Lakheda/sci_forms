	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_2">
			...
			<div class="portlet-body form">
				<form action="rsvp2.php?c=<?php echo $rsvp_city?>" class="form-horizontal" name="reg_registration_form_2" id="reg_registration_form_2" method="post" onsubmit="return validateEnquiry1223();">
								...
								<div class="tab-pane active">
									...
									<div class="form-group" style="margin-top: -15px;">
										...
										<div class="col-md-6">
											...
											<input name="mob" type="number" id="mob" class="form-control" maxlength="20" required  style="padding-left: 92px;" />
