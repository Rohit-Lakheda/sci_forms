...
<table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1" style=" margin-top:20px; margin-left:400px;">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><strong class="small_button">Hubli Event:
          <?php 
...
<form id="form1" name="form1" method="post" onsubmit="return validate_rsvp()" action="rsvp_2_comp_registration.php?enq_emler=<?php echo $emler?>">
