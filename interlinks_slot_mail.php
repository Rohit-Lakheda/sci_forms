...
error_reporting(E_ALL);*/
	...
	//############################################################################
	//==== Create slot===============
	$qr_gt_user_data_id      = mysqli_query($link,"SELECT * FROM it_2020_reg_tbl WHERE (`pay_status` = 'Complimentary' OR `pay_status` = 'Paid') AND sector !='Biotechnology'");
	
	while($qr_gt_user_data_ans_row = mysqli_fetch_array($qr_gt_user_data_id)){
	...
	while($qr_gt_user_data_ans_row2 = mysqli_fetch_array($qr2)){
		for ($i = 2; $i <= 2; $i++) {
	        ...
	        if ($qry_email_chk_num >= 1) {
	            ...
	            $dele_title      = $qr_gt_user_data_ans_row2['title'.$i];
	            $dele_fname      = $qr_gt_user_data_ans_row2['fname'.$i];
	            $dele_lname      = $qr_gt_user_data_ans_row2['lname'.$i];
	            $dele_email      = $qr_gt_user_data_ans_row2['email'.$i];
	            $dele_cellno     = $qr_gt_user_data_ans_row2['cellno'.$i];
	            $dele_cellno_arr = explode("-", $dele_cellno);
	            
	            $test_title = $qr_gt_user_data_ans_row2['title'.$i];
	            $test_fname = $qr_gt_user_data_ans_row2['fname'.$i];
	            $test_lname = $qr_gt_user_data_ans_row2['lname'.$i];
	            $test_email = $qr_gt_user_data_ans_row2['email'.$i];
	            
	            
	            $pas1_inx    = str_replace(' ', '_', $qr_gt_user_data_ans_row2['fname'.$i]) . "123";
	            $pas2_inx    = md5($pas1_inx);
	            $user_id_md5 = md5($usr_no1);
	            
	            $temp_qr_gt_user_data_ans_row2_fone_arr = explode("-", $qr_gt_user_data_ans_row2['fone']);
	            $temp_qr_gt_user_data_ans_row2_fax_arr  = explode("-", $qr_gt_user_data_ans_row2['fax']);
	            
	            //------------------------------------------------- Inserting Values in interlinx registration table --------------------------------------
				/*echo "INSERT INTO " . $EVENT_DB_FORM_INTERLINX_REG_TBL . "
	            		(user_id,dup_user_id,title,fname,lname,birth_date,sex,addr1,addr2,city,state,country,pin,web_site,pri_email,sec_email,org_name,org_info,desig,mob_cntry_code,mob_number,hm_ph_cntry_code,hm_ph_area_code,hm_ph_number,				fax_cntry_code,fax_area_code,fax_number,reg_cata,intr1,intr2,intr3,intr4,intr5,intr6,intr7,intr8,intr9,intr10,intr11,intr12,intr13,intr14,intr15,intr16,intr17,intr18,intr19,user_name,pass1,pass2,reg_id,vercode,photo,org_profile,inx_reg_date,inx_reg_time,tin_no) values 
	            		('$usr_no1','$user_id_md5','$dele_title','$dele_fname','$dele_lname','','','$qr_gt_user_data_ans_row2[addr1]','$qr_gt_user_data_ans_row2[addr2]','$qr_gt_user_data_ans_row2[city]','$qr_gt_user_data_ans_row2[state]','$qr_gt_user_data_ans_row2[country]','$qr_gt_user_data_ans_row2[pin]','','$dele_email','','$qr_gt_user_data_ans_row2[org]','','','$dele_cellno_arr[0]','$dele_cellno_arr[1]','$temp_qr_gt_user_data_ans_row2_fone_arr[0]','$temp_qr_gt_user_data_ans_row2_fone_arr[1]','$temp_qr_gt_user_data_ans_row2_fone_arr[2]','$temp_qr_gt_user_data_ans_row2_fax_arr[0]','$temp_qr_gt_user_data_ans_row2_fax_arr[1]','$temp_qr_gt_user_data_ans_row2_fax_arr[2]','','$qr_gt_user_data_ans_row2[intr1]','$qr_gt_user_data_ans_row2[intr2]','$qr_gt_user_data_ans_row2[intr3]','$qr_gt_user_data_ans_row2[intr4]','$qr_gt_user_data_ans_row2[intr5]','$qr_gt_user_data_ans_row2[intr6]','$qr_gt_user_data_ans_row2[intr7]','$qr_gt_user_data_ans_row2[intr8]','$qr_gt_user_data_ans_row2[intr9]','$qr_gt_user_data_ans_row2[intr10]','$qr_gt_user_data_ans_row2[intr11]','$qr_gt_user_data_ans_row2[intr12]','$qr_gt_user_data_ans_row2[intr13]','$qr_gt_user_data_ans_row2[intr14]','$qr_gt_user_data_ans_row2[intr15]','$qr_gt_user_data_ans_row2[intr16]','$qr_gt_user_data_ans_row2[intr17]','$qr_gt_user_data_ans_row2[intr18]','','$dele_email','$pas1_inx','$pas2_inx','$qr_gt_user_data_ans_row2[reg_id]','$qr_gt_user_data_ans_row2[reg_id]','uploads/default_file.jpg','$qr_gt_user_data_ans_row2[org_profile]','$qr_gt_user_data_ans_row2[reg_date]','$qr_gt_user_data_ans_row2[reg_time]','$qr_gt_user_data_ans_row2[tin_no]');";*/
	            mysqli_query($link,"INSERT INTO " . $EVENT_DB_FORM_INTERLINX_REG_TBL . "
	            		(user_id,dup_user_id,title,fname,lname,birth_date,sex,addr1,addr2,city,state,country,pin,web_site,pri_email,sec_email,org_name,org_info,desig,mob_cntry_code,mob_number,hm_ph_cntry_code,hm_ph_area_code,hm_ph_number,				fax_cntry_code,fax_area_code,fax_number,reg_cata,intr1,intr2,intr3,intr4,intr5,intr6,intr7,intr8,intr9,intr10,intr11,intr12,intr13,intr14,intr15,intr16,intr17,intr18,intr19,user_name,pass1,pass2,reg_id,vercode,photo,org_profile,inx_reg_date,inx_reg_time,tin_no) values 
	            		('$usr_no1','$user_id_md5','$dele_title','$dele_fname','$dele_lname','','','$qr_gt_user_data_ans_row2[addr1]','$qr_gt_user_data_ans_row2[addr2]','$qr_gt_user_data_ans_row2[city]','$qr_gt_user_data_ans_row2[state]','$qr_gt_user_data_ans_row2[country]','$qr_gt_user_data_ans_row2[pin]','','$dele_email','','$qr_gt_user_data_ans_row2[org]','','','$dele_cellno_arr[0]','$dele_cellno_arr[1]','$temp_qr_gt_user_data_ans_row2_fone_arr[0]','$temp_qr_gt_user_data_ans_row2_fone_arr[1]','$temp_qr_gt_user_data_ans_row2_fone_arr[2]','$temp_qr_gt_user_data_ans_row2_fax_arr[0]','$temp_qr_gt_user_data_ans_row2_fax_arr[1]','$temp_qr_gt_user_data_ans_row2_fax_arr[2]','','$qr_gt_user_data_ans_row2[intr1]','$qr_gt_user_data_ans_row2[intr2]','$qr_gt_user_data_ans_row2[intr3]','$qr_gt_user_data_ans_row2[intr4]','$qr_gt_user_data_ans_row2[intr5]','$qr_gt_user_data_ans_row2[intr6]','$qr_gt_user_data_ans_row2[intr7]','$qr_gt_user_data_ans_row2[intr8]','$qr_gt_user_data_ans_row2[intr9]','$qr_gt_user_data_ans_row2[intr10]','$qr_gt_user_data_ans_row2[intr11]','$qr_gt_user_data_ans_row2[intr12]','$qr_gt_user_data_ans_row2[intr13]','$qr_gt_user_data_ans_row2[intr14]','$qr_gt_user_data_ans_row2[intr15]','$qr_gt_user_data_ans_row2[intr16]','$qr_gt_user_data_ans_row2[intr17]','$qr_gt_user_data_ans_row2[intr18]','','$dele_email','$pas1_inx','$pas2_inx','$qr_gt_user_data_ans_row2[reg_id]','$qr_gt_user_data_ans_row2[reg_id]','uploads/default_file.jpg','$qr_gt_user_data_ans_row2[org_profile]','$qr_gt_user_data_ans_row2[reg_date]','$qr_gt_user_data_ans_row2[reg_time]','$qr_gt_user_data_ans_row2[tin_no]')") or die(mysqli_error($link));
	            
	            $year = $EVENT_YEAR;
	            $month = 11;
				$date = 19;
				mysqli_query($link,"insert  into `" . $EVENT_DB_FORM_ALL_USERS_SCHEDULE . "` (`req_date`,`req_time`,`sender_id`,`sender_title`,`sender_fname`,`sender_lname`,`sender_org`,`sender_desig`,`sender_org_profile`,`sender_email`,`receiver_id`,`receiver_title`,`receiver_fname`,`receiver_lname`,`receiver_org`,`receiver_desig`,`receiver_org_profile`,`receiver_email`,`req_type`,`meeting_date`,`meeting_time_start`,`meeting_time_end`,`message`,`status`,`read_flag`,`table_no`) values				
				(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','14:00:00 pm','14:30:00 am',NULL,'',NULL,NULL),
				(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','14:30:00 am','15:00:00 pm',NULL,'',NULL,NULL),
				(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','15:00:00 pm','15:30:00 pm',NULL,'',NULL,NULL),
				(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','15:30:00 pm','16:00:00 pm',NULL,'',NULL,NULL),
				(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','16:00:00 pm','16:30:00 pm',NULL,'',NULL,NULL),
				(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$usr_no1','$test_title','$test_fname','$test_lname','$temp_receiver_org',NULL,NULL,'$test_email',NULL,'$year-$month-$date','16:30:00 pm','17:00:00 pm',NULL,'',NULL,NULL),
	...
	while ($qr_gt_user_data_ans_row = mysqli_fetch_array($qr_reg)) {
		for ($i = 1; $i <= $qr_gt_user_data_ans_row['sub_delegates']; $i++) {
	        $test_delegate_email = $qr_gt_user_data_ans_row['email'];
			//$qry_email_chk       = mysqli_query($link,"SELECT * FROM " . $EVENT_DB_FORM_INTERLINX_REG_TBL . " WHERE pri_email = '$test_delegate_email'");
			$qry_email_chk       = mysqli_query($link,"SELECT * FROM it_2019_all_users_schedule WHERE receiver_email = '$test_delegate_email'");
			if(mysqli_num_rows($qry_email_chk)) {
				echo $test_delegate_email . '## ' . mysqli_num_rows($qry_email_chk) . ' <br/>';
			}
		}
	}
	exit;*/
