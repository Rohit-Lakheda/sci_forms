<?php
	...
	mysqli_query($link,"UPDATE ".$EVENT_DB_FORM_REG_DEMO." SET cata1 = 'Standard Delegate' where reg_id = '$reg_id'") or die(mysqli_error($link));
	...
	mysqli_query($link,"UPDATE ".$EVENT_DB_FORM_REG_DEMO." SET cata3 = 'Standard Delegate' where reg_id = '$reg_id'") or die(mysqli_error($link));
	...
	mysqli_query($link,"UPDATE ".$EVENT_DB_FORM_REG_DEMO." SET cata4 = 'Standard Delegate' where reg_id = '$reg_id'") or die(mysqli_error($link));
	...
	mysqli_query($link,"UPDATE ".$EVENT_DB_FORM_REG_DEMO." SET cata5 = 'Standard Delegate' where reg_id = '$reg_id'") or die(mysqli_error($link));
	...
	mysqli_query($link,"UPDATE ".$EVENT_DB_FORM_REG_DEMO." SET cata6 = 'Standard Delegate' where reg_id = '$reg_id'") or die(mysqli_error($link));
	...
	mysqli_query($link,"UPDATE ".$EVENT_DB_FORM_REG_DEMO." SET cata7 = 'Standard Delegate' where reg_id = '$reg_id'") or die(mysqli_error($link));
