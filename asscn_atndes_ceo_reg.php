...
require "asscn_atndes_ceo_reg_captcha.php";
$page = basename($_SERVER['SCRIPT_NAME']); 

//$asscn_atndes_ceo_reg_city = $_REQUEST['asscn_atndes_ceo_reg_city'];
$asscn_atndes_ceo_reg_city = "Bangalore";

$gt_asscn_name = $_REQUEST['gt_asscn_name'];
...
<script language="javascript" type="text/javascript">
	function validate_asscn_atndes_ceo()
	{
 ...
 <table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1" style=" margin-top:20px;" align="center">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><strong class="small_button"><?php echo $EVENT_NAME;?> : </strong><strong>Confirmation to attend CEO Conclave</strong></div>
...
<form id="form1" name="form1" method="post" onsubmit="return validate_asscn_atndes_ceo()" action="asscn_atndes_ceo_reg_2.php?enq_emler=<?php echo $emler?>">
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="border_style2">
      <tr>
        <td height="291" align="left" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="631" height="16"><input type="hidden" name="asscn_atndes_ceo_reg_city" id="asscn_atndes_ceo_reg_city" value="<?php echo $asscn_atndes_ceo_reg_city;?>" /></td>
          </tr>
          <tr>
         ...
         <tr>
          ...
          <tr>
            <td height="63" align="center" valign="middle"><table width="95%" border="0" cellpadding="0" cellspacing="0" class="border_style1">
              <tr>
                <td width="29%"></td>
                <td width="3%" height="10"></td>
                <td width="43%"></td>
              ...
              <tr>
                <td align="left" valign="top"><span class="blue_text_no_padding"><span class="sitemap-txt">&nbsp;Association Name*</span></span></td>
                <td align="center"><span class="blue_text_no_padding">:</span></td>
                <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="346" align="left" valign="top" class="blue_text_no_padding"><span class="sitemap-txt">
                      <input name="assoc_name" type="text" class="content-txt-without-alignment" id="assoc_name" size="40" maxlength="20" <?php if($gt_asscn_name !=""){?> readonly="readonly" value="<?php echo $gt_asscn_name;?>" <?php } ?> />
                    </span></td>
                    <td width="65" align="left" valign="top" class="blue_text_no_padding">&nbsp;</td>
                  </tr>
                </table></td>
