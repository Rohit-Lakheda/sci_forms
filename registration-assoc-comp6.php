<?php
	...
	for($i=1; $i<= $lmt; $i++) {
	    ...
	    if( ($title == "") || ($fname == "") || ($lname == "") || ($job_title == "") || ($badge == "") || ($email == "")) {
			...
			echo "<script language='javascript'>window.location='registration-assoc-comp5.php?en=$en&a=$assoc_code';</script>";
			exit;	
		}	
	...
	echo "<script language='javascript'>window.location = 'registration-assoc-comp7.php?en=$en&a=$assoc_code';</script>";
	exit;
	...
	echo "<script language='javascript'>window.location = 'registration7.php?en=$en&a=$assoc_code';</script>";
	exit;
?>