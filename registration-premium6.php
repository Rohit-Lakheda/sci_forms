<?php
	...
	for($j = 1; $j <= $lmt; $j ++) {
		...
		if ($num_row > 0) {
			...
			echo "<script language='javascript'>window.location = ('registration-premium5.php?ret=retds4fu324rn_ed24d3it&en=" .$en . "&a=" .$a . "&assoc_name=" .$assoc_name."');</script>";
			exit;
		}
		...
		if ($num_row > 0) {
			...
			if($qr_gt_user_data_ans_row['pay_status'] == 'Not Paid') {
				...
				echo "<script language='javascript'>window.location='registration-premium5.php?en=$en&assoc_name=$assoc_name';</script>";
				exit ();*/
				echo "<script language='javascript'>window.location = 'registration-premium9.php?id=" . $qr_gt_user_data_ans_row['tin_no'] . "';</script>";
				exit;
			}
	...
	echo "<script language='javascript'>window.location = 'registration-premium7.php?en=$en&assoc_name=$assoc_name';</script>";
	exit;
?>