...
<div id='container'>
		...
		<form id='form1' action='' method='post'>
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'><a href='http://www.interlinx.in/BIO2017/index.php' target='_blank'>Click Here</a> to login to ".$EVENT_NAME." ".$EVENT_YEAR." InterlinX.</td>
            </tr>
            <tr>
              <td height='10' valign='top' class='style4'>&nbsp;</td>
              <td colspan='4' valign='top' class='style4'></td>
