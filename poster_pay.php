<?php
	...
	$qr =  mysqli_query($link,"SELECT * FROM ".$PSTR_TBL_NAME." WHERE tin_no= '$tin_id'")or die(mysqli_error($link));
...
<table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1"  align="center">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><?php echo $EVENT_NAME . ' ' . $EVENT_YEAR; ?>: Poster Submission Detail </div>
