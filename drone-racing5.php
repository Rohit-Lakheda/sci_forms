<?php
	...
	//$qr_gt_user_data_id = mysqli_query($link,"SELECT * FROM ".$EVENT_DB_FORM_DRONE_RACING." WHERE tin_no = '$tin_no' AND reg_id='$reg_id'");
	$qr_gt_user_data_id = mysqli_query($link,"SELECT * FROM ".$EVENT_DB_FORM_DRONE_RACING." WHERE tin_no = '$tin_no'");
														...
														<div class="tab-pane active">
										                                    	...
										                                    	<table class="table table-striped table-bordered table-hover">
										                                            <tbody>
										                                            	<tr>
										                                                    ...
										                                                    <td> <?php echo $qr_gt_user_data_ans_row['fname'] . ' ' . $qr_gt_user_data_ans_row['lname']; ?> </td>
										                                                </tr>
										                                                <tr>
										                                                    <td> <strong>Pilot CallSign or Nickname</strong> </td>
										                                                    <td> <?php echo $qr_gt_user_data_ans_row['nickname']; ?> </td>
										                                                </tr>
										                                                <tr>
										                                                ...
										                                                <tr>
										                                                    ...
										                                                    <td> <?php echo $qr_gt_user_data_ans_row['dob']; ?> </td>
										                                                </tr>
										                                                <tr>
										                                                    <td> <strong>Gender</strong> </td>
										                                                    <td> <?php echo $qr_gt_user_data_ans_row['gender']; ?> </td>
										                                                </tr>
										                                                <tr>
										                                                ...
										                                                <tr>
										                                                    ...
										                                                    <td> <?php echo $qr_gt_user_data_ans_row['skill_level']; ?> </td>
										                                                </tr>
										                                                <tr>
										                                                    <td> <strong>Drone Experience</strong> </td>
										                                                    <td> <?php echo $qr_gt_user_data_ans_row['drone_experience']; ?> </td>
										                                                </tr>
										                                                <tr>
										                                                ...
										                                                <tr>
										                                                    ...
										                                                    <td> <?php echo $qr_gt_user_data_ans_row['pay_status']; ?> </td>
										                                                </tr>
										                                            </tbody>
										                                        </table>
										                                    </div>
										                                    <div class="table-scrollable">
										                                    	<?php if($qr_gt_user_data_ans_row['paymode'] == "Bank Transfer") { ?>
											                                        <table class="table table-striped table-bordered table-hover">
																						<tbody>
																							<tr>
																								<td colspan="2" class="success">Indian Delegates are requested to Bank Transfer the registration fees to the following account</td>
																							</tr>
																							<tr>
																								<td>Account Name :</td>
																							...
																							<tr>
																								<td colspan="2" class="success">International Delegates are requested to Bank Transfer the registration fees to the following account</td>
																							</tr>
																							<tr>
															...
															<div class="note note-danger">
																...
																<p>Please DO NOT print this page. This page print not accepted in event.
																	<br />You need to click on <strong>Print</strong> button OR <a class="alert-link" href="reg_pay_dr_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>" target="_blank">Click here </a>to generate printable receipt.
																</p>
															</div>
														</div>
													</div>
	                                            ...
	                                            <div class="form-actions">
	                                                <div class="row">
	                                                    <div class="col-md-offset-3 col-md-9">
															<a href="reg_pay_dr_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>" class="btn blue sbold uppercase green-jungle" type="submit" name="make_payment" value="1">
