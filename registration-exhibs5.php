		...
		<div class="portlet light bordered" id="registration_form_3">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Standard Exhibitior Complimentary Premium Delegates Registration Form
					</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="registration-exhibs6.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_3" id="reg_registration_form_3" method="post" onsubmit="return validate_registration_form_3();">
...
<script>
    ...
    function go_back11() {
    	...
    	window.location=('registration-exhibs.php?ret=retds4fu324rn_ed24d3it&en=' + en + a + assoc_nameurl2);
    }
</script>
