...
if ($ret == "retds4fn324rn_ed24d3it") {
	...
	if ((!isset($_SESSION["vercode_ex"])) || ($_SESSION["vercode_ex"] == '')) {
		...
		echo "<script language='javascript'>window.location = ('exhibitor_payment_form_tie.php');</script>";
		exit();
	}
		...
		<div class="portlet light bordered" id="registration_form_1">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase">
						Exhibitor Registration For Tie-Bangalore(Non-members) StartUps
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d') <= '2023-11-29') { ?>
					<form action="exhibitor_payment_form_tie2.php<?php echo !empty($ret) ? '?rt=' . $ret : ''; ?>" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" enctype="multipart/form-data" onsubmit="return validate_ex();">
												...
												<table class="table table-bordered tariff-table" style="border: thin solid #dddddd; box-shadow: 5px 5px 5px 0 rgb(219, 219, 219);">
													<thead>
														<tr bgcolor="#E39101" style="color: #fff;">
															<th colspan="6" style="text-align: center;">Exhibition Tariff – Tie-Banglore(Non-members)</th>
														</tr>
														<tr bgcolor="#2fa0dd" style="color: #fff;">
															...
															<th class="align-td" align="center">SPECIAL OFFER FOR Tie-Banglore(Non-members) STALLS</th>
														</tr>
													</thead>
													<tbody>
														<tr class="indian-tariff" style="background-color: #e1e1e1;">
															...
															<td class="align-td" align="center">27,999</td>
														</tr>
														...
														<tr>
															<td colspan="6">
																...
																<p><strong>Entitlements</strong><br>
																	...
																	&bull;&nbsp;Tie-Bangalore Membership<br />
										...
										<div class="main-form">
											...
											<div class="form-group form-md-radios">
												...
												<div class="col-md-9">
													<div class="md-radio-inline">
														<div class="md-radio">
															<input type="radio" id="booth_size1" name="booth_size" class="md-radiobtn" value="4 SQM" checked>
														...
														<div class="md-radio" style="display:none;">
															<input type="radio" id="booth_size2" name="booth_size" class="md-radiobtn" value="4 SQM">
