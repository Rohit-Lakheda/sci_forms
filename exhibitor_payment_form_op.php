...
if ($ret == "retds4fn324rn_ed24d3it") {
	...
	$text = mysqli_escape_string($link, htmlspecialchars($_SESSION["vercode_ex"]));

	$assoc_nm = mysqli_escape_string($link, htmlspecialchars(@$_SESSION['assoc_nm']));
		...
		<div class="portlet light bordered" id="registration_form_1">
				...
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase">
						...
						<?php if (!empty($assoc_nm)) { ?>
							...
							Exhibitor Registration For <?php echo $assoc_nm; ?>
			...
			<div class="portlet-body form">
				...
				<?php if (date('Y-m-d') <= '2025-11-21') { ?>
					...
					<form action="exhibitor_payment_form_op2.php<?php echo !empty($ret) ? '?rt=' . $ret : ''; ?>"
						class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post"
						onsubmit="return validate_ex();">
									...
									<li>
										...
										<a data-toggle="tab" class="step dips-default-cursor">
											...
											<span class="desc">
												...
												<i class="fa fa-check"></i> Submit Details </span>
									...
									<div class="tab-pane active">
											...
											<div class="col-md-9">
												...
												<div class="md-radio-inline">
													...
													<div class="md-radio">
														...
														<?php /*?><input type="radio" id="Foreign" name="curr" class="md-radiobtn" value="International" onclick="show_cata();" required="required">
										...
										<div class="row">
											...
											<div class="col-md-offset-2 col-md-7 table-responsive1">
												...
												<table class="table table-bordered tariff-table"
													...
													<thead>
														...
														<tr bgcolor="#2fa0dd" style="color: #fff;">
															...
															<th class="align-td" style="text-align:center;" align="center">

																OPTION</th>

															<th class="align-td" align="center" style="text-align:center;">
															...
															if ($assoc_nm == "IESA") { ?>
																...
																<th class="align-td" align="center">IESA RATE @ 15% DISOCUNT
																</th>
															...
															<!-- <th class="align-td" align="center">SPECIAL OFFER FOR FIRST 100 STALLS</th> -->
													...
													<tbody>
														...
														<tr class="indian-tariff" style="background-color: #e1e1e1;">
															...
															<td class="align-td" align="center">Raw Space</td>

															<td class="align-td" align="center">12000</td>

															<?php if ($assoc_nm == "IESA") { ?>

																<td class="align-td" align="center">11050</td>

															<?php }

															?>

															<!-- <td class="align-td" align="center">48,000</td> -->

															<!-- <td class="align-td" align="center">24,999</td> -->
														...
														<tr class="indian-tariff1" style="background-color: #e1e1e1;">
															...
															<td class="align-td" align="center">Shell Space</td>

															<td class="align-td" align="center">13000</td>

															<?php if ($assoc_nm == "IESA") { ?>

																<td class="align-td" align="center">11900</td>
															...
															<!-- <td class="align-td" align="center">72,000</td> -->
																					  ...
																					  <tr>
																						  ...
																						  <td colspan="6">
																							  ...
																							  <p><strong>Entitlements</strong><br>		
																								  ...
																								  &bull;&nbsp;Fully furnished booth with wall to wall carpet, 1 table, 2 chairs, 3 spot lights, one 5 amp electrical connection and fascia with name of organisation displayed.<br/>

																								  &bull;&nbsp;One Complementary delegate registrations to access Inaugural Function, Plenary Talks, Technical Sessions in IT &amp; DeepTech, Start-Up, Biotech, GIA and India USA Tech conclave tracks, IT Export Awards, Smart Bio Awards and Start-up Unicorns Felicitation, Rural IT Quiz, Bio Quiz, Biotech Posters and B2B partnering etc.<br/>

																								  &bull;&nbsp;Two Exhibitor Batches to manage the booth.<br/>			

																								  &bull;&nbsp;Listing of Organization information in the event directory<br/>
												...
												<p><strong>Note:</strong><br />
													...
													- Raw Space is subject to minimum of 36sqm

												</p>

												<p><strong>Entitlements</strong><br>

													<strong>Each 9 Sqm Booth – Shell Space</strong><br />

													&bull;&nbsp;Fully furnished booth with wall to wall carpet, 1 table, 2
													chairs, 3 spot lights, one 5amp

													&nbsp;&nbsp;electrical connection and fascia with name of organisation
													displayed.<br />

													&bull;&nbsp;One Complementary delegate registrations<br />

													&bull;&nbsp;Two Exhibitor Badges to manage the booth.<br />

													&bull;&nbsp;Listing of Organization information in the e-directory<br />

													<br />

													<strong>Raw Space Note: minimum 36 sqm</strong><br />

													&bull;&nbsp;In case of raw space, only space will be provided. Extra
													charges will be applicable for

													&nbsp;&nbsp;power, carpet or any other facility required.<br />

													&bull;&nbsp;The design and fabrication of the booth should be done from
													client.<br />

													&bull;&nbsp;The booth should not be destructing the view or disturbing
													the aesthetics of any other co-

													&nbsp;&nbsp;exhibitor. Organiser holds the final right to stop/alter the
													design if needed.<br />

													&bull;&nbsp;All drawings/designs showing stand construction have to be
													submitted and approved by

													&nbsp;&nbsp;the Event Partner, who reserves the right to recommend
													changes/modification, in the

													&nbsp;&nbsp;interest of the overall presentation of the exhibition.
													Exhibitors have to ensure that the

													&nbsp;&nbsp;changes recommended are carried out.<br />

													&bull;&nbsp;The maximum height permitted is as follows: Front Area 8ft;
													Middle Area 12ft &amp; Rear Area

													&nbsp;&nbsp;10ft.<br />

													&bull;&nbsp;4 Complementary delegate registrations<br />

													&bull;&nbsp;8 Exhibitor Badges to manage the booth.<br />
										...
										<div class="main-form">
											...
											<div class="form-group">
												...
												<label class="control-label col-md-3"> Select Booth Space <span
														class="required"> * </span> </label>

												<div class="col-md-6">

													<select id="booth_space" name="booth_space" class="form-control"
														required="required">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													...
													<select id="booth_size" name="booth_size" class="form-control"
														required="required">
											...
											$countryList = array(
												...
												// '9' => '9sqm (9sqm x Rs. 13,000) Raw Space = 1,17,000 + 18% GST',
										
												'9s' => '9sqm (9sqm x Rs. 13,000) Shell Space = 1,17,000 + 18% GST',

												'12s' => '12sqm (12sqm x Rs. 13,000) Shell Space = 1,56,000 + 18% GST',

												// '15' => '15sqm (15sqm x Rs. 13,000) Raw Space = 1,95,000 + 18% GST',
										
												'15s' => '15sqm (15sqm x Rs. 13,000) Shell Space = 1,95,000 + 18% GST',

												// '18' => '18sqm (18sqm x Rs. 13,000) Raw Space = 2,34,000 + 18% GST',
										
												'18s' => '18sqm (18sqm x Rs. 13,000) Shell Space = 2,34,000 + 18% GST',

												// '27' => '27sqm (27sqm x Rs. 13,000) Raw Space = 3,51,000 + 18% GST',
										
												'27s' => '27sqm (27sqm x Rs. 13,000) Shell Space = 3,51,000 + 18% GST',

												//30sqm (30sqm x Rs13,000) Raw Space = 3,90,000 + 18% GST
										
												// '30' => '30sqm (30sqm x Rs. 13,000) Raw Space = 3,90,000 + 18% GST',
										
												'36' => '36sqm (36sqm x Rs. 12,000) Raw Space = 4,32,000 + 18% GST',

												// '36s' => '36sqm (36sqm x Rs. 14,000) Shell Space = 5,04,000 + 18% GST',
										
												'48' => '48sqm (48sqm x Rs. 12,000) Raw Space = 5,76,000 + 18% GST',

												// '48s' => '48sqm (48sqm x Rs. 14,000) Shell Space = 6,72,000 + 18% GST',
										
												'54' => '54sqm (54sqm x Rs. 12,000) Raw Space = 6,48,000 + 18% GST',

												// '54s' => '54sqm (54sqm x Rs. 14,000) Shell Space = 7,56,000 + 18% GST',
										
												'72' => '72sqm (72sqm x Rs. 12,000) Raw Space = 8,64,000 + 18% GST',

												// '72s' => '72sqm (72sqm x Rs. 14,000) Shell Space = 10,08,000 + 18% GST',
										
												//'100' => '100sqm (100sqm x Rs. 13,000) Raw Space = 13,00,000 + 18% GST',
										
												// '100s' => '100sqm (100sqm x Rs. 14,000) Shell Space = 14,00,000 + 18% GST',
										
												'108' => '108sqm (108sqm x Rs. 12,000) Raw Space = 1,296,000 + 18% GST',
												'126' => '126sqm (126sqm x Rs. 12,000) Raw Space = 1,512,000 + 18% GST',

												'135' => '135sqm (135sqm x Rs. 12,000) Raw Space = 1,620,000 + 18% GST',
											...
											<script>
												...
												// JavaScript to handle dynamic population of booth size dropdown based on the selected booth space

												document.getElementById("booth_space").addEventListener("change", function () {

													var boothSpace = this.value;

													var boothSizeDropdown = document.getElementById("booth_size");

													boothSizeDropdown.innerHTML = ""; // Clear existing options

													var options = <?php echo json_encode($countryList); ?>;



													// Filter options based on selected booth space

													for (var key in options) {

														if (options.hasOwnProperty(key)) {

															if ((boothSpace === "Raw" && key.endsWith("s")) || (boothSpace === "Shell" && !key.endsWith("s"))) {

																continue; // Skip options that don't match the selected booth space
															...
															boothSizeDropdown.appendChild(option);
											...
											<?php /*<div class="form-group form-md-radios">
																  ...
																  <label class="control-label col-md-3">Select Booth size <span class="required"> * </span> </label>
																  ...
																  <div class="col-md-9">
																	  ...
																	  <div class="md-radio-inline">
																		  ...
																		  <div class="md-radio">
																			  ...
																			  <input type="radio" id="booth_size1" name="booth_size" class="md-radiobtn" value="4 SQM">
																			  ...
																			  <span class="box"></span> 4 SQM

																			  </label>

																		  </div>

																		  <div class="md-radio" style="display:none1;">

																			  <input type="radio" id="booth_size2" name="booth_size" class="md-radiobtn" value="6 SQM">

																			  <label for="booth_size2">

																			  <span></span>

																			  <span class="check"></span>

																			  <span class="box"></span> 6 SQM
											...
											<script>
												...
												function updateSubsectors() {
													...
													if (!sectorSelect || !subsectorSelect || !subsectorDiv || !otherSectorDiv) {
														return;
													}
												...
												// Initialize subsectors and attach change listener
												(function initSubsectorBehaviour() {
													// Update once now (in case DOMContentLoaded already fired)
													updateSubsectors();

													// Attach listener to update when sector changes (guarding for missing element)
													const sectorSelect = document.getElementById('sector');
													if (sectorSelect) {
														sectorSelect.addEventListener('change', updateSubsectors);
													}

													// If a saved subsector exists in session, safely inject it and restore selection
													<?php if (isset($_SESSION['sess_subsector']) && $_SESSION['sess_subsector']) { ?>
														setTimeout(function() {
															const subsectorSelect = document.getElementById('subsector');
															const savedSubsector = <?php echo json_encode($_SESSION['sess_subsector']); ?>;
															...
															if (typeof showOtherDiv === 'function') {
																showOtherDiv();
															}
														}, 100);
													<?php } ?>
																  ...
																  <div class="form-group">
																	  ...
																	  <div class="col-md-6">
																		  ...
																		  <select id="subsector" name="subsector" class="form-control" required="required" onchange="showOtherDiv();">
																			  ...
																			  $countryList = array('IT', 'IoT', 'AI & ML', 'AR & VR', 'BlockChain', 'Digital Learning', 'Electronics', 'FinTech', 'Robo & Drone', 'Gaming', 'Mobility', 'IT Services', 'BioTech', 'AgriTech', 'MedTech', 'Healthtech', 'SmartTech', 'Cyber security & Human Resource', 'Other');
											...
											<div class="form-group">
												...
												<label class="control-label col-md-3"> Select Category <span
														class="required"> * </span>
												...
												<div class="col-md-6">
													...
													<select id="delegate_type" name="delegate_type" class="form-control"
														required="required">
											...
											<div class="form-group">
												...
												<div class="col-md-2"><input type="text" class="form-control" name="zip"
													...
													placeholder="Postal Code" required="required" inputmode="numeric" 
													maxlength="6" pattern="[1-9][0-9]{5}" 
													title="Enter 6-digit PIN code (first digit cannot be 0)" /></div>
											...
											<div class="form-group">
												...
												<div class="col-md-6" style="margin-top: -15px;">
													...
													<input name="fon" type="text" id="fon" class="form-control"
														maxlength="10" value="<?php echo @$_SESSION['sess_fon']; ?>"
														required onkeyup="check_num(event, 'fon');"
														style="padding-left: 92px;"  />

													<span class="help-block">+Country Code-Area Code-Contact Number(Eg. 91-123412345)</span>
												...
												<label class="col-md-3 control-label">TAN Number<span class="dips-required">

														* </span></label>

												<div class="col-md-3">

													<select id="tan" name="tan" class="form-control" onchange="hidetan();"
														required="required">

														<option value="">- Select -</option>

														<option value="Registered" <?php if (!empty($_SESSION['tan']) && $_SESSION['tan'] != 'Unregistered')

															echo 'selected=selected'; ?>>

															Registered</option>

														<option value="Unregistered" <?php if (!empty($_SESSION['tan']) && $_SESSION['tan'] == 'Unregistered')
												...
												<div class="col-md-3" style="display:none;" id="tan-div">

													<input type="text" class="form-control" name="tan_number"
														id="tan_number" value="<?php echo $_SESSION['tan_number']; ?>"
														placeholder="Enter TAN Number" maxlength="10"
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="text" class="form-control" name="pan_number"
														id="pan_number"
														value="<?php echo strtoupper($_SESSION['pan_number']); ?>"
														maxlength="10" placeholder="E.g. ABCDE1234F" required
											...
											<div class="form-group">
												...
												<label class="col-md-3 control-label">Sales Executive Name <span
														style="font-size:10px;">&nbsp;(From SCI 2025 Team)</span> <span
														class="dips-required"> * </span></label>

												<div class="col-md-6">

													<input type="text" class="form-control" name="sales_exec"
														id="sales_exec" value="<?php echo @$_SESSION['sales_exec']; ?>"
														required="required" />
											...
											<input type="hidden" id="Cc" name="paymode" class="md-radiobtn"
													...
													<table class="table table-striped table-bordered table-hover "
														...
														<tbody>
															...
															<?php /*<tr>
																							  ...
																							  <td style="width: 828px;">Prawaas.BIZ </td>
 ...
 <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group" style="display: inline-flex;align-items: center;width: 100%;">
                                            <input name="vercode_ex" id="captcha" type="text" class="form-control"
...
<script src="js/exhibitor-payment_op.js?546asd45"></script>
