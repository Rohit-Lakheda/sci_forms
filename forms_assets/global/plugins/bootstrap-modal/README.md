...
+ Include `js/bootstrap-modalmanager.js` and `js/bootstrap-modal.js` after the main bootstrap js files.
	...
	<link href="forms-css/bootstrap-responsive.css" rel="stylesheet" />
 	<link href="forms-css/bootstrap-modal.css" rel="stylesheet" />

 	<script src="forms-js/bootstrap.js"></script>
 	<script src="forms-js/bootstrap-modalmanager.js"></script>
 	<script src="forms-js/bootstrap-modal.js"></script>
