<?php
	...
	echo "<script language='javascript'>window.location = 'registration-assoc-conf-vip.php?ret=retds4fu324rn_ed24d3it&a=$assoc_code';</script>";
	exit;
	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_3">
			...
			<div class="portlet-body form">
				<form action="registration-assoc-conf6.php?a=<?php echo $a;?>" class="form-horizontal" name="reg_registration_form_3" id="reg_registration_form_3" method="post" onsubmit="return validate_registration_form_3();">
						...
						<div class="form-body">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<table class="table table-hover1 table-bordered teriff-table">
										<?php /*<tbody>
											<tr bgcolor="#2fa0dd" style="color: #fff;">
									...
									<div class="form-group">
										...
										<div class="col-md-6" style="margin-top: 8px;">Complimentary Delegate
											<input type="hidden" id="catagory<?php echo $i; ?>" name="catagory<?php echo $i; ?>" value="Complimentary Delegate" />
...
<script>
    ...
    function go_back11() {
    	...
    	window.location=('registration-assoc-conf.php?ret=retds4fu324rn_ed24d3it&en=' + en + a + assoc_nameurl2);
    }
</script>
