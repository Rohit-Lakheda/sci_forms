...
$ORGANISATION_NAME = "Bengaluru Tech Summit Secretariat";
$EVENT_NAME = "Bengaluru Tech Summit";
$EVENT_NAME1 = 'Bengaluru Tech Summit';
$EVENT_YEAR = "2024";
$EVENT_DATE = "19 - 21 Nov, " . $EVENT_YEAR;
$EVENT_WEBSITE_LINK = "https://bengalurutechsummit.com/";
$EVENT_WEBSITE_LINK_NAME = 'www.bengalurutechsummit.com';
$EVENT_WEBSITE_LINK1 = "http://www.bengaluruindiabio.in/";
$EVENT_WEBSITE_LINK_NAME1 = 'www.bengaluruindiabio.in';
//$EVENT_LOGO_LINK1 = $EVENT_WEBSITE_LINK1 . "images/logo.png";	
$EVENT_FORM_LINK = $EVENT_WEBSITE_LINK . "web/it_forms/";
$EVENT_LOGO_LINK1 = $EVENT_LOGO_LINK = $EVENT_LOGO_URL = $EVENT_FORM_LINK . "images/logo.png";
$EVENT_LOGO_EMAILER = $EVENT_FORM_LINK . "images/logo.png";
//$EVENT_ENQUIRY_EMAIL = "enquiry@bengaluruite.biz";
//$EVENT_ENQUIRY_EMAIL_2 = "enquiry@bengaluruindiabio.in";
$EVENT_SECRETERIATE_PERSON_EMAIL_ID = $EVENT_ENQUIRY_EMAIL_2 = $EVENT_ENQUIRY_EMAIL = "enquiry@bengalurutechsummit.com";

$EVENT_TBL_PREFIX = "it";
$EVENT_TABLE_PRFIX = "it";
...
$FACEBOOK_PAGE = 'https://www.facebook.com/BengaluruTechSummit/';
$TWITTER_PAGE = 'https://twitter.com/blrtechsummit';
$SERVICE_TAX = 18;
$EVENT_SECRT_ADDR = "No.11/3, NITON,<br /> Block C, 2nd Floor,<br /> Palace Road, Bengaluru - 560 001, India<br />Tel:  +91.80.4113 1912/3<br/>Website: <a href='http://www.bengalurutechsummit.com' target='_blank'>www.bengalurutechsummit.com</a>";

$EVENT_SECRT_ADDR_2 = $EVENT_SECRT_ADDR;

$EVENT_ADDR = "Bengaluru, India";
$EVENT_PAY_LINK = "https://www.mmactiv.in/pay/it-2024/enter_reg_tin_no.php";
$EVENT_PAY_LINK_DR = "https://www.mmactiv.in/pay/it-2024/enter_reg_tin_no_dr.php";
$EVENT_OL_PAY_ACT_LINK = "https://www.mmactiv.in/pay/it-2024/reg_pay_1.php";
$EVENT_OL_PAY_ACT_LINK_DR = "https://www.mmactiv.in/pay/it-2024/reg_pay_dr_1.php";
$EVENT_PAY_LINK_EX = "https://www.mmactiv.in/pay/it-2024/enter_reg_tin_no_ex.php";
$EVENT_OL_PAY_ACT_LINK_EX = "https://www.mmactiv.in/pay/it-2024/reg_pay_ex_1.php";
$EVENT_OL_PAY_ACT_LINK_POSTER = "https://www.mmactiv.in/pay/it-2024/poster_pay.php";
$EVENT_VENUE = "Bengaluru Palace, Bengaluru, India.";
...
$MMACTIV_LOGO = "https://www.bengalurutechsummit.com/web/it_forms/images/MMA.jpg";
$PAYMENT_REDIRECT_LINK = "https://www.mmactiv.in/pay/it-2024/redirecturl.php";
$EVENT_INTERLINX_LINK = "https://www.bengalurutechsummit.com/web/interlinx-2024";
$EVENT_INTERLINX_LOGO = "https://www.bengalurutechsummit.com/web/interlinx-2024/assets/img/interlinx-logo.png";
...
$PAYPAL_PROCESSING_CHARGE_PER = 9.3;
...
$CANCEL_URL = $EVENT_WEBSITE_LINK . 'web/paypal/paypal.php';
$NOTIFY_URL = $EVENT_WEBSITE_LINK . 'web/paypal/payment.php';
$RETURN_URL = $EVENT_WEBSITE_LINK . 'web/paypal/success.php';

$CANCEL_URL_POSTER = $EVENT_WEBSITE_LINK . 'web/paypal/paypal_poster.php';
$NOTIFY_URL_POSTER = $EVENT_WEBSITE_LINK . 'web/paypal/payment_poster.php';
$RETURN_URL_POSTER = $EVENT_WEBSITE_LINK . 'web/paypal/success_poster.php';

$CANCEL_URL_EXHIBITOR = $EVENT_WEBSITE_LINK . 'web/paypal/paypal_exhibitor.php';
$NOTIFY_URL_EXHIBITOR = $EVENT_WEBSITE_LINK . 'web/paypal/payment_exhibitor.php';
$RETURN_URL_EXHIBITOR = $EVENT_WEBSITE_LINK . 'web/paypal/success_exhibitor.php';

$CURRENCY_CODE = 'USD';
$EVENT_PAY_LINK_PAYPAL = $EVENT_WEBSITE_LINK . "web/paypal/enter_reg_tin_no.php";
...
$EVENT_DB_FORM_EXHIBITOR_DIR_CONTACT_PERSON_NAME = "Mrs. Ambika Shetty";
$EVENT_DB_FORM_EXHIBITOR_DIR_CONTACT_PERSON_EMAIL = "ambika.kiran@mmactiv.com";
...
$EVENT_DB_FORM_EXHIBITOR_DIR_COMP_CONTACT_PERSON_NAME = "Mr. Chandra Chood";
$EVENT_DB_FORM_EXHIBITOR_DIR_COMP_CONTACT_PERSON_EMAIL = "chandrachood.as@mmactiv.com";
$EVENT_DB_FORM_EXHIBITOR_DIR_COMP_CONTACT_PERSON_MOBILE_NO = "91-9964195859 ";
...
$DAY1 = 'DAY 1 - Tuesday, 19TH NOVEMBER, 2024';
$DAY2 = 'DAY 2 - Wednesday, 20TH NOVEMBER, 2024';
$DAY3 = 'DAY 3 - Thursday, 21ST NOVEMBER, 2024';
...
$EVENT_DB_PRN_NO = "PRN-BTS" . $EVENT_YEAR . "-";
$EVENT_DB_EXI_ID = 'BTS' . $EVENT_YEAR . "_EXB_";
/***
		TIN NO End
 ***/
...
$ENQUIRY_WNT_INFO_ARR = array('Attending as Delegate', 'Speaking Opportunity', 'Exhibiting', 'Sponsoring', 'B2B Meetings', 'Visitor', 'Poster', 'Other');
...
$ENQUIRY_EMAIL_WNT_INFO_WISE[$ENQUIRY_WNT_INFO_ARR[6]][0] = "prabha.j@mmactiv.com";
...
$ENQUIRY_RECIPIENTS_ADMIN_MAIL = array('', $EVENT_ENQUIRY_EMAIL, '', 'test.interlinks@gmail.com', '', 'ambika.kiran@mmactiv.com', '', 'gurunath.angadi@mmactiv.com');

$ENQUIRY_FROM_NAME_USER_MAIL = $EVENT_NAME . " " . $EVENT_YEAR;
$ENQUIRY_FROM_EMAIL_USER_MAIL = $EVENT_ENQUIRY_EMAIL;
...
$SPON_ENQUIRY_RECIPIENTS_ADMIN_MAIL = array($EVENT_ENQUIRY_EMAIL, 'test.interlinks@gmail.com', '', 'bhavya.mmactiv@gmail.com');
...
$JN_MA_LST_RECIPIENTS_ADMIN_MAIL = array($EVENT_ENQUIRY_EMAIL, 'test.interlinks@gmail.com', '', 'bhavya.mmactiv@gmail.com');
...
$RSVP_RECIPIENTS_ADMIN_MAIL = array('', $EVENT_ENQUIRY_EMAIL, '', $EVENT_ENQUIRY_EMAIL_2, '', 'vani.faustina@mmactiv.com', '', 'bhavya.n@mmactiv.com');

if (isset($rsvp_city) && $rsvp_city == 'New_Delhi') {
  //$RSVP_DAY = "Monday";
  $RSVP_NAME = 'Bengaluru Tech Summit 2024 Curtain Raiser @ New Delhi';
  $RSVP_HEADING = 'Bengaluru Tech Summit 2024 Curtain Raiser @ New Delhi';
  $RSVP_DATE = "Tuesday, 31st October 2024";
  $RSVP_DATE1 = "Tuesday, 31<sup>st</sup> October, 2024";
...
} else if (isset($rsvp_city) && $rsvp_city == 'Mysuru') {
  //$RSVP_DAY = "Monday";
  $RSVP_NAME = 'CEO Conclave & STPI IT Export Awards';
  $RSVP_HEADING = 'RSVP for Bengaluru Next CEO Conclave & STPI IT Export Awards';
  $RSVP_DATE = "14th Nov, 2024";
  $RSVP_DATE1 = "14<sup>th</sup> Nov, 2024";
  $RSVP_TIME = "5:00 PM to 7:00 PM";
  $RSVP_CITY = 'Bengaluru';
  $RSVP_LOCATION = "WestEnd Court, Taj West End, Race Course Road, Bengaluru";
  $RSVP_PROG = 'Function followed by Networking Dinner';
  $RSVP_FROM_NAME_USER_MAIL = $EVENT_NAME . " " . $EVENT_YEAR;
  $RSVP_FROM_EMAIL_USER_MAIL = $EVENT_ENQUIRY_EMAIL;
  $RSVP_FROM_SUBJECT_USER_MAIL = "Thank you for RSVP on " . $RSVP_HEADING;
  $RSVP_RECIPIENTS_USER_MAIL = array('test.interlinks@gmail.com');
 ...
 *****/
$PSTR_LAST_DATE_OF_SUB = "November 22th, 2024";
$PSTR_LAST_DATE_OF_SUB_HTML = "22<sup>th</sup> November, 2024.";
$PSTR_LAST_DATE_OF_SUB1 = '2024-07-27 23:59';
$PSTR_REG_FEE = "";
...
$VSTR_DAY1_TIME = 'Tuesday, 19 NOVEMBER,2024 - 12:00 PM - 06:00PM';
$VSTR_DAY2_TIME = 'Wednesday, 20 NOVEMBER,2024 - 10:00 AM - 06:00PM';
$VSTR_DAY3_TIME = 'Thursday, 21 NOVEMBER,2024 - 10:00 AM - 04:00PM';


$VSTR_DAY1_TIME_STUD = 'Tuesday 19 NOVEMBER,2024 - 02:00 PM - 06:00PM';
$VSTR_DAY2_TIME_STUD = 'Wednesday, 20 NOVEMBER,2024 - 02:00 PM - 06:00PM';
$VSTR_DAY3_TIME_STUD = 'Thursday, 21 NOVEMBER,2024 - 02:00 PM - 04:00PM';
...
function callUniversalAPI($data)
{
  if (isset($data['category_id']) && ($data['category_id'] == 743 || $data['category_id'] == 722 || $data['category_id'] == 734 || $data['category_id'] == 735 || $data['category_id'] == 736 || $data['category_id'] == 733 || $data['category_id'] == 739 || $data['category_id'] == 729 || $data['category_id'] == 728)) {
    ...
    $sql = "INSERT INTO it_2024_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request, response) VALUES('$data[name]','$data[email]','$login_link','$category_id','$data[print_val]','$response[success]','$msg','$date', '$request', '$result')";
...
/**
 * This function save the Speaker data
 */
function callExhibitorAPI($data)
{
  //$data['ticket_id']= 31424;
  $data['event_id'] = 117619;
  //print_r($data);
  $result = callAPI($data, 'https://studio.chkdin.com/api/v1/push_exhibitor');

  $response = json_decode($result, true);
  //print_r($response);exit;
  $request = json_encode($data);
  $date = date('Y-m-d H:i:s');
  $sql = "INSERT INTO it_2024_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request) VALUES('$data[company_name]','$data[email]','$data[booking_id]','$data[ticket_id]','','$response[status]','$response[message]','$date', '$request')";
  mysqli_query($link,$sql);
 ...
 * This function save the delegate data
 */
function callUniversalAPIPaidDel($data)
{
  //return;
  /*if($data['email'] != 'vivekcashf@gmail.com') {
			return;
		}*/
  /*//print_r(json_encode($data));exit;
	// $data['ticket_id']= $ticket_id;
	...
	$sql = "INSERT INTO it_2024_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request, response) VALUES('$data[name]','$data[email]','$login_link','','$category_id','$response[success]','$msg','$date', '$request', '$result')";
	mysqli_query($link,$sql);
 ...
 * This function save the delegate data
 */
function callUniversalAPIPaypal($data)
{
  /*return;

	if ($data['email'] != 'vivekpaypal@gmail.com') {
		return;
	}
	//print_r(json_encode($data));exit;
	// $data['ticket_id']= $ticket_id;
	$data['event_id'] = 177619;
	$result = callAPI($data);
	//print_r($result);//exit;
	$response = json_decode($result, true);
	//print_r($response);exit;
 ...
 * This function save the delegate data
 */
function callDelegateAPI($data)
{
  /* $data['ticket_id']= 31036;
		...
		$request = json_encode($data);
		$date = date('Y-m-d H:i:s');
		$sql = "INSERT INTO it_2019_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request) VALUES('$data[name]','$data[email]','$data[booking_id]','$data[ticket_id]','Delegate','$response[status]','$response[message]','$date', '$request')";
		mysqli_query($link,$sql);
...
function callSpeakerAPI($data)
{
  /* $data['ticket_id']= 31424;
		...
		$request = json_encode($data);
		$date = date('Y-m-d H:i:s');
		$sql = "INSERT INTO it_2019_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request) VALUES('$data[name]','$data[email]','$data[booking_id]','$data[ticket_id]','Speaker','$response[status]','$response[message]','$date', '$request')";
		mysqli_query($link,$sql);
...
/**
 * This function save the Visitor data
 */
function callVisitorAPI($data)
{
  ...
  $request = json_encode($data);
  $date = date('Y-m-d H:i:s');
  $sql = "INSERT INTO it_2024_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request,response) VALUES('$data[name]','$data[email]','$data[booking_id]','$data[category_id]','Visitor','$response[status]','$response[message]','$date', '$request', '$result')";
  mysqli_query($link,$sql);
...
function elastic_mail($subject, $message, $to)
{
  ...
  try {
    ...
    $post = array(
      ...
      'fromName' => "Bengaluru Tech Summit 2024",
...
function elastic_mail_frm($subject, $message, $to, $frm)
{
  ...
  try {
    ...
    $to = implode(";", $to);
    $post = array(
      'from' => $frm, // 'vivek.patil@mmactiv.com',
      'fromName' => "Bengaluru Tech Summit 2024",
      'apikey' => 'E3789A39124B6397F3C4290637E5D57F269ACABD51053D992C4B9A44CB0BA59555EA032B359CC27ACFDC566E585FE74D',
      'subject' => $subject,
      'to' => $to,
...
function callWizVisitorAPI($data)
{
  /*$result = callWizAPI($data);
	...
	$sql = "INSERT INTO it_2024_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request, response) VALUES('$data[name]','$data[email]','$login_link','','','$response[id]','$msg','$date', '$request', '$result')";
	mysqli_query($link,$sql);
