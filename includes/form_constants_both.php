...
$ORGANISATION_NAME = "Super Computing India Secretariat";
$EVENT_NAME = "Super Computing India";
$EVENT_NAME1 = 'Super Computing India';
$EVENT_YEAR = "2025";
...
$EVENT_SECRETERIATE_PERSON_EMAIL_ID = $EVENT_ENQUIRY_EMAIL_2 = $EVENT_ENQUIRY_EMAIL = "scindia2025@gmail.com";
...
$SERVICE_TAX = 18;
$EVENT_SECRT_ADDR = "No.11/6, NITON, Block \"C\",<br /> Second Floor, Palace Road,<br /> Bengaluru - 560001, Karnataka, India<br />Tel:  +91 08069328400<br/>Website: <a href='http://https://sci25.supercomputingindia.org' target='_blank'>https://sci25.supercomputingindia.org</a>";

$EVENT_SECRT_ADDR_2 = $EVENT_SECRT_ADDR;

$EVENT_ADDR = "Bengaluru, India";
$EVENT_PAY_LINK = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/enter_reg_tin_no.php";
$EVENT_PAY_LINK_DR = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/enter_reg_tin_no_dr.php";
$EVENT_OL_PAY_ACT_LINK = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/reg_pay_1.php";
$EVENT_OL_PAY_ACT_LINK_DR = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/reg_pay_dr_1.php";
$EVENT_PAY_LINK_EX = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/enter_reg_tin_no_ex.php";
$EVENT_OL_PAY_ACT_LINK_EX = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/reg_pay_ex_1.php";
$EVENT_OL_PAY_ACT_LINK_POSTER = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/poster_pay.php";
...
$MMACTIV_LOGO = "https://https://sci25.supercomputingindia.org/web/it_forms/images/MMA.jpg";
$PAYMENT_REDIRECT_LINK = "https://https://sci25.supercomputingindia.org/web/pay/it-2025/redirecturl.php";
$EVENT_INTERLINX_LINK = "https://https://sci25.supercomputingindia.org/web/interlinx-2025";
$EVENT_INTERLINX_LOGO = "https://https://sci25.supercomputingindia.org/web/interlinx-2025/assets/img/interlinx-logo.png";
...
$DAY1 = 'DAY 1 - Tuesday, 19TH NOVEMBER, 2025';
$DAY2 = 'DAY 2 - Wednesday, 20TH NOVEMBER, 2025';
$DAY3 = 'DAY 3 - Thursday, 21ST NOVEMBER, 2025';
...
function callUniversalAPI($data)
{
	...
	if (isset($data['category_id']) && ($data['category_id'] == 743 || $data['category_id'] == 722 || $data['category_id'] == 734 || $data['category_id'] == 735 || $data['category_id'] == 736 || $data['category_id'] == 733 || $data['category_id'] == 739 || $data['category_id'] == 729 || $data['category_id'] == 728)) {
		...
		$sql = "INSERT INTO it_2025_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request, response) VALUES('$data[name]','$data[email]','$login_link','$category_id','$data[print_val]','$response[success]','$msg','$date', '$request', '$result')";
...
function callExhibitorAPI($data)
{
	...
	$request = json_encode($data);
	$date = date('Y-m-d H:i:s');
	$sql = "INSERT INTO it_2025_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request) VALUES('$data[company_name]','$data[email]','$data[booking_id]','$data[ticket_id]','','$response[status]','$response[message]','$date', '$request')";
	mysqli_query($link,$sql);
...
function callUniversalAPIPaidDel($data)
{
	...
	/*//print_r(json_encode($data));exit;
	   ...
	   $sql = "INSERT INTO it_2025_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request, response) VALUES('$data[name]','$data[email]','$login_link','','$category_id','$response[success]','$msg','$date', '$request', '$result')";
	   mysqli_query($link,$sql);
...
function callVisitorAPI($data)
{
	...
	$request = json_encode($data);
	$date = date('Y-m-d H:i:s');
	$sql = "INSERT INTO it_2025_reg_api_log(name,email,booking_id,ticket_id,ticket_type,status,message,created_at,request,response) VALUES('$data[name]','$data[email]','$data[booking_id]','$data[category_id]','Visitor','$response[status]','$response[message]','$date', '$request', '$result')";
	mysqli_query($link,$sql);
...
function elastic_mail($subject, $message, $to)
{
	...
	try {
		...
		$post = array(
			...
			'fromName' => "Super Computing India 2025",
