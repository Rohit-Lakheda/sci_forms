...
if (($_SESSION["vercodevp"] == '')) {
	...
	echo "<script language='javascript'>window.location = 'visitor_pass_form1.php?assoc_nm_vp=$temp_assoc_nm_vp';</script>";
	exit;
}
		...
		<div class="portlet light bordered" id="enq_form_2">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Free Business Visitor Registration Form
					</span>
				</div>
			</div>
							...
							<div class="tab-content">
								<div class="tab-pane active">
									<div class="note note-success">
										...
										<p><strong>Day 1: </strong><strong><?php echo $VSTR_DAY1_TIME; ?></strong></p><br />
										<p><strong>Day 2: </strong><strong><?php echo $VSTR_DAY2_TIME; ?></strong></p><br />
										<p><strong>Day 3: </strong><strong><?php echo $VSTR_DAY3_TIME; ?></strong></p><br />
										<?php /* ?><strong><a href="visitor_pass_form4.php?pn=<?php echo $res_vp_d['pass_no'];?>&assoc_nm_vp=<?php echo $temp_assoc_nm_vp;?>" target="_blank" id="text" style="text-decoration:underline; color:#0033FF;">Click here</a> to generate your Visitor Pass. </strong><br/><?php */ ?>
										<br />
										<p>Best Regards,<br />
