<?php
	...
	if ($tin_id == "") {
		...
		if ($tin_id == "") {
			...
			echo "<script language='javascript'>window.location = ('$EVENT_PAY_LINK_DR');</script>";
			exit ();
		}
	} 
	...
	$qr =  mysqli_query($link,"SELECT * FROM ".$EVENT_DB_FORM_DRONE_RACING." WHERE tin_no= '$tin_id'")or die(mysqli_error($link));
	...
	*/
	...
	require "emailer_drone_racing.php";
?>
...
<table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1"  align="center">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><?php echo $EVENT_NAME . ' ' . $EVENT_YEAR; ?>: Night Drone Racing Registration Detail </div>
