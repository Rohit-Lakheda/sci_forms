...
require "exhibitor-form-captcha.php";
...
if (!empty($assoc_nm) && ($assoc_nm != $ASSOC_NAME_EXHIBITOR || $assoc_nm != 'STPI')) {
		...
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-title">
				...
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Exhibitors Directory Form </span>
			...
			<div class="portlet-body form">
				...
				<?php if (date('Y-m-d') <= '2025-11-21') { ?>
					...
					<form action="exhibitor-form2.php" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" onsubmit="return validate_ex();" enctype="multipart/form-data">
								...
								<div class="tab-content">
									...
									<div class="tab-pane active">
										...
										<div class="alert alert-info">
											...
											<span class="block">Dear Sponsor/Exhibitor, <br />Please note: The details submitted through this form will be published in the Exhibitors Directory. Please take necessary precaution to give the correct details.</span>
										...
										<div class="form-group">
											...
											<label class="col-md-3 control-label">Name of the Exhibitor <br /><span style="font-size:10px;">&nbsp;(Organisation Name)</span><span class="dips-required"> * </span></label>
									...
									<div class="form-group">
										...
										<?php if (empty($assoc_nm)) { ?>
											...
											<div class="form-group">
												...
												<label class="col-md-3 control-label">Stall Number <span class="dips-required"> * </span></label>

												<div class="col-md-6">

													<input class="form-control" name="booth_no" type="text" id="booth_no"

														value="<?php echo $_SESSION['sess_booth_no']; ?>" required="required" max="25" />
											...
											<script>
												...
												document.getElementById("booth_no").addEventListener("input", function() {
										...
										<div class="form-group">
											...
											<div class="col-md-2"><input type="text" class="form-control" placeholder="First Name" name="cp_fname" id="cp_fname" maxlength="100" value="<?php if (isset($_SESSION['sess_cp_fname'])) {

																																															echo $_SESSION['sess_cp_fname'];

																																														} ?>" required="required" onkeyup="check_char(event,'cp_fname');"></div>

											<div class="col-md-2"><input type="text" class="form-control" placeholder="Last Name" name="cp_lname" id="cp_lname" maxlength="100" value="<?php if (isset($_SESSION['sess_cp_lname'])) {

																																															echo $_SESSION['sess_cp_lname'];

																																														} ?>" required="required" onkeyup="check_char(event,'cp_lname');"></div>

										</div>

										<div class="form-group">

											<label class="col-md-3 control-label">Contact Person Designation <span class="dips-required"> * </span></label>
										...
										<div class="form-group">
											...
											<label class="col-md-3 control-label">Organisation Address <span class="dips-required"> * </span></label>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											...
											<?php if(!empty($assoc_nm)) { ?>
												...
												<select id="exhi_profile" name="exhi_profile[]" class="form-control" required>
											...
											<?php } else {?>
												...
												<select id="exhi_profile" name="exhi_profile[]" class="form-control" required multiple="multiple">
													...
													<?php $countryList = array('Artificial Intelligence (AI)','Blockchain','ML & Robotics','Internet of Things (IoT)','Telecom','Cyber Security','Intelligent Apps and Analytics','Immersive Experience (AR/VR)','BioPharma','BioAgri','BioIT','BioIndustrial','BioServices','Other');
									...
									<div class="form-group" id="other-div" style="display:none;">
										...
										<div class="form-group" style="">
											...
											<div class="col-md-6">
												...
												<div class="input-group">
													...
													<label class="input-group-btn">
														...
														<span class="btn btn-primary">
															...
															Choose Image&hellip; <input type="file" name="logo" id="logo" class="hide" onchange="updateFileName()" />
												...
												<span class="help-block">Image Dimension should be: 200px(width)x125px(height) & image size less than 100kb. Image format should be JPG, JPEG, PNG & GIF only.</span>
										...
										<span class="help-block col-md-offset-3">This organisational profile will get published in Exhibitors Directory</span>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												...
												<textarea rows="9" cols="" class="form-control exbhi_profile" name="exbhi_profile" id="exbhi_profile" maxlength="700"><?php echo htmlspecialchars($_SESSION['sess_exbhi_profile'], ENT_QUOTES, 'UTF-8'); ?></textarea>

												<span class="help-block"><span id="limit-char">Character count 0/700</span></span>

												<br />

												<span class="help-block"> - Please write at least 250 characters & maximum 700 characters</span>

												<span class="help-block"> -* If you're copying and pasting from an external document, make sure to press enter and then delete that blank enter line to activate profile box.</span>
										...
										<script>
											...
											document.addEventListener('DOMContentLoaded', function() {
												...
												const textarea = document.getElementById('exbhi_profile');

												const charCountSpan = document.getElementById('limit-char');
												...
												function updateCharCount() {
													...
													charCountSpan.textContent = 'Character count ' + currentLength + '/' + maxLength;
												...
												// Track character count during typing
												...
												textarea.addEventListener('input', function() {
													...
													if (currentLength > maxLength) {
														...
														alert('You have reached the maximum character limit of ' + maxLength);
												...
												document.querySelector('form').addEventListener('submit', function(e) {
													...
													if (currentLength < minLength) {
														...
														alert('Current Length: ' + currentLength + '. Please write at least ' + minLength + ' characters.');
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-md-offset-3">
												...
												<div class="note note-success">
													...
													<?php /*<p> If you have any issue with exhibitor, please contact our executive <br />

													</span>Name: <?php echo $EVENT_DB_FORM_DELEGATE_PERSON_NAME;?><br />

													Email: <a href="mailto:<?php echo $EVENT_DB_FORM_DELEGATE_PERSON_EMAIL;?>"><?php echo $EVENT_DB_FORM_DELEGATE_PERSON_EMAIL;?></a><br />

													Mobile: <?php echo $EVENT_DB_FORM_DELEGATE_PERSON_MOBILE_NO;?><br />

													Phone: <?php echo $EVENT_DB_FORM_DELEGATE_PERSON_PHONE_NO;?><br/><br/>

												</p>*/ ?>

													<?php /*<p>	If you have any issue filling exhibitor directory, please contact <br />
													...
													<!-- Phone: <?php echo $EVENT_DB_FORM_EXHIBITOR_DIR_COMP_CONTACT_PERSON_PHONE_NO;?><br/> --><br/>

												</p>*/ ?>

													<p> If you have any technical problem, please contact <br />
	...
	jQuery(document).ready(function() {
		...
		<?php if (empty($assoc_nm)) { ?>
			...
			/*$('#exhi_profile').multiselect({
				...
				nonSelectedText: 'Select Any',

				onChange: function(element, checked) {

					if (checked === true && element.val() == 'Other') {
					...
					} else if (checked === false && element.val() == 'Other') {
