	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if(date('Y-m-d') <= '2025-11-22' && $assoc_nm!="STARTUP-ZONE") {?>
				<form action="exhibitors_form2.php?assoc_nm=<?php echo $assoc_nm;?>" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" onsubmit="return validate_ex();" novalidate>
						...
						<div class="form-body">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<div class="form-group <?php if(($assoc_nm !="STPI") && ($assoc_nm !="STARTUP")) {?>hide<?php }?>">
										...
										<div class="col-md-6">
											<select id="sector" name="sector" class="form-control" required="required">
												<?php if(($assoc_nm !="STPI") && ($assoc_nm !="STARTUP")) {?>
													<?php 
									...
									<?php if(!empty($assoc_nm)) { ?>
										<div class="form-group">
											...
											<div class="col-md-6">
												<?php echo $assoc_nm;?>
												<input type="hidden" value="<?php echo $assoc_nm;?>" name="assoc_nm" id="assoc_nm"/>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-6">
												...
												<option value="">-- Select Exhibitor Sector --</option>
													<?php //$countryList = array('Information Technology'=>'Information Technology', 'Bio Technology'=>'Bio Technology');
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select id="category" name="category" class="form-control" required="required">
												...
												<?php if(!empty($assoc_nm)) {
														$cataList = array('Exhibitor'=>'Exhibitor');
													} else {
														$cataList = array('Exhibitor'=>'Exhibitor', 'Sponsor'=>'Sponsor');
													}
														//$countryList = array('Information Technology'=>'Information Technology');
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select id="booth_space" name="booth_space" class="form-control" required="required">
												...
												<?php if(!empty($assoc_nm)) {
														$cataList = array('Shell'=>'Shell');
													} else {
														$cataList = array('Raw'=>'Raw', 'Shell'=>'Shell');
													}
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<?php if(!empty($assoc_nm)) { 
												...
												<?php } else if($assoc_nm=="STARTUP") {?>
													<select id="booth_area" name="booth_area" class="form-control" required="required">
													<option value="">-- Select Booth Area --</option>
													<?php $cataList = array(4, 6);
															foreach ($cataList as $value) {
																$selected = '';
																if(isset($_SESSION['sess_booth_area']) && $value==$_SESSION['sess_booth_area']) {
																	$selected = 'selected="selected"';
				...
				<?php } else {?>
					<h1><?php echo $assoc_nm;?> - Online Exhibitors Directory Registrations for <?php echo $EVENT_NAME . ' ' . $EVENT_YEAR;?> is closed.</h1>
				<?php }?>
			</div>
		</div>
	</div>
...
<script src="js/exhibitor.js?fgggasdasd"></script>
<script>
