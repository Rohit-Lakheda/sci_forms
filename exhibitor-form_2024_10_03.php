												...
												<div class="input-group">
													<label class="input-group-btn">
														<span class="btn btn-primary">
															Choose Image&hellip; <input type="file" name="logo" id="logo" class="hide" />
														</span>
													</label>
									...
									document.addEventListener('DOMContentLoaded', function () {
										...
										textarea.addEventListener('input', function () {
											...
											if (currentLength > maxLength) {
												...
												console.log('You have reached the maximum character limit of ' + maxLength);
												alert('You have reached the maximum character limit of ' + maxLength);
											}
								
											charCountSpan.textContent = 'Character count ' + textarea.value.length + '/' + maxLength;
										});
...
-															console.log('Please write at least ' + minLength + ' characters.');
