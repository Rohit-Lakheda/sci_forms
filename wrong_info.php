...
if (!empty($del) && !empty($cit)) {
    $allowed_del_ids = ["nextgen", "academia", "industry", "government"];
...
<?php
$pageStyleCss =
    '<link href="forms_assets/telephoneWithFlags/css/intlTelInput.css" rel="stylesheet" type="text/css" />';
...
if (date("Y-m-d H:i") <= "2025-12-13 24:00") { ?>
                        <div id="formContainer">
                            ...
                            <form action="registration2.php<?php echo !empty(
                                $ret
                            )
                                ? "?ret=" . $ret
                                : ""; ?>"
                                ...
                                <input type="hidden" id="curr" name="curr" value="<?php echo htmlspecialchars(
                                    $cit
                                ); ?>">
                                ...
                                <div class="form-wizard">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div id="other-sector" style="display:none; margin-top: 10px;">
                                                <label class="control-label">Please specify sector:</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Ticket Type<span class="dips-required">
                                                *</span></label>
                                        <div class="col-md-6" style="padding-top:7px;">
                                            <span><strong id="del_id_text"
                                    ...
                                    <div class="form-group" id="ieee_number_group">
    ...
    function toggleAccompanying() {
        ...
        section2.style.display = isPosterPresenter ? 'block' : 'none';
                                ...
                                <?php
                        // if ($del == 'businvestor' || $del == 'silverinv' || $del == 'goldinv' || $del == 'goldinvint' || $del == 'bronzeinv') {
                        ?>
                                <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="radio-group" style="display: flex; gap: 15px; align-items: center;">
                                                    <label>
                                                        <input type="radio" name="ivca" value="Yes" required="required" <?php
                        //echo (isset($_SESSION['ivca']) && $_SESSION['ivca'] == 'Yes') ? 'checked' : '';
                        ?> />
                                                        Yes
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="ivca" value="No" required="required" <?php
                        //echo (isset($_SESSION['ivca']) && $_SESSION['ivca'] == 'No') ? 'checked' : '';
                        ?> />
                                                        No
                                                    </label>
                                                </div>
                        ...
                        /* echo (isset($_SESSION['are_you_investor']) && $_SESSION['are_you_investor'] == 'Yes') ? 'checked' : ''; ?> />
                               Yes
                           </label>
                           <label>
               ...
               <?php } */
                        ...
                        ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Pincode <span class="dips-required">
                                            *</span></label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="zipcode" id="zipcode"
                                            value="<?php echo isset(
                                                ...
                                                ? $_SESSION["zipcode"]
                                                : " "; ?>"
                                            required="required" pattern="^\d{6}$|^[A-Za-z0-9\- ]{3,10}$"
                                            title="Enter a valid postal code: 6-digit for India or 3-10 alphanumeric for international" />
                                    </div>
                                </div>

                                <?php // Check if the number of attendees is stored in the session

                        $attendeesCount = isset($_SESSION["total_dele"])
                                    ? $_SESSION["total_dele"]
                                    : ""; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" id="attendees" name="attendees"
                                            ...
                                            <?php } else { ?>
                                                <option value="1" <?php echo $attendeesCount ==
                                                1
                                                    ? "selected"
                                                    : ""; ?>>1
                                                </option>
                                                <option value="2" <?php echo $attendeesCount ==
                                                2
                                                    ? "selected"
                                                    : ""; ?>>2
                                                </option>
                                                <option value="3" <?php echo $attendeesCount ==
                                                3
                                                    ? "selected"
                                                    : ""; ?>>3
                                                </option>
                                                <option value="4" <?php echo $attendeesCount ==
                                                4
                                                    ? "selected"
                                                    : ""; ?>>4
                                                </option>
                                                <option value="5" <?php echo $attendeesCount ==
                                                5
                                                    ? "selected"
                                                    : ""; ?>>5
                                                </option>
                                                <option value="6" <?php echo $attendeesCount ==
                                                6
                                                    ? "selected"
                                                    : ""; ?>>6
                                                </option>
                                                <!-- <option value="7" <?php
                                                //echo ($attendeesCount == 7) ? 'selected' : '';
                                                ?>>7</option> -->
                                            <?php } ?>
                                        </select>
                                    </div>
                                        ...
                                        <label class="col-md-3 control-label" for="attendees">Student Package<span
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control" id="attendees" name="package"
                                                        ...
                                                        <option value="100 Students + 5 Faculty">100 Students + 5 Faculty</option>
                                                        <option value="200 Students + 5 Faculty">200 Students + 5 Faculty</option>
                                                    </select>
                                                </div>           
                                </div> 
                                ...
                                <?php $attendees = isset($_SESSION["attendees"])
                                    ? $_SESSION["attendees"]
                                    : []; ?>
                                <!-- Attendee 1 Fields -->
                                <div id="attendee1" class="attendee-fields" style="display:none;">
                                    <?php if ($del != "nextgen") { ?>
                                    <h3 align=center>Attendee 1 Details</h3>
                                    <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select id="title1" name="title1" class="form-control">
                                                ...
                                                <option value="Mr." <?php echo isset(
                                                    $attendees[0]["title"]
                                                ) &&
                                                $attendees[0]["title"] == "Mr."
                                                    ? "selected"
                                                    : ""; ?>>Mr. </option>
                                                <option value="Mrs." <?php echo isset(
                                                    $attendees[0]["title"]
                                                ) &&
                                                $attendees[0]["title"] == "Mrs."
                                                    ? "selected"
                                                    : ""; ?>> Mrs.
                                                </option>
                                                <option value="Ms." <?php echo isset(
                                                    $attendees[0]["title"]
                                                ) &&
                                                $attendees[0]["title"] == "Ms."
                                                    ? "selected"
                                                    : ""; ?>>Ms. </option>
                                                <option value="Dr." <?php echo isset(
                                                    $attendees[0]["title"]
                                                ) &&
                                                $attendees[0]["title"] == "Dr."
                                                    ? "selected"
                                                    : ""; ?>>Dr. </option>
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="email1">Email<span class="dips-required">
                                                *</span></label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="designation1">Designation<span
                                                class="dips-required"> *
                                            </span></label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select id="title2" name="title2" class="form-control">
                                                ...
                                                $attendees[1]["title"] == "Mr."
                                                    ? "selected"
                                                    : ""; ?>>Mr. </option>
                                                <option value="Mrs." <?php echo isset(
                                                    $attendees[1]["title"]
                                                ) &&
                                                $attendees[1]["title"] == "Mrs."
                                                    ? "selected"
                                                    : ""; ?>> Mrs.
                                                </option>
                                                <option value="Ms." <?php echo isset(
                                                ...
                                                $attendees[1]["title"] == "Ms."
                                                    ? "selected"
                                                    : ""; ?>>Ms. </option>
                                                <option value="Dr." <?php echo isset(
                                                    $attendees[1]["title"]
                                                ) &&
                                                $attendees[1]["title"] == "Dr."
                                                    ? "selected"
                                                    : ""; ?>>Dr. </option>
                                                <option value="Mx." <?php echo isset(
                                                    $attendees[1]["title"]
                                                ) &&
                                                $attendees[1]["title"] == "Mx."
                                                    ? "selected"
                                                    : ""; ?>>Mx.
                                                </option>
                                            </select>
                        ...
                        /* echo (isset($attendees[1]['government_id_type']) && $attendees[1]['government_id_type'] == 'Aadhar Card') ? 'selected' : ''; */
                        ?>>Aadhar Card</option>
                                                    <option value="Passport" <?php
                        /* echo (isset($attendees[1]['government_id_type']) && $attendees[1]['government_id_type'] == 'Passport') ? 'selected' : ''; */
                        ?>>Passport</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="government_id_number2" name="government_id_number2"
                                                    class="form-control"
                                                    value="<?php
                        /* echo isset($attendees[1]['government_id_number']) ? $attendees[1]['government_id_number'] : ''; */
                        ?>"
                                    ...
                                    <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select id="government_id_type3" name="government_id_type3"
                                                    ...
                                                    <option value="">Select Government ID Type</option>
                                                    <option value="Aadhar Card" <?php
                        /* echo (isset($attendees[2]['government_id_type']) && $attendees[2]['government_id_type'] == 'Aadhar Card') ? 'selected' : ''; */
                        ?>>Aadhar Card</option>
                                                    <option value="Passport" <?php
                        /* echo (isset($attendees[2]['government_id_type']) && $attendees[2]['government_id_type'] == 'Passport') ? 'selected' : '';*/
                        ?>>Passport</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="government_id_number3" name="government_id_number3"
                                                    class="form-control"
                                                    value="<?php
                        /* echo isset($attendees[2]['government_id_number']) ? $attendees[2]['government_id_number'] : ''; */
                        ?>"
                                                    oninput="validateGovernmentID()">
                                            </div>
                                        </div>-->
                                    ...
                                    <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select id="government_id_type4" name="government_id_type4"
                                                    ...
                                                    <option value="">Select Government ID Type</option>
                                                    <option value="Aadhar Card" <?php
                        /* echo (isset($attendees[3]['government_id_type']) && $attendees[3]['government_id_type'] == 'Aadhar Card') ? 'selected' : ''; */
                        ?>>Aadhar Card</option>
                                                    <option value="Passport" <?php
                        /* echo (isset($attendees[3]['government_id_type']) && $attendees[3]['government_id_type'] == 'Passport') ? 'selected' : ''; */
                        ?>>Passport</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select id="government_id_type5" name="government_id_type5"
                                                    ...
                                                    <option value="">Select Government ID Type</option>
                                                    <option value="Aadhar Card" <?php
                        /* echo (isset($attendees[4]['government_id_type']) && $attendees[4]['government_id_type'] == 'Aadhar Card') ? 'selected' : ''; */
                        ?>>Aadhar Card</option>
                                                    <option value="Passport" <?php
                        /* echo (isset($attendees[4]['government_id_type']) && $attendees[4]['government_id_type'] == 'Passport') ? 'selected' : ''; */
                        ?>>Passport</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="government_id_number5" name="government_id_number5"
                                                    class="form-control"
                                                    value="<?php
                        /* echo isset($attendees[4]['government_id_number']) ? $attendees[4]['government_id_number'] : ''; */
                        ?>"
                                                    oninput="validateGovernmentID()">
                                            </div>
                                        </div> -->
                                    ...
                                    <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select id="government_id_type6" name="government_id_type6"
                                                    ...
                                                    <option value="">Select Government ID Type</option>
                                                    <option value="Aadhar Card" <?php
                        /* echo (isset($attendees[5]['government_id_type']) && $attendees[5]['government_id_type'] == 'Aadhar Card') ? 'selected' : ''; */
                        ?>>Aadhar Card</option>
                                                    <option value="Passport" <?php
                        /* echo (isset($attendees[5]['government_id_type']) && $attendees[5]['government_id_type'] == 'Passport') ? 'selected' : ''; */
                        ?>>Passport</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="gstNumber" name="gstNumber"
                                                placeholder="Enter GST Number" value="<?= $_SESSION[
                                                    "gstNumber"
                                                ] ?? "" ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="panNumber" name="panNumber"
                                                placeholder="Enter PAN Number" value="<?= $_SESSION[
                                                    "panNumber"
                                                ] ?? "" ?>">
                                ...
                                <div class="form-group"
                                    ...
                                    <!-- <input type="hidden" name="gem_connect" value="No">
                                                        <input type="checkbox" name="gem_connect" id="gem_connect"
                                                            value="Yes" <?php
                        /*  echo (isset($_SESSION['gem_connect']) && $_SESSION['gem_connect'] == 'Yes') ? 'checked' : 'checked'; */
                        ?>
    ...
    <script>
        ...
        function showAttendeeFields() {
            ...
            const isStudentPackage = selectedValue.includes("Students");
        ...
        window.onload = function() {
            <?php if ($del == "nextgen") { ?>
                ...
                <?php if (
                    isset($_SESSION["package"]) &&
                    $_SESSION["package"] != ""
                ) { ?>
                    document.getElementById("attendees").value = "<?php echo $_SESSION[
                        "package"
                    ]; ?>";
                    showAttendeeFields();
                <?php } ?>
            <?php } else { ?>
                ...
                const attendeesCount = <?php echo $attendeesCount
                    ? $attendeesCount
                    : 1; ?>;
