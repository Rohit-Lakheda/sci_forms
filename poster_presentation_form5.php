<?php 
	...
	//echo "SELECT * FROM ".$PSTR_TBL_NAME." WHERE tin_no = '" . $_GET['id'] . "'";exit;
	//$tin_no = $_GET['id'];
	$qr_gt_user_data_id = mysqli_query($link,"SELECT * FROM ".$PSTR_TBL_NAME." WHERE tin_no = '" . $tin_no . "'");
	//echo mysqli_num_rows($qr_gt_user_data_id);exit;
												...
												<table class="table table-striped table-bordered table-hover">
													<tbody>
														...
														<tr>
															...
															<td> <a href="<?php echo $res['poster_abstract'];?>" target='_blank'> Click here to download file </a> </td>
														</tr>
														<tr>
									...
									<div class="row">
					                  ...
					                  <div class="note note-danger">
					                    ...
					                    <p>Please DO NOT print this page. This page print not accepted in event.
					                      <br />You need to click on <strong>Print</strong> button OR <a class="alert-link" href="poster_pay.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>" target="_blank">Click here </a>to generate printable receipt.
					                    </p>
					                  </div>
								</div>
							</div>
			            ...
			            <div class="form-actions">
			              <div class="row">
			                <div class="col-md-offset-3 col-md-9">
			                  <a href="reg_pay_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>" class="btn blue sbold uppercase green-jungle" type="submit" name="make_payment" value="1">
