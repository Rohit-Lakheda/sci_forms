    ...
    <div class="col-md-12">
        <div class="portlet light bordered" id="registration_form_1">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red bold uppercase"><?php if (
                        ...
                        echo "International ";
                    } ?>Delegate Registration Form <?php if (
                         ...
                         echo "with Special offer only for TiE Bangalore Charter Members @ Rs. 3K";
                           ...
                           } elseif ($assoc_name == "Program-Coordinators") {
                               $assoc_name_disp =
                                   "ONLY FOR BiSEP, DAC and NAIN PROGRAM-COORDINATORS ";
                           } elseif ($assoc_name == "SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI)") {
                               $assoc_name_disp =
                                   " For SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI MEMBER)";
                           } elseif ($assoc_name == "Student-Coordinator") {
                               $assoc_name_disp =
                                   "For IBAB, CHG, IIIT-B, BiSEP, DAC and NAIN Students";
                           } elseif ($assoc_name == "TBCM") {
                               $assoc_name_disp =
                                   "with Special offer only for TiE Bangalore Charter Members @ Rs. 3K";
                           } elseif ($assoc_name == "Tie Bengaluru charter members") {
                               $assoc_name_disp =
                                   "with Special offer only for TiE Bangalore Charter Members @ Rs. 3K";
                           } else {
            ...
            <div class="portlet-body form">
                <?php if (date("Y-m-d H:i") <= "2025-11-21 13:00") { ?>
                    <form action="registration2_es.php<?php echo !empty($ret)
                        ? "?ret=" . $ret
                        : ""; ?>" class="form-horizontal" name="reg_registration_form_1" id="reg_registration_form_1"
                        method="post" onsubmit="return validate_registration_form_2();">
                        <?php
                        /*?><input type="hidden" value="Standard" name="cata_m" /><?php */
                        ?>
                                ...
                                <div class="tab-content main-form-div" id="main-form-div">
                                    <div class="tab-pane active">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3"> Select Industry Sector <span
                                                    class="required"> * </span>
                                            </label>
                                            <div class="col-md-6">
                                                <select id="sector" name="sector" class="form-control" required="required"
                                                    onchange="showPayment();">
                                                    <?php if ($assoc_name == "SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI) - OLD") { ?>
                                                        <?php
                                                        $countryList = [
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        foreach ($countryList as $key => $value) {
                                                            $selected = "";
                                                            if (
                                                                isset($_SESSION["sector"]) &&
                                                                $_SESSION["sector"] == $value
                                                            ) {
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3"> <span class="normal-cata">Number of
                                                    Delegate(s)</span><span class="poster-cata" style="display:none;">Number
                                                    of Co-Author</span> <span class="required"> * </span></label>
                                            <div class="col-md-6">
                                                <select class="form-control" name="total_dele" id="total_dele" required>
                                                    <?php
                                                    $lmt = 2;
                                                    if (
                                                        isset($discountDetail["code"]) &&
                                                        !empty($discountDetail["code"]) &&
                                                        $discountDetail["code"] == "WOF OLD"
                                                    ) {
                                                        $lmt = 1;
                                                    } /*else if($assoc_name == 'NASSCOM' || $assoc_name == 'IESA' || $assoc_name == 'ABAI' || $assoc_name == 'ABLE' || $assoc_name == 'TIE' || $assoc_name == 'IACC' || $assoc_name == 'AMCHAM' || $assoc_name == 'USIBC') {
                                                                                                                                                                                                                                                       $lmt = 1;
                                                                                                                                                                                                                                                   } */ else {
                                                        ?>
                                                    ...
                                                    for ($index = 1; $index <= $lmt; $index++) {
                                                        ...
                                                        $selected = "";
                                                        if (
                                                            isset($_SESSION["total_dele"]) &&
                                                            $_SESSION["total_dele"] == $index
                                                        ) {
                                                            $selected = 'selected="selected"';
                                                        }
                                                        if ($lmt == 1) {
                                        ...
                                        <!-- New Checkboxes for Day 1, Day 2, Day 3 -->
                                        <div class="form-group">
                                            <label class="control-label col-md-3">
                                                Number of Day(s) <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-6">
                                                <div class="checkbox">
                                                    <input type="checkbox" id="day1" name="days[]" value="19th">
                                                    <label for="day1"> Day 1 (19th Nov 2024) </label>
                                                </div>
                                                <div class="checkbox">
                                                    <input type="checkbox" id="day2" name="days[]" value="20th">
                                                    <label for="day2"> Day 2 (20th Nov 2024) </label>
                                                </div>
                                                <div class="checkbox">
                                                    <input type="checkbox" id="day3" name="days[]" value="21st">
                                                    <label for="day3"> Day 3 (21st Nov 2024) </label>
                                                    <br>
                                                    <br>
                                                    <span>Note: Click on day text to select day</span>
                                        ...
                                        <?php if (
                                            $assoc_name == "ABAI OLD" ||
                                            $assoc_name == "Spread OLD" ||
                                            $assoc_name == "KSRSAC OLD" ||
                                            $assoc_name == "TiE Bangalore OLD" ||
                                            $assoc_name == "YESSS Abstract Presenter OLD" ||
                                            $assoc_name == "KBITS OLD"
                                        ) { ?>
                                            ...
                                            <?php } elseif ($assoc_name == "Spread OLD") { ?>
                                            ...
                                            <?php } elseif ($assoc_name == "KSRSAC OLD" || $assoc_name == "KBITS OLD") { ?>
                                                <input type="checkbox" id="day3" name="day3" class="hide" checked="checked"
                                                    value="Day 3">
                                                <div class="group form-group">
                                                    <label class="control-label col-md-3">Regitration Single Day: </label>
                                            ...
                                            <?php } elseif ($assoc_name == "TiE Bangalore OLD") { ?>
                                                <input type="checkbox" id="day3" name="day3" class="hide" checked="checked"
                                                    value="Day 3">
                                                <div class="group form-group">
                                                    <label class="control-label col-md-3">Regitration Single Day: </label>
                                            ...
                                            <?php } elseif ($assoc_name == "YESSS Abstract Presenter OLD") { ?>
                                                <?php
                                            ...
                                            <?php if (!empty($assoc_name)) { ?>
                                                ...
                                                <?php } elseif (!empty($assoc_name) && $assoc_name == "Faculty OLD") { ?>
                                                    <div class="group form-group">
                                                ...
                                                <?php } elseif (
                                                    !empty($assoc_name) &&
                                                    $assoc_name == "Student-Coordinator OLD"
                                                ) { ?>
                                                    <div class="group form-group">
                                            ...
                                            <div class="form-group form-md-radios hidden">
                                                ...
                                                <div class="col-md-9">
                                                    <!-- <?php
                                                    //if($discountDetail['assoc_name']== "International"{
                                                    ?>  -->
                                                    <div class="md-radio-inline">


                                                        <div
                                                            class="md-radio <?php if ($discountDetail['assoc_name'] == "International") { ?>hide<?php } ?>">
                                                            <input type="hidden" id="assoc_name" name="assoc_name"
                                                                value="<?php echo !empty($assoc_name) ? $assoc_name : ""; ?>">
                                                        ...
                                                        <div class="md-radio">
                                                            <input type="radio" id="Foreign" name="curr" class="md-radiobtn"
                                                                value="Foreign" onclick="show_cata();" <?php if ($discountDetail['assoc_name'] == "International")
                                                                    echo '  required="required" checked="checked"'; ?>>
                                                            <label for="Foreign">
                                                                <span></span>
                                                                <span class="check"></span>
                                            ...
                                            <?php
                                            /*?><div class="group form-group" id="genotypic-div" style="display:none;">
                                            ...
                                            <?php if (!empty($discountDetail)) { ?>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Association Name/ Dignitary Name<span
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <span class="help-block"><i>Note: Discount will get added at last step of
                                                                registration.</i></span>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            <div class="form-group form-md-radios hide" id="reg_type">
                                                <label class="control-label col-md-3"> Type of registration<span
                                                        class="required"> * </span> </label>
                                                <div class="col-md-9">
                                                    <div class="md-radio-inline">
                                                        <?php
                                                        /*?><div class="md-radio" id="Single_Day_button">
                                                        ...
                                                        ?>
                                                        <div class="md-radio">
                                                            <input type="radio" id="Full_Day" name="daytype" class="md-radiobtn"
                                                                value="3 Days" checked="checked" onclick="showDays();">
                                                            <label for="Full_Day">
                                                                <span></span>
                                                                <span class="check"></span>
                                            ...
                                            <div class="form-group form-md-radios" id="div_single_day" style="display: none;">
                                                <label class="control-label col-md-3">Select Day(s)<span class="required"> *
                                                    </span> </label>
                                                <div class="col-md-9">
                                                    <div class="md-checkbox-inline">
                                                        <div class="md-checkbox">
                                                            <input type="checkbox" id="day1" name="day1" class="md-check"
                                                                value="Nov 18th">
                                                            <label for="day1">
                                                                <span></span>
                                                                <span class="check"></span>
                                                        ...
                                                        <?php if (date("Y-m-d H:i") <= "2019-11-20 20:00") { ?>
                                                            <div class="md-checkbox">
                                                                <input type="checkbox" id="day2" name="day2" class="md-check"
                                                                    value="Nov 19th">
                                                                <label for="day2">
                                                                    <span></span>
                                                                    <span class="check"></span>
                                                        ...
                                                        <?php } ?>
                                                        <div class="md-checkbox">
                                                            <input type="checkbox" id="day3" name="day3" class="md-check"
                                                                value="Nov 20th">
                                                            <label for="day3">
                                                                <span></span>
                                                                <span class="check"></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <?php if ($assoc_name == "SOFTWARE TECHNOLOGY PARKS OF INDIA(STPI)") { ?>
                                                    <table class="table table-striped table-hover1 table-bordered teriff-table">
                                                        ...
                                                        <tr class="indian-tariff first-row">
                                                            ...
                                                            <?php
                                                            /*<td colspan="1">-</td>
                                                                                                                                                                                                                                                                                                                          <td colspan="2" class="success1">INR 9000</td>*/
                                                            ?>
                                                            <td colspan="2" class="success1">INR 3000
                                                                <?php
                                                                /*<input name="cata" type="radio" class="hide" value="Full Delegate" id="cata1" />*/
                                                                ?>
                                                            </td>
                                                            <?php
                                                ...
                                                <?php } elseif ($assoc_name == "Tie Bengaluru charter members") { ?>
                                                    <table class="table table-striped table-hover1 table-bordered teriff-table">
                                                        <thead>
                                                            <tr bgcolor="#2fa0dd" style="color: #fff;">
                                                                <th colspan="1">Catagory</th>
                                                ...
                                                <?php } elseif ($assoc_name == "Program-Coordinators OLD") { ?>
                                                    <table class="table table-striped table-hover1 table-bordered teriff-table">
                                                        <thead>
                                                            <tr bgcolor="#2fa0dd" style="color: #fff;">
                                                                <th colspan="1">Catagory</th>
                                                        ...
                                                        <tr class="indian-tariff first-row">
                                                            <td colspan="1"><?php echo $assoc_name; ?> : BiSEP, DAC and NAIN
                                                            </td>
                                                            <td colspan="1">-</td>
                                                            <?php
                                                            /*<td colspan="2" class="success1">INR 9000</td>*/
                                                            ?>
                                                            <td colspan="2" class="success1">INR 2000 <input name="cata"
                                                                    type="radio" class="hide" value="Full Delegate"
                                                                    id="cata1" /></td>
                                                            <?php
                                                            /*<td class="success1">INR 6000 </td>
                                                                                                                                                                                                                                                                                                                      <td class="success1">INR 9000 </td>
                                                ...
                                                <?php } elseif ($assoc_name == "Faculty OLD") { ?>
                                                    <table class="table table-striped table-hover1 table-bordered teriff-table">
                                                        <thead>
                                                            <tr bgcolor="#2fa0dd" style="color: #fff;">
                                                                <th colspan="1">Catagory</th>
                                                        ...
                                                        <tr class="indian-tariff first-row">
                                                            <td colspan="1"><?php echo $assoc_name; ?> : IBAB, CHG and IIIT-B
                                                            </td>
                                                            <td colspan="1">-</td>
                                                            <?php
                                                            /*<td colspan="2" class="success1">INR 9000</td>*/
                                                            ?>
                                                            <td colspan="2" class="success1">INR 1500 <input name="cata"
                                                                    type="radio" class="hide" value="Full Delegate"
                                                                    id="cata1" /></td>
                                                            <?php
                                                            /*<td class="success1">INR 6000 </td>
                                                ...
                                                <?php } elseif ($assoc_name == "Student-Coordinator OLD") { ?>
                                                    <table class="table table-striped table-hover1 table-bordered teriff-table">
                                                        <thead>
                                                            <tr bgcolor="#2fa0dd" style="color: #fff;">
                                                                <th colspan="1">Catagory</th>
                                                        ...
                                                        <tr class="indian-tariff first-row">
                                                            <td colspan="1">IBAB, CHG, IIIT-B, BiSEP, DAC and NAIN Students
                                                            </td>
                                                            <td colspan="1">-</td>
                                                            <?php
                                                            /*<td colspan="2" class="success1">INR 9000</td>*/
                                                ...
                                                <?php } elseif ($assoc_name == "UK-StartUps OLD") { ?>
                                                    <table class="table table-striped table-hover1 table-bordered teriff-table">
                                                        <thead>
                                                            <tr bgcolor="#2fa0dd" style="color: #fff;">
                                                                <th colspan="1">Catagory</th>
                                                ...
                                                <?php } elseif ($assoc_name == "Session-StartUps OLD") { ?>
                                                    <table class="table table-striped table-hover1 table-bordered teriff-table">
                                                        <thead>
                                                            <tr bgcolor="#2fa0dd" style="color: #fff;">
                                                                <th colspan="1">Catagory</th>
                                                ...
                                                <?php } else { ?>
                                                    <table
                                                        ...
                                                        <thead>
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <th>TARIFF (For Single Day)</th>
                                                                <!-- <th>EARLY BIRD OFFER</th> -->
                                                                <th class="indian-tariff">REGISTRATION DATE</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <!-- <tr>
                                                            ...
                                                            <?php /*  ?>
                                                                                                                                                                                                      <tr>
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          <td class="indian-tariff" style="background-color: #e1e1e1;">INR 4000</td>
                                                                                                                                                                                                          <td class="indian-tariff" style="background-color: #e1e1e1;">
                                                                                                                                                                                                              1201 - 2000 Tickets OR <br />(01st Nov to 10th Nov)</td>
                                                                                                                                                                                                      </tr>
                                                                                                                                                                              <?php */ ?>
                                                            <tr>
                                                            ...
                                                            /*?><tr>
                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                              <td class="indian-tariff" style="background-color: #e1e1e1;">INR 7500</td>
                                                                                                                                                                                                                                                                                                                              <td class="indian-tariff" style="background-color: #e1e1e1;">3001  Tickets onwards<br />(Nov 27th onwards)</td>
                                                                                                                                                                                                                                                                                                                          </tr><?php */
                                                            ?>
                                                            <tr>
                                        ...
                                        <div class="form-group form-md-radios" id="tech-div" style="display:none;">
                                            <label class="control-label col-md-3">How do you know about Event <span
                                                    class="required"> * </span> </label>
                                            <div class="col-md-6">
                                                <select id="event_know" name="event_know" class="form-control"
                                                    onchange="showPromo();">
                                                    <option value="">-- Select --</option>
                                                    <option value="News Paper Ads" <?php if (
                                                        isset($_SESSION["event_know"]) &&
                                                        $_SESSION["event_know"] == "News Paper Ads"
                                                    ) { ?>selected="selected" <?php } ?>>News Paper Ads</option>
                                                    <option value="Social Media" <?php if (
                                                        isset($_SESSION["event_know"]) &&
                                                        $_SESSION["event_know"] == "Social Media"
                                                    ) { ?>selected="selected"
                                                        <?php } ?>>Social Media</option>
                                                    <option value="Past Participant" <?php if (
                                                        isset($_SESSION["event_know"]) &&
                                                        $_SESSION["event_know"] == "Past Participant"
                                                    ) { ?>selected="selected" <?php } ?>>Past Participant
                                                    </option>
                                                    <option value="Mailer" <?php if (
                                                        isset($_SESSION["event_know"]) &&
                                                        $_SESSION["event_know"] == "Mailer"
                                                    ) { ?>selected="selected" <?php } ?>>Mailer</option>
                                                    <option value="Hoarding" <?php if (
                                                        isset($_SESSION["event_know"]) &&
                                                        $_SESSION["event_know"] == "Hoarding"
                                                    ) { ?>selected="selected" <?php } ?>>Hoarding</option>
                                                    <option value="Others" <?php if (
                                                        isset($_SESSION["event_know"]) &&
                                                        $_SESSION["event_know"] == "Others"
                                            ...
                                            <div class="col-md-11">
                                                ...
                                                <table class="table table-striped table-bordered table-hover "
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Account Name :</td>
                                                            <td style="width: 828px;">MM ACTIV SCI TECH COMMUNICATIONS PVT.
                                                                LTD.</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Account Type :</td>
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td colspan="2" style="color: red;">Incase of payment through
                                                                IMPS. IMPS Transaction ID along with Date of Payment to be
                                                                sent to <a
                                                                    href="mailto:ramakrishna.mokkapati@mmactiv.com">ramakrishna.mokkapati@mmactiv.com</a>/<a
                                                                    href="mailto:srisha.accounts@mmactiv.com">srisha.accounts@mmactiv.com</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border: medium none; width: 99%;">
                                                                <p>
                                                                    ...
                                                                    <?php echo $EVENT_CHEQUE_PAYBLE_AT_NAME; ?> payable at
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="border: medium none;">
                                                                <ul>
                                                                    <li>
                                                                        If the holder of the card is not the delegate, then
                                                                        the delegate should possess:
                                                                        <ul type="i">
                                                                            <li>A Photocopy of both sides of the card, which
                                                                                will have to be self attested by the card
                                                                                holder authorising the use of the card for
                                                                                the delegate registration fee. For security
                                                                                reasons, please strike out the Card
                                                                                Verification Value (CVV) code on the copy of
                                                                                your card.</li>
                                                                            <li>This Photocopy should also contain the name
                                                                                of the delegate.</li>
                                                                        </ul>
                                                                    </li>
                                                                    <li>The above document MUST be produced at the
                                                                        ...
                                                                        Bengaluru INDIA BIO Secretariat reserves the right
                                                                        to deny the delegate from attending the event.</li>
                                                                </ul>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                ...
                                                <table class="table table-striped table-bordered well" id="bcheque"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td style="border: medium none; width: 99%;">
                                                                <p>
                                                                    Please send your Cheque/DD in favour of BANGALORE INDIA
                                                                    BIO payable at Bengaluru, India.<br>
                                                                    Along with the copy of your registration receipt and
                                                                    send to<br>
                                                                    <strong>Address
                                                                        :</strong><br /><?php echo $EVENT_CHEQUE_PAYBLE_ADDRESS;
                                                                        /*?><br>Website: <a href="http://www.bengaluruindiabio.in" target="_blank">www.bengaluruindiabio.in</a><?php */
                                                                        ?>
                                                                </p>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Organisation Name <span
                                                    class="dips-required"> * </span><span id="gstorg"><br />(To create
                                                    invoice in the name of)</span></label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group hide" style="display:none;">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="nature" id="nature"
                                                    value="<?php echo isset($_SESSION["nature"]) ? $_SESSION["nature"] : ""; ?>" />
                                            </div>
                                        </div>
                                        <?php
                                        /*<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select id="country" name="country" class="form-control">
                                                    ...
                                                    $countryList = [
                                                        ...
                                                        "KM" => "Comoros",
                                                        "CG" => "Congo",
                                                        "CD" => "Congo the Democratic Republicofthe",
                                                        "CK" => "Cook Islands",
                                                        "CR" => "CostaRica",
                                                        "CI" => "Coted Ivoire",
                                                        "HR" => "Croatia(Hrvatska)",
                                                        ...
                                                        "KW" => "Kuwait",
                                                        "KG" => "Kyrgyzstan",
                                                        "LA" => "LaoPeoples Democratic Republic",
                                                        "LV" => "Latvia",
                                                        "LB" => "Lebanon",
                                                        "LS" => "Lesotho",
                                                        "LR" => "Liberia",
                                                        ...
                                                        "RW" => "Rwanda",
                                                        "KN" => "Saint Kittsand Nevis",
                                                        "LC" => "SaintLUCIA",
                                                        "VC" => "Saint VincentandtheGrenadines",
                                                        "WS" => "Samoa",
                                                        "SM" => "SanMarino",
                                                        "ST" => "Sa oTomeand Principe",
                                                        "SA" => "Saudi Arabia",
                                                        "SN" => "Senegal",
                                                        "SC" => "Seychelles",
                                                        "SL" => "Sierra Leone",
                                                        ...
                                                        "SO" => "Somalia",
                                                        "ZA" => "South Africa",
                                                        "GS" => "South Georgiaand the South Sandwich Islands",
                                                        "ES" => "Spain",
                                                        "LK" => "SriLanka",
                                                        "SH" => "St.Helena",
                                        ...
                                        ?>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Phone Number<span class="dips-required"> *
                                                </span></label>
                                            <div class="col-md-6" style="margin-top: -16px;">
                                                <span type="tel" id="telCountryIsoCode"
                                                    data-fax-iso-code-hidden-field-name="foneCountryCode"
                                                    class="hide"></span>
                                                <input type="hidden" name="foneCountryCode" id="foneCountryCode" value="<?php echo isset($_SESSION["foneCountryCode"])
                                                    ? $_SESSION["foneCountryCode"]
                                                    : ""; ?>" />
                                                <input type="hidden" id="foneCountryCodeIso" />
                                                <input name="fone" type="text" id="fone" class="form-control" maxlength="20"
                                                    value="<?php echo isset($_SESSION["fone"]) ? $_SESSION["fone"] : ""; ?>"
                                                    required onkeyup="checkPhoneNumber(event, 'fone');"
                                                    style="padding-left: 92px;" />
                                                <span class="help-block">+Country Code-Phone Number(xxx-xxxxxxx)</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Do you need a GST based Invoice?<span
                                                    class="dips-required"> * </span></label>
                                            <div class="col-md-6">
                                                <select id="is_gst_invoice_needed" name="is_gst_invoice_needed"
                                                    class="form-control" onchange="showInvoiceData();" required>
                                                    <option value="">--Select--</option>
                                                    <option value="Yes" <?php echo isset($_SESSION["is_gst_invoice_needed"]) &&
                                                        $_SESSION["is_gst_invoice_needed"] == "Yes"
                                                        ? 'selected="selected"'
                                                        : ""; ?>>Yes </option>
                                                    <option value="No" <?php echo isset($_SESSION["is_gst_invoice_needed"]) &&
                                                        $_SESSION["is_gst_invoice_needed"] == "No"
                                                        ? 'selected="selected"'
                                                        : ""; ?>>No </option>
                                                </select>
                                            </div>
                                        ...
                                        <div id="gst-div">
                                            <h3 class="block">Organisation Details for Raising the Invoice</h3>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Invoice Address<span
                                                        class="dips-required"> * </span></label>
                                                <div class="col-md-6">
                                                    <textarea name="gst_inv_addr" id="gst_inv_addr" rows="" cols=""
                                                        class="form-control"><?php echo isset($_SESSION["gst_inv_addr"])
                                                            ? $_SESSION["gst_inv_addr"]
                                                            : ""; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Organisation GST Registration No<span
                                                        class="dips-required"> * </span></label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="gst_inv_reg_no"
                                                        id="gst_inv_reg_no" value="<?php echo isset($_SESSION["gst_inv_reg_no"])
                                                            ? $_SESSION["gst_inv_reg_no"]
                                                            : ""; ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Organisation Pan No<span
                                                        class="dips-required"> * </span></label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="gst_inv_pan"
                                                        id="gst_inv_pan" value="<?php echo isset($_SESSION["gst_inv_pan"])
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="gst_inv_state"
                                                        id="gst_inv_state" value="<?php echo isset($_SESSION["gst_inv_state"])
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Contact Person Name <span
                                                        class="dips-required"> * </span></label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="gst_inv_cp"
                                                        id="gst_inv_cp" value="<?php echo isset($_SESSION["gst_inv_cp"])
                                                            ? $_SESSION["gst_inv_cp"]
                                                            : ""; ?>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Phone No <span class="dips-required">
                                                        * </span></label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="gst_inv_phone"
                                                        id="gst_inv_phone" value="<?php echo isset($_SESSION["gst_inv_phone"])
                                                            ? $_SESSION["gst_inv_phone"]
                                                            : ""; ?>"
                                                        onkeyup="checkPhoneNumber(event, 'gst_inv_phone');" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Email Address <span
                                                        class="dips-required"> * </span></label>
                                                <div class="col-md-6">
                                                    <input type="email" class="form-control" name="gst_inv_email"
                                                        id="gst_inv_email" value="<?php echo isset($_SESSION["gst_inv_email"])
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"
                                                        style="background-image: url('images/verify_img_bg.JPG'); text-align: center; font-size: 32px; padding: 0 15px 1px;"><?php echo $_SESSION[
                                                            "vercode_reg"
                                                        ]; ?></span>
                                                </div>
                                            </div>
                ...
                <?php } else { ?>
                    <h1>Delegate Registration for Bengaluru Tech Summit 2024 has been Closed.
