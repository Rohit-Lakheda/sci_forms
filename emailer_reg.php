        ...
        <td width='650' colspan='3' style='font-family:Verdana; font-size:10px; color:#333333; line-height:17px;'><table width='100%' border='0' cellpadding='0' cellspacing='1' bgcolor='#CCCCCC'>
		 ...
		 if($res['pay_status']=='Not Paid'){
          ...
          <tr>
			...
			<td height='22' colspan='2' valign='top' bgcolor='#FFFFFF' style='color:#1D0D6F;font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 16px; padding: 8px; border: 1px solid #dadada;'><strong>&nbsp;&nbsp;Standard Delegate Registration Receipt </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          ...
          <tr>
			...
			<td height='22' colspan='2' valign='top' bgcolor='#FFFFFF' style='color:#1D0D6F;font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 16px; padding: 8px; border: 1px solid #dadada;'><strong>&nbsp;&nbsp;Payment Acknowledgement Receipt </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
if($res['org_reg_type'] != ''){
		   $mail_body = $mail_body."<tr bgcolor='#FFFFFF'>
            <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Domain</td>
         ...
         $mail_body = $mail_body." <tr bgcolor='#FFFFFF'>
          ...
          <tr bgcolor='#FFFFFF'>
            ...
            <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['addr1']." ".$res['addr2']."City - ".$res['city'].", Country - ".$res['country'].".</td>
...
/*.", State - ".$res['state'] .", Pincode - ".$res['pin']
...
/*if(($res['assoc_name'] != 'Faculty' && $res['assoc_name'] != 'Program-Coordinators') && $res['member_of_assoc'] != '') {
...
$mail_body = $mail_body."
		  ...
		  <tr bgcolor='#FFFFFF'>
		    ...
		    <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Packages</td>

		    <td height='22' align='center' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['packages']."</td>
    ...
    if($res['is_gst_invoice_needed'] == 'Yes') {

        $mail_body = $mail_body."

          <tr>

            <td height='22' colspan='3' align='left' valign='middle' bgcolor='#F9F8F2'>&nbsp;<span style='font-family: Verdana, Arial, Helvetica, sans-serif; color: #333333; font-size: 11px; font-weight: bold;'>Organisation Details for Raising the Invoice</span></td>

          </tr>

        <tr bgcolor='#FFFFFF'>

		    <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Organisation Name<br/>(To create invoice in the name of)</td>

		    <td height='22' align='center' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['org']."</td>

	    </tr>

        <tr bgcolor='#FFFFFF'>

		    <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Invoice Address</td>

		    <td height='22' align='center' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['gst_inv_addr']."</td>

	    </tr>

        <tr bgcolor='#FFFFFF'>

		    <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Organisation GST Registration No</td>

		    <td height='22' align='center' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['gst_inv_reg_no']."</td>

	    </tr>

        <tr bgcolor='#FFFFFF'>

		    <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Organisation Pan No</td>

		    <td height='22' align='center' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['gst_inv_pan']."</td>
        ...
        <tr bgcolor='#FFFFFF'>
		    ...
		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['gst_inv_state']."</td>

	    </tr>

        <tr bgcolor='#FFFFFF'>

		    <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Contact Person Name</td>

		    <td height='22' align='center' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['gst_inv_cp']."</td>

	    </tr>

        <tr bgcolor='#FFFFFF'>

		    <td height='22' align='left' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Phone No</td>

		    <td height='22' align='center' valign='top' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

		    <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['gst_inv_phone']."</td>
...
$mail_body = $mail_body."
          ...
          if (!empty($res['sector'])) {
            ...
            <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Domain</td>
          ...
          if (!empty($res['days'])) {
            ...
            <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Day</td>

            <td height='22' align='center' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

            <td width='75%' height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['days']."</td> 
          </tr>";
          }
...
if(!empty($res['course'])) {
    $mail_body = $mail_body." <tr bgcolor='#FFFFFF'>
            ...
            <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Course</td>

            <td height='22' align='center' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

            <td width='75%' height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['course']."</td>
          </tr>";
}
if (!empty($res['branch'])) {
    $mail_body = $mail_body." <tr bgcolor='#FFFFFF'>

            <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Branch</td>

            <td height='22' align='center' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>

            <td width='75%' height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['branch']."</td>
          </tr>";
}
if(!empty($res['paymode'])) {
    ...
    $mail_body = $mail_body." <tr bgcolor='#FFFFFF'>
           ...
           $mail_body = $mail_body."<tr bgcolor='#FFFFFF'>
            ...
            <td height='22' align='center' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>
 <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;<strong>".$res['pay_status']."</strong></td>
    ...
    // Calculate total delegates based on package
    $total_delegates = $res['sub_delegates']; // Default value
    if (!empty($res['packages'])) {
        if ($res['packages'] == '200 Students + 5 Faculty') {
            $total_delegates = 205;
        } elseif ($res['packages'] == '100 Students + 5 Faculty') {
            $total_delegates = 105;
        }
    }
    ...
    $mail_body = $mail_body."<tr bgcolor='#FFFFFF'>
            ...
            <td height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'><span class='content-txt-form'>&nbsp;".$total_delegates."   </span></td>
      ...
      <tr>
        ...
        <td colspan='3' style='font-family:Verdana; font-size:10px; color:#333333; line-height:17px;'><table width='100%' border='0' align='left' cellpadding='0' cellspacing='1' bgcolor='#CCCCCC'>
          ...
          <tr>
            ...
            if(!empty($res['cata'] != 'Next Gen HPC Experience') && !empty($res['cata'] != 'Author')) {
            $mail_body = $mail_body." 
            <td width='20%' align='center' valign='middle' bgcolor='#D7CFA8'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'><div align='center'><strong><font color='#FFFFFF'>Category</font></strong></div></td>";
            }
            $mail_body = $mail_body."
            <td width='20%' align='center' valign='middle' bgcolor='#D7CFA8'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'><div align='center'><strong><font color='#FFFFFF'>Pass Type</font></strong></div></td>

            <td width='20%' align='center' valign='middle' bgcolor='#D7CFA8'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'><div align='center'><strong><font color='#FFFFFF'>Amount (".$res['amt_ext'].")</font></strong></div></td>
...

{
	...
	$mail_body = $mail_body."<tr bgcolor='#FFFFFF'>
           ...
           if(!empty($res['cata'] != 'Next Gen HPC Experience') && !empty($res['cata'] != 'Author')) {
            ...
            <td  bgcolor='#F9F8F2' style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;&nbsp;".$res['cata']."</td>
...
if($res['cata'] != 'Next Gen HPC Experience' && $res['cata'] != 'Author') {
    $colspan_total = 6;
} else {
    $colspan_total = 5;
}
...
$mail_body = $mail_body."<tr bgcolor='#FFFFFF'>
             ...
             <td align='right' colspan='".$colspan_total."' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Total Selection Amount (".$res['amt_ext'].")&nbsp;&nbsp;</td>
...
if( ($res['ieee_discount'] != "") && ($res['ieee_discount'] >0) )

{
	...
	$mail_body = $mail_body."
          ...
          <tr bgcolor='#FFFFFF'>
              ...
              <td align='right' colspan='".$colspan_total."' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>IEEE Discount @ 10% </td>

            <td align='right' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>".$res['ieee_discount']."&nbsp;&nbsp;</td>
...

{
	...
	$mail_body = $mail_body."
          ...
          <tr bgcolor='#FFFFFF'>
              ...
              <td align='right' colspan='".$colspan_total."' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Admin Discount @ ".$res['adminDiscountPer']."% </td>
...

{
	...
	$mail_body = $mail_body."
          ...
          <tr bgcolor='#FFFFFF'>
              ...
              <td align='right' colspan='".$colspan_total."' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Membership Discount@".$res['membershipDiscountPer']."%</td>
...

{
	...
	$mail_body = $mail_body."
          ...
          <tr bgcolor='#FFFFFF'>
              ...
              <td align='right' colspan='".$colspan_total."' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Group Discount @ 10%&nbsp;&nbsp;&nbsp; </td>
...

{
  ...
  $mail_body = $mail_body."<tr bgcolor='#FFFFFF'>
              ...
              <td align='right' colspan='".$colspan_total."' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Processing Charges &nbsp;&nbsp; </td>

              <td align='right' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'><div align='right'><span >".$res['processing_charge']."</span>&nbsp;&nbsp;</div></td>
...
$mail_body = $mail_body." <tr bgcolor='#FFFFFF'>
              ...
              <td align='right' colspan='".$colspan_total."' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Total (Including Processing Charges)  ".$res['amt_ext']."&nbsp;&nbsp; </td>
...
if(!empty($total_amt)) {
	...
	$mail_body .= " <tr bgcolor='#FFFFFF'>
	              ...
	              <td align='right' colspan='".$colspan_total."' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Total Amount Payable in INR (Including Processing Charges)";
...
if(!empty($res['total_amt_received'])) {
	...
	$mail_body .= " <tr bgcolor='#FFFFFF'>
	              ...
	              <td align='right' colspan='".$colspan_total."' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>Total  Amount Received&nbsp;&nbsp; </td>
...
if($res['pay_status']=='Not Paid'){
	...
	if( ($res['paymode'] == 'Credit Card') || ($res['paymode'] == 'Google pay') || ($res['paymode'] == 'i Banking') || ($res['paymode'] == 'Online')){
    ...
    $mail_body = $mail_body."<table width='100%' border='0' cellspacing='0' cellpadding='0'>
                              ...
                              <tr>
                                ...
                                <td width='94%'class='content-txt-form'><strong>Note :</strong>Click on 'Checkout' Below to pay instantly or<br />
                                  ...
                                  <a href='".$CF_EVENT_OL_PAY_ACT_LINK."?id=".$res['tin_no']."' target='_blank'>Click here</a> to activate your online payment process </td>
          ...
          <tr bgcolor='#FFFFFF'>
            ...
            <td  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
              ...
              <tr>
                ...
                <td colspan='2' align='center' valign='middle'><img src='".$MMACTIV_LOGO."' width='200'/></td>
