...
$qr_gt_user_data_id = mysqli_query($link,"SELECT * FROM " . $EVENT_DB_FORM_EXHIBITOR_DIR_USR_DETAILS_DEMO_PHASE_2 . " WHERE reg_id = '$reg_id'");
  ...
  <div class="col-md-12">
    <div class="portlet light bordered" id="registration_form_4">
      ...
      <div class="portlet-body form">
        <form action="stall-manning4.php?a=<?php echo $qr_gt_user_data_ans_row['promo_code']; ?>" class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">
                            ...
                            <table class="table table-striped table-bordered table-hover">
                              <tbody>
                                <tr>
                                  ...
                                  <td> <?php echo $result['assoc_name']; ?> </td>
                                </tr>
                                <tr>
...
<script>
  ...
  function go_back() {
    window.location = ('stall-manning.php?ret=retds4fu324rn_ed24d3it&?en=<?php echo $en; ?>&a=<?php echo $a; ?>');
  }
