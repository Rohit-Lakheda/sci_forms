 ...
 <table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1" style=" margin-top:20px;" align="center">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><strong class="small_button"><?php echo $EVENT_NAME;?>:
          <?php 
...
<form id="form1" name="form1" method="post" onsubmit="return validate_rsvp()" action="rsvp_2.php?enq_emler=<?php echo $emler?>">
 ...
 <input name="name" type="text" id="name" size="35" maxlength="80" />
                ...
                <td colspan="2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="346" align="left" valign="top" class="blue_text_no_padding"><span class="sitemap-txt">
                        <input name="mob" type="number" class="content-txt-without-alignment" id="mob" size="40" maxlength="20" />
                      </span></td>
         ...
         <?php /*?> <tr>
            <td height="62" align="center"><table width="95%" border="0" cellpadding="0" cellspacing="0" class="border_style1">
              ...
              <tr>
                <td><span class="blue_text_no_padding"><span class="sitemap-txt">&nbsp;I would like to know &nbsp;more about&nbsp;*</span></span></td>
                <td align="center"><span class="blue_text_no_padding">:</span></td>
                <td align="left"><span class="blue_text_no_padding"><span class="sitemap-txt">
					<table width="100%">
					<tr>
						<td width="20"><input type="checkbox" name="pr_1"  id="pr_1" value="Sponsorship"/></td>
						<td width="104">sponsorship</td>
						<td width="20"><input type="checkbox" name="pr_2"  id="pr_2" value="Exhibition"/></td>
						<td width="102">Exhibition</td>
						<td width="20"><input type="checkbox" name="pr_3"  id="pr_3" value="Visiting Event"/></td>
						<td width="112">Visiting event</td>
                  	</tr>
					<tr>
						<td><input type="checkbox" name="pr_4"  id="pr_4" value="Partnering"/></td>
						<td>Partnering</td>
						<td><input type="checkbox" name="pr_5" id="pr_5" value="Conference"/></td>
						<td>Conference</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
                  	</tr>
