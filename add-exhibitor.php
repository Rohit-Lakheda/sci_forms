...
$qwe = mysqli_query($link,"SELECT * FROM it_2024_offline_exhibitor_data_sagar where is_success!='1'");
...
while($del = mysqli_fetch_assoc($qwe)) {
	...
	$data['category_id']= 1894; //Complimentary delegate
	...
	mysqli_query($link,"update it_2024_offline_exhibitor_data_sagar set is_success ='1' where email='$dele_email'");
