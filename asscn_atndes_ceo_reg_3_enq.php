...
<table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1" style=" margin-top:20px; margin-left:400px;">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><strong class="small_button">&nbsp;<?php echo $EVENT_NAME;?> <?php echo $EVENT_YEAR;?>:</strong><strong>Confirmation to attend CEO Conclave</strong></div>
		  ...
		  <table width='100%'  cellspacing='0' cellpadding='0'>
            <tr>
              <td width='101%' height='1' colspan='2' > <div style="margin-left:5px;"><?php 
				echo $ASSCN_ATNDES_CEO_REG_RECIPIENTS_USER_MSG;
				?></div></td>
            </tr>
          </table>
