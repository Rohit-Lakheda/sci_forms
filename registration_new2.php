													...
													<table class="table table-hover1 table-bordered teriff-table col-md-offset-1 col-md-7 main-tariff-table">
														...
														<tbody>
															...
															<tr>
																...
																<td class="indian-tariff" style="background-color: #e1e1e1;">01 – 1000 Tickets Or <br />(Upto 31st May)</td>
															</tr>
															<?php ?>
															<tr>

																<td class="indian-tariff" style="background-color: #e1e1e1;">INR 4500</td>
																<td class="indian-tariff" style="background-color: #e1e1e1;">1001 - 3000 Tickets OR <br />(01st June to 15th August)</td>
															</tr>
															<?php ?>
															<tr>

																<td class="indian-tariff" style="background-color: #e1e1e1;">INR 6500</td>
																<td class="indian-tariff" style="background-color: #e1e1e1;">3001– 4000 Tickets OR <br />(15th Aug to 17th Nov)</td>
															</tr>
															<?php ?>
															<tr>

																<td class="indian-tariff" style="background-color: #e1e1e1;">INR 10000</td>
																<td class="indian-tariff" style="background-color: #e1e1e1;">Spot Registration </td>
															</tr>
															<?php /*?><tr>
