	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d') <= '2024-11-21') { ?>
					<form action="exhibitor_payment_form_op2_up.php<?php echo !empty($ret) ? '?rt=' . $ret : ''; ?>"
									...
									<div class="tab-pane active">
												...
												<table class="table table-bordered tariff-table"
													...
													<thead>
														...
														<tr bgcolor="#2fa0dd" style="color: #fff;">
															...
															<th class="align-td" align="center" style="text-align:center;">
																...
																<?php
																if($assoc_nm == "IESA"){ ?>
																	<th class="align-td" align="center">IESA RATE @ 15% DISOCUNT</th> 
																<?php }
																?>
															 <!-- <th class="align-td" align="center">IESA RATE @ 15% DISOCUNT</th>  -->
													...
													<tbody>
														...
														<tr class="indian-tariff1" style="background-color: #e1e1e1;">
															...
															<td class="align-td" align="center">14000</td>
															<?php if($assoc_nm == "IESA"){ ?>
										...
										<div class="main-form">
											...
											$countryList = array(
												...
												'9s' => '9sqm (9sqm x Rs. 14,000) Shell Space = 1,26,000 + 18% GST',
												'12s' => '12sqm (12sqm x Rs. 14,000) Shell Space = 1,68,000 + 18% GST',
												// '15' => '15sqm (15sqm x Rs. 13,000) Raw Space = 1,95,000 + 18% GST',
												'15s' => '15sqm (15sqm x Rs. 14,000) Shell Space = 2,10,000 + 18% GST',
												// '18' => '18sqm (18sqm x Rs. 13,000) Raw Space = 2,34,000 + 18% GST',
												'18s' => '18sqm (18sqm x Rs. 14,000) Shell Space = 2,52,000 + 18% GST',
												// '27' => '27sqm (27sqm x Rs. 13,000) Raw Space = 3,51,000 + 18% GST',
												'27s' => '27sqm (27sqm x Rs. 14,000) Shell Space = 3,78,000 + 18% GST',
												//30sqm (30sqm x Rs13,000) Raw Space = 3,90,000 + 18% GST
												'30' => '30sqm (30sqm x Rs. 13,000) Raw Space = 3,90,000 + 18% GST',
												'36' => '36sqm (36sqm x Rs. 13,000) Raw Space = 4,68,000 + 18% GST',
												// '36s' => '36sqm (36sqm x Rs. 14,000) Shell Space = 5,04,000 + 18% GST',
												'48' => '48sqm (48sqm x Rs. 13,000) Raw Space = 6,24,000 + 18% GST',
												// '48s' => '48sqm (48sqm x Rs. 14,000) Shell Space = 6,72,000 + 18% GST',
												'54' => '54sqm (54sqm x Rs. 13,000) Raw Space = 7,02,000 + 18% GST',
												// '54s' => '54sqm (54sqm x Rs. 14,000) Shell Space = 7,56,000 + 18% GST',
												'72' => '72sqm (72sqm x Rs. 13,000) Raw Space = 9,36,000 + 18% GST',
												...
												'108' => '108sqm (108sqm x Rs. 13,000) Raw Space = 14,04,000 + 18% GST',
												'135' => '135sqm (135sqm x Rs. 13,000) Raw Space = 17,55,000 + 18% GST',
											...
											<div class="form-group">
												...
												<div class="col-md-6" style="margin-top: -15px;">
													...
													<span class="help-block">+Country Code-Area Code-Contact Number(Eg.
														91-123412345)</span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">Sales Executive Name <span
														style="font-size:10px;">&nbsp;(From BTS Team)</span> <span
														class="dips-required"> * </span></label>
												<div class="col-md-6">
				...
				<?php } else { ?>
					<h1><?php echo $assoc_nm; ?> Online Startup Registrations for
						<?php echo $EVENT_NAME . ' ' . $EVENT_YEAR; ?> is closed.</h1>
				<?php } ?>
			</div>
		</div>
	</div>
