    ...
    <tr>
      ...
      <td width='98%'  align='left' valign='top' bgcolor='#F5F7F6'><p class='style3'>Dear ".$res_vp_d['title']." ".$res_vp_d['fname'].",<br />
        ...
        <p><strong>Pass No.: ".$res_vp_d['pass_no']."</strong></p>        
          ...
          <p><strong>Day 1: </strong><strong>".$VSTR_DAY1_TIME_STUD."</strong></p>
          <p><strong>Day 2: </strong><strong>".$VSTR_DAY2_TIME_STUD."</strong></p>
          <p><strong>Day3: </strong><strong>".$VSTR_DAY3_TIME_STUD."</strong></p>
        <br/>
        Thanking You,
        </p>
