<?php
  ...
  if(empty($tin_no)) {
  	if((!isset($_SESSION["vercode_reg"]))||($_SESSION["vercode_reg"]==''))
  	{
  		...
  		echo "<script language='javascript'>window.location=('registration-del.php');</script>";
  		echo "<script language='javascript'>document.location=('registration-del.php');</script>";
  		exit;
  	}
  }
