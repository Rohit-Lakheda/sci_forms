...
<div id='container'>
		...
		<form id='form1' action='' method='post'>
		  <table width='100%'  cellspacing='0' cellpadding='0'>
            ...
            <tr>
              <td>&nbsp;</td>
              <td align='center' valign='middle'><a href='".$EVENT_WEBSITE_LINK."' target='_blank'><img src='".$EVENT_LOGO_LINK."' title='".$EVENT_NAME."' alt='".$EVENT_NAME."' border='0' align='middle' style='width: 40%;'/></a></td>
            </tr>
            <tr>
              <td width='3%'  align='left'>&nbsp;</td>
              <td width='98%'  align='left'><p class='style3'><br/>Dear ".$_POST['fname'].",<br />
               Thank you for your expression of interest for registering on spot. Request you to kindly carry this acknowledgement at the spot registration counter for us to process your registration.<br /><br />
                Thanking You,</p>
