	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_3">
			...
			<div class="portlet-body form">
				<form action="registration6_test.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_3" id="reg_registration_form_3" method="post" onsubmit="return validate_registration_form_3();">
											...
											<?php if($qr_gt_user_data_ans_row['nationality'] == "Indian Organization") { 	
											 ...
											 ?>
												<div class="md-radio international-tariff">
													<input type="radio" id="paypal" name="paymode" class="md-radiobtn" value="Paypal" checked>
													<label for="paypal">
													<span></span>
													<span class="check"></span>
