<?php
	...
	{ 
		...
		echo "<script language='javascript'>window.location = 'rsvp_registrations.php?cata_type=$cata_type&assoc_nm=$assoc_nm';</script>";
		exit;
	}
	...
	$spl_delegate_asso_type = $assoc_nm;	
	$nt_sele_mem_cnt=0;
	...
	if(@$_POST['reg_day_1'] != ""){
		...
		if($cata == ""){
			$cata = $_POST['reg_day_1'];		
		}
		else{
			$cata = $cata.$_POST['reg_day_1'];		
		}
	}
	...
	if(@$_POST['reg_day_2'] != ""){
		...
		if($cata == ""){
			$cata = $_POST['reg_day_2'];		
		}
		else{
			$cata = $cata.", ".$_POST['reg_day_2'];		
		}		
	}
	...
	mysqli_query($link,"insert into ".$EVENT_DB_FORM_REG_DEMO."(org,org_reg_type,nationality,cata,curr,gr_type,sub_delegates,paymode,pay_status,amt_ext,amt_per_del,selection_amt,total,reg_id,reg_date,reg_time,sp_msg,dollar,membership_name,ticket_type,addr1) values ('$org','$cata_m','$nationality','Complimentary','$curr','$grp','$total_dele','$paymode','$pay_status','$amt_ext','$rate_org','$amt','$amt','$reg_id','$ddate','$ttime','$temp_sess_sp_msg','$dollar','$spl_delegate_asso_type','$temp_ticket_type','$address')")or die(mysqli_error($link));
...
/*		if($res['org_reg_type'] == "Poster"){
	...
	/*if($total == 0)
	{
		...
		mysqli_query($link,"DELETE FROM ".$EVENT_DB_FORM_REG_DEMO." WHERE reg_id = '$reg_id'")or die(mysqli_error($link));
		session_destroy();
		echo "<script language='javascript'>window.location='rsvp_registrations.php?cata_type=$cata_type';</script>";
		exit;
	}*/
...
*/	
	...
	{	
			...
			if( ($title == "") || ($fname == "") || ($lname == "") || ($job_title == "") || ($badge == "") || ($email == "")  )
			{
				...
				echo "<script language='javascript'>window.location='reg_registrations5.php?cata_type=$cata_type&assoc_nm=$assoc_nm';</script>";
				exit;	
			}	
...
/*	if( ($res['cata']=="Industry - Single Day Delegate") || ($res['cata']=="GOVT., R&D & Faculty - Single Day Delegate") ){
	...
	//user	
		...
		switch($lmt)
		{
				case 1	:	$recipients = array('enquiry@bangaloreite.biz','accounts@mmactiv.in','test.interlinks@gmail.com','utsav.activ@gmail.com',$qr_gt_user_data_ans_row['email1']);
							break;
				case 3	:	$recipients = array('enquiry@bangaloreite.biz','accounts@mmactiv.in','test.interlinks@gmail.com','utsav.activ@gmail.com',$qr_gt_user_data_ans_row['email1'],$qr_gt_user_data_ans_row['email2'],$qr_gt_user_data_ans_row['email3']);
							break;
				case 4	:	$recipients = array('enquiry@bangaloreite.biz','accounts@mmactiv.in','test.interlinks@gmail.com','utsav.activ@gmail.com',$qr_gt_user_data_ans_row['email1'],$qr_gt_user_data_ans_row['email2'],$qr_gt_user_data_ans_row['email3'],$qr_gt_user_data_ans_row['email4']);
							break;
				case 5	:	$recipients = array('enquiry@bangaloreite.biz','accounts@mmactiv.in','test.interlinks@gmail.com','utsav.activ@gmail.com',$qr_gt_user_data_ans_row['email1'],$qr_gt_user_data_ans_row['email2'],$qr_gt_user_data_ans_row['email3'],$qr_gt_user_data_ans_row['email4'],$qr_gt_user_data_ans_row['email5']);
							break;
				case 6	:	$recipients = array('enquiry@bangaloreite.biz','accounts@mmactiv.in','test.interlinks@gmail.com','utsav.activ@gmail.com',$qr_gt_user_data_ans_row['email1'],$qr_gt_user_data_ans_row['email2'],$qr_gt_user_data_ans_row['email3'],$qr_gt_user_data_ans_row['email4'],$qr_gt_user_data_ans_row['email5'],$qr_gt_user_data_ans_row['email6']);
							break;
				case 7	:	$recipients = array('enquiry@bangaloreite.biz','accounts@mmactiv.in','test.interlinks@gmail.com','utsav.activ@gmail.com',$qr_gt_user_data_ans_row['email1'],$qr_gt_user_data_ans_row['email2'],$qr_gt_user_data_ans_row['email3'],$qr_gt_user_data_ans_row['email4'],$qr_gt_user_data_ans_row['email5'],$qr_gt_user_data_ans_row['email6'],$qr_gt_user_data_ans_row['email7']);
							break;
				
				default	:	$recipients = array('enquiry@bangaloreite.biz','accounts@mmactiv.in','test.interlinks@gmail.com','utsav.activ@gmail.com');
							break;			
		}
	...
	echo "<script language='javascript'>window.location = 'rsvp_3_registrations.php?nm=$name&enq_emler=rsvp&cata_type=$cata_type&assoc_nm=$assoc_nm';</script>";	
	exit;
