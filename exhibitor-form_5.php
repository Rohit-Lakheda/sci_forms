	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d') <= '2024-11-20') { ?>
					<form action="exhibitor-form2m.php" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" onsubmit="return validate_ex();" enctype="multipart/form-data">
								...
								<div class="tab-content">
									...
									<div class="form-group" id="other-div" style="display:none;">
												...
												<div class="input-group">
													<label class="input-group-btn">
														<span class="btn btn-primary">
															Choose Image&hellip; <input type="file" name="logo" id="logo" class="hide" required="required"  />
														</span>
													</label>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<textarea rows="9" cols="" class="form-control exbhi_profile" name="exbhi_profile" id="exbhi_profile" minlength="250"><?php echo $_SESSION['sess_exbhi_profile']; ?></textarea>
...
<script>
	...
	$(function() {
	  ...
	  // Count of character for textarea
		$('#addr1').keyup(function(e) {
			var tval = $('#addr1').val(),
				words = tval.trim().split(/\s+/),
				wordCount = words.length,
				set = 150,
				remain = set - wordCount;
			var htmlcount = "Word Count: " + wordCount + "/150";
			$('#limit-char1').text(htmlcount);
			if (remain <= 0 && e.which !== 0 && e.charCode !== 0) {
				$('#addr1').val(words.slice(0, set).join(" "));
			}
		});
