<?php
	...
	if(isset($_POST['make_payment'])) {
		...
		$mail->Subject    = "Thank you for exibitor registration on " . $EVENT_NAME . " " . $EVENT_YEAR;
		...
		$Subject    = "Thank you for exibitor registration on " . $EVENT_NAME . " " . $EVENT_YEAR;
	   ...
	   //$recipients = array('', 'test.interlinks@gmail.com','', 'mayuri.ladi@interlinks.in');
		...
		echo "<script language='javascript'>window.location = 'exhibitor-standard5.php?id=" . $qr_gt_user_data_ans_row['tin_no'] . "';</script>";
		exit;
