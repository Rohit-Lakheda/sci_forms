<?php
  ...
  if(empty($tin_no)) {
  	if((!isset($_SESSION["vercode_reg"]))||($_SESSION["vercode_reg"]==''))
  	{
  		...
  		echo "<script language='javascript'>document.location=('registration-premium.php');</script>";
  		exit;
  	}
  }
                ...
                <div class="tab-pane active">
                  ...
                  <div class="note note-danger">
                    ...
                    <p>Please DO NOT print this page. This page print not accepted in event.
                      <br />You need to click on <strong>Print</strong> button OR <a class="alert-link" href="reg_pay_1.php?id=<?php echo $qr_gt_user_data_ans_row['tin_no'];?>" target="_blank">Click here </a>to generate printable receipt.
                    </p>
                  </div>
                </div>
              </div>
