<?php
	...
	if(isset($_GET['id']) && !empty($_GET['id'])) {
		$qr_gt_user_data_id = mysqli_query($link,"SELECT * FROM ".$EVENT_DB_FORM_DRONE_RACING_DEMO." WHERE tin_no = '" . $_GET['id'] . "'");
	}
...
<?php require 'includes/reg_form_header.php';?>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered" id="registration_form_4">
                ...
                <div class="portlet-body form">
                    <form action="drone-racing4.php" class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">                    	
                                ...
                                <div class="tab-content">
									<div class="tab-pane active">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="well">
													<?php /*<div class="row static-info align-reverse">
    ...
    <script>
		...
		function go_back() {
			window.location=('drone-racing.php?ret=retds4fu324rn_ed24d3it');
		}
