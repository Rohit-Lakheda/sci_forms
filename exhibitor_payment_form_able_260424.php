...
if ($ret == "retds4fn324rn_ed24d3it") {
	...
	if ((!isset($_SESSION["vercode_ex"])) || ($_SESSION["vercode_ex"] == '')) {
		...
		echo "<script language='javascript'>window.location = ('exhibitor_payment_form_able.php');</script>";
		exit();
	}
		...
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d') <= '2024-11-19') { ?>
					<form action="exhibitor_payment_form_able2.php<?php echo !empty($ret) ? '?rt=' . $ret : ''; ?>" class="form-horizontal" name="exhibitors_form_1" id="exhibitors_form_1" method="post" enctype="multipart/form-data" onsubmit="return validate_ex();">
							...
							<div class="form-body">
								...
								<div class="tab-content">
									<div class="tab-pane active">
												...
												<table class="table table-bordered tariff-table" style="border: thin solid #dddddd; box-shadow: 5px 5px 5px 0 rgb(219, 219, 219);">
													<thead>
														<tr bgcolor="#E39101" style="color: #fff;">
															<th colspan="6" style="text-align: center;">Exhibition Tariff – ABLE PAVILION</th>
														</tr>
														<tr bgcolor="#2fa0dd" style="color: #fff;">
															<th class="align-td" style="display:none1;" align="center">OPTION</th>
															<th class="align-td" align="center">AREA (SQM)</th>
															<th class="align-td" align="center">RATE /SQM</th>
															<th class="align-td" align="center">AMOUNT(RS.)</th>
															<th class="align-td" align="center">SPECIAL OFFER TO ABLE MEMBERS</th>
															<th class="align-td" align="center">AMOUNT PAYABLE*(RS.)</th>
														</tr>
													</thead>
													<tbody>
														<tr class="indian-tariff" style="background-color: #e1e1e1;">
															...
															<td class="align-td" align="center">12,000</td>
															<td class="align-td" align="center">1,08,000</td>
															<td class="align-td" align="center">15%</td>
															<td class="align-td" align="center">91,800</td>
														</tr>
														<tr class="indian-tariff1" style="background-color: #e1e1e1;">
															<td class="align-td" align="center">2</td>
															<td class="align-td" align="center">18</td>
															<td class="align-td" align="center">12000</td>
															<td class="align-td" align="center">2,16,000</td>
															<td class="align-td" align="center">15%</td>
															<td class="align-td" align="center">1,83,600</td>
														</tr>
														<tr class="indian-tariff1" style="background-color: #e1e1e1;">
															<td class="align-td" align="center">3</td>
															<td class="align-td" align="center">36</td>
															<td class="align-td" align="center">11000</td>
															<td class="align-td" align="center">3,96,000</td>
															<td class="align-td" align="center">15%</td>
															<td class="align-td" align="center">3,36,600</td>
														</tr>
														...
														<tr>
															<td colspan="6">
																<p><strong>Note:</strong><br />
																	...
																	- Raw Space is subject to minimum of 36sqm</p>
																<?php /*?><p><strong>Entitlements</strong><br>
																	<strong><u>Each 9 Sqm Shell Space Booth:</u></strong><br />
																	...
																	&bull;&nbsp;Listing of Organization information in the Event Directory<br /><br />

																	
																	<strong><u>Raw Space is subject to minimum of 36sqm Note:</u></strong><br />
																	&bull;&nbsp;In case of bare space, only space will be provided.  Extra charges will be applicable for power, carpet or any other facility required.<br />
																	&bull;&nbsp;The booth should not be destructing the view or disturbing the aesthetics of any other co-exhibitor. Organiser holds the final right to stop/alter the design if needed.<br />
																	&bull;&nbsp;Four Complementary delegate registrations to access Inaugural Function, Plenary Talks, Technical Sessions in IT &amp;DeepTech, Start-Up, Biotech, GIA and India USA Tech conclave tracks, IT Export Awards, Smart Bio Awards and Start-up Unicorns Felicitation, Rural IT Quiz, Bio Quiz, Biotech Posters and B2B partnering etc.<br />
																	&bull;&nbsp;Eight Exhibitor Badges to manage the booth.<br />
										...
										<div class="main-form">
											...
											<div class="form-group form-md-radios">
												...
												<div class="col-md-9">
													<div class="md-radio-inline">
														<div class="md-radio">
															<input type="radio" id="booth_size1" name="booth_size" class="md-radiobtn" value="9 SQM">
															<label for="booth_size1">
																<span></span>
																<span class="check"></span>
																<span class="box"></span> 9 SQM
															</label>
														</div>
														<div class="md-radio" style="display:none1;">
															<input type="radio" id="booth_size2" name="booth_size" class="md-radiobtn" value="18 SQM">
															<label for="booth_size2">
																<span></span>
																<span class="check"></span>
																<span class="box"></span> 18 SQM
															</label>
														</div>
														<div class="md-radio" style="display:none1;">
															<input type="radio" id="booth_size3" name="booth_size" class="md-radiobtn" value="36 SQM">
															<label for="booth_size3">
																<span></span>
																<span class="check"></span>
																<span class="box"></span> 36 SQM
															</label>
														</div>
													</div>
												</div>
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Exhibitor Type<span class="dips-required"> * </span></label>
											<div class="col-md-6">
												<select id="user_type" name="user_type" class="form-control" onchange="showCertiDiv();" required="required">
													<option value="">- Select -</option>
													<option value="ABLE StartUp Exhibitor" <?php if (!empty($_SESSION['user_type']) && $_SESSION['user_type'] != 'ABLE Regular Exhibitor') echo 'selected=selected'; ?>>ABLE StartUp Exhibitor</option>
													<option value="ABLE Regular Exhibitor" <?php if (!empty($_SESSION['user_type']) && $_SESSION['user_type'] == 'ABLE Regular Exhibitor') echo 'selected=selected'; ?>>ABLE Regular Exhibitor</option>
												</select>
											</div>
										</div>
											<div class="form-group" id="certi_div">
												<label class="control-label col-md-3">Company Registration Certificate / Certificate of Incorporation<span class="required"> * </span>
												</label>
												<div class="col-md-6">
													<input type="file" id="ci_certf" name="ci_certf">
													<br>
													<strong>Note:</strong> <br>1. Certificate Should be in <strong>PDF format only</strong> <br>2. Certificate size should be <strong>less than 2MB</strong>
												</div>
											</div>
											<div class="form-group">
...
<script src="js/exhibitor-payment-able.js?546asd45"></script>
<script>
	...
	function showCertiDiv() {
		if (document.getElementById("user_type").value == "ABLE StartUp Exhibitor") {
			$('#certi_div').show();
			document.getElementById("ci_certf").value = "";
			$('#ci_certf').attr('required');

		} else {
			document.getElementById("ci_certf").value = "";
			$('#certi_div').hide();
			$('#ci_certf').removeAttr('required');
		}
	}
</script>
