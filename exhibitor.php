	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_1">
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d') <= '2025-11-19') { ?>
					<form action="exhibitor2.php?assoc_nm=<?php echo $assoc_nm; ?>" class="form-horizontal"
						name="exhibitors_form_1" id="exhibitors_form_1" method="post" onsubmit="return validate_ex();"
								...
								<div class="tab-content">
									<div class="tab-pane active">
										<div class="alert alert-info">
											<span class="block">Dear Sponsor/Exhibitor, <br />Please note: The details
												submitted through this form will be published in the Event Document. Please
												take necessary precaution to give the correct details.</span>
										</div>
										<?php if (!empty($assoc_nm)) { ?>
											<?php if ($assoc_nm == $ASSOC_NAME_EXHIBITOR) { ?>
												<h3><strong>Startup Innovation Zone</strong></h3><br />
												<div class="form-group">
													<label class="col-md-3 control-label">Sector <span class="dips-required"> *
														</span></label>
													<div class="col-md-6">
														<select id="exhi_profile" name="exhi_profile[]" class="form-control"
															required onchange="sectorChanged();">
												...
												<div class="form-group" id="other-div" style="display:none;">
													<label class="col-md-3 control-label">Specify Other Sector<span
															class="required"> * </span></label>
													<div class="col-md-6">
														<input type="text" class="form-control" name="exhi_profile-other"
															id="exhi_profile-other" />
													</div>
												</div>
											<?php } else { ?>
												<div class="form-group">
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Name of the Exhibitor <span
													style="font-size:10px;">&nbsp;<br />(Organisation Name)</span><span
										...
										if ($assoc_nm == $ASSOC_NAME_EXHIBITOR) {
											$area_type = "Booth Type";
											$area_drop = "Select Booth Type";
										}
										else {
											$area_type = "Enter Area in sqm";
											$area_drop =  "Select Booth Area";
										}
										
										?>
										<div class="form-group">
											<label class="col-md-3 control-label"><?php echo $area_type; ?> <span
													class="dips-required"> * </span></label>
											<div class="col-md-6">
												<?php if (!empty($assoc_nm)) { ?>
													<select id="booth_area" name="booth_area" class="form-control"
														required="required">
														<option value="">-- <?php echo $area_drop; ?> --</option>
														<?php $cataList = array(6);
														if ($assoc_nm == $ASSOC_NAME_EXHIBITOR) {
															$cataList = array("Startup Booth");
														}
														if ($assoc_nm == 'VoICE Consortium Pavilion') {
															$cataList = array(9);
														}
													...
													<input name="booth_area_unit" type="hidden" id="booth_area_unit"
														value="sqm">
												<?php } else { ?>
													<input class="form-control" name="booth_area" type="number" id="booth_area"
														maxlength="100" value="<?php echo $_SESSION['sess_booth_area']; ?>"
														required="required" onkeyup="check_num(event, 'booth_area');" />
													<input name="booth_area_unit" type="hidden" id="booth_area_unit"
														value="sqm">
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Organisation Address 1<span
													class="dips-required"> * </span></label>
											<div class="col-md-6">
												<textarea name="addr1" id="addr1" rows="" cols="" required="required"
													class="form-control"
													maxlength="150"><?php echo $_SESSION['sess_addr1']; ?></textarea>
												<span class="help-block"><span id="limit-char1">Character count
														0/150</span></span>
											</div>
										</div>
										<?php /*<div class="form-group">
										...
										<div class="form-group">
											<label class="control-label col-md-3">City<span class="dips-required"> *
												</span></label>
											<div class="col-md-3">
												<input type="text" class="form-control" name="city" id="city"
													value="<?php echo $_SESSION['sess_city']; ?>"
													onkeyup="check_char(event,'city');" required="required" />
											</div>
											<div class="col-md-1 col-md-offset-14" style="margin-top: 8px;">State<span
													class="dips-required"> * </span></div>
											<div class="col-md-2"><input type="text" class="form-control" name="state"
													id="state" value="<?php echo $_SESSION['sess_state']; ?>"
													required="required" onkeyup="check_char(event,'state');" /></div>
										</div>

										<div class="form-group">
											<label class="control-label col-md-3">Country<span class="dips-required"> *
												</span></label>
											<div class="col-md-3">
											...
											<div class="col-md-1 col-md-offset-15"
												style="font-size: 12px; margin-top: 8px;">Zip Code<span
													class="dips-required">*</span></div>
										...
										<div class="form-group">
											...
											<div class="col-md-6" style="margin-top: -15px;">
												...
												<input type="hidden" name="foneCountryCode" id="foneCountryCode"
													value="<?php echo @$_SESSION['sess_fon_cntry']; ?>" />
												<input type="hidden" id="foneCountryCodeIso" name="foneCountryCodeIso" />
												<input name="fon" type="text" id="fon" class="form-control" maxlength="20"
													value="<?php echo @$_SESSION['sess_fon']; ?>"
													onkeyup="check_num(event, 'fon');" style="padding-left: 92px;" />
											...
											<div class="col-md-6 col-md-offset-3">
												<div class="note note-success">
													...
													<p> If you have any technical problem, please contact our executive
														...
														<?php echo $EVENT_DB_FORM_TECHNICAL_PERSON_NAME; ?><br />
														Email: <a
															href="mailto:<?php echo $EVENT_DB_FORM_TECHNICAL_PERSON_EMAIL; ?>">
															<?php echo $EVENT_DB_FORM_TECHNICAL_PERSON_EMAIL; ?> </a><br />
				...
				<?php } else { ?>
					<h1>Online Exhibitors Directory Registrations for <?php echo $EVENT_NAME . ' ' . $EVENT_YEAR; ?> is
						closed.</h1>
				<?php } ?>
			</div>
		</div>
