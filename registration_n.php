...
if (($assoc_name == 'Shell%20Netherland%20Delegation') || ($assoc_name == 'Shell Netherland Delegation')) {
		...
		<div class="portlet light bordered" id="registration_form_1">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Delegate Registration Form <?php if ($assoc_name == "Tie Bengaluru charter members") {
																											echo  "with Special offer only for TiE Bangalore Charter Members @ Rs. 3K";
																												...
																												if ($assoc_name != "") {
																													if ($assoc_name == "Faculty") {
																														...
																														$assoc_name_disp = "with Special offer only for TiE Bangalore Charter Members @ Rs. 3K";
																													} else if ($assoc_name == "Tie Bengaluru charter members") {
																														$assoc_name_disp = "with Special offer only for TiE Bangalore Charter Members @ Rs. 3K";
																													} else {
			...
			<div class="portlet-body form">
				<?php if (date('Y-m-d H:i') <= '2024-12-01 13:00') { ?>
								...
								<div class="tab-content main-form-div" id="main-form-div">
									...
									<?php */ ?>
										<div class="form-group">
											<label class="control-label col-md-3"> Select Industry Sector <span class="required"> * </span>
											</label>
											<div class="col-md-6">
												<select id="sector" name="sector" class="form-control" required="required" onchange="showPayment();">
													...
													<?php } else { ?>
														...
														<?php $countryList = array('Information Technology' => 'Information Technology', 'Electronics' => 'Electronics', 'Biotechnology' => 'Biotechnology', 'Startup' => 'Startup', 'Academia & University (not for Student Only Faculty and HOD)' => 'Academia & University (not for Student Only Faculty and HOD)', 'Others' => 'Others');
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<select class="form-control" name="total_dele" id="total_dele" required>
													<?php $lmt = 7;
													if (isset($discountDetail['code']) && !empty($discountDetail['code']) && $discountDetail['code'] == 'WOF OLD') {
														$lmt = 1;
										...
										<?php if ($assoc_name == 'ABAI OLD' || $assoc_name == 'Spread OLD' || $assoc_name == 'KSRSAC OLD' || $assoc_name == 'TiE Bangalore OLD' || $assoc_name == 'YESSS Abstract Presenter OLD' || $assoc_name == 'KBITS OLD') { ?>
									...
									<?php */ ?>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
													...
													<table class="table table-striped table-hover1 table-bordered teriff-table">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
																...
																<?php /*<th colspan="1">REGISTRATION SLABS*</th>
														...
														<tr class="indian-tariff first-row">
															...
															<td colspan="2" class="success1">INR 3000 <?php /*<input name="cata" type="radio" class="hide" value="Full Delegate" id="cata1" />*/ ?></td>
												...
												<?php } else if ($assoc_name == "Tie Bengaluru charter members") { ?>
													<table class="table table-striped table-hover1 table-bordered teriff-table">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
																<th colspan="1">Catagory</th>
												...
												<?php } else if ($assoc_name == 'Program-Coordinators OLD') { ?>
													<table class="table table-striped table-hover1 table-bordered teriff-table">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
																<th colspan="1">Catagory</th>
												...
												<?php } else if ($assoc_name == 'Faculty OLD') { ?>
													<table class="table table-striped table-hover1 table-bordered teriff-table">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
																<th colspan="1">Catagory</th>
												...
												<?php } else if ($assoc_name == 'Student-Coordinator OLD') { ?>
													<table class="table table-striped table-hover1 table-bordered teriff-table">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
																<th colspan="1">Catagory</th>
												...
												<?php } else if ($assoc_name == 'UK-StartUps OLD') { ?>
													<table class="table table-striped table-hover1 table-bordered teriff-table">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
																<th colspan="1">Catagory</th>
												...
												<?php } else if ($assoc_name == 'Session-StartUps OLD') { ?>
													<table class="table table-striped table-hover1 table-bordered teriff-table">
														<thead>
															<tr bgcolor="#2fa0dd" style="color: #fff;">
																<th colspan="1">Catagory</th>
												...
												<?php } else { ?>
													<table class="table table-hover1 table-bordered teriff-table col-md-offset-1 col-md-7 main-tariff-table">
														...
														<tbody>
															<tr>
																<td class="indian-tariff" style="background-color: #e1e1e1;" rowspan="6">
																	<strong>INR 5000</strong>
																</td>
															</tr>
															<tr>
																<td class="indian-tariff" style="background-color: #e1e1e1;">INR 2500</td>
																<td class="indian-tariff" style="background-color: #e1e1e1;">01 – 1000 Tickets Or <br />(Upto 14th Sep)</td>
															</tr>
															<?php ?>
															<tr>

																<td class="indian-tariff" style="background-color: #e1e1e1;">INR 3000</td>
																<td class="indian-tariff" style="background-color: #e1e1e1;">1001 - 2000 Tickets OR <br />(05th Sept to 21st Nov)</td>
															</tr>
															<?php ?>
															<tr>

																<td class="indian-tariff" style="background-color: #e1e1e1;">INR 4000</td>
																<td class="indian-tariff" style="background-color: #e1e1e1;">2001– 3000 Tickets OR <br />(22nd Nov to 28th Nov)</td>
															</tr>
															<?php ?>
															<tr>

																<td class="indian-tariff" style="background-color: #e1e1e1;">INR 5000</td>
																<td class="indian-tariff" style="background-color: #e1e1e1;">3001 Tickets onwards OR <br />(Nov 29th onwards)</td>
															</tr>
															<?php /*?><tr>
															...
															<tr>
																<td class="international-tariff" style="background-color: #e1e1e1;">USD 300</td>

																<td class="international-tariff" style="background-color: #e1e1e1;">USD 250 <br /> (up to 1st Sept)</td>
																<td class="international-tariff" style="background-color: #e1e1e1;"><strong>INTERNATIONAL DELEGATES</strong> </td>
															</tr>
													...
													<?php /*<table class="table table-hover1 table-bordered teriff-table col-md-offset-1 col-md-7">
												<tbody>
													<tr bgcolor="#2fa0dd" style="color: #fff;">
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Organisation Name <span class="dips-required"> * </span><span id="gstorg"><br />(To create invoice in the name of)</span></label>
											<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="form-group">
											<label class="col-md-3 control-label">Do you need a GST based Invoice?<span class="dips-required"> * </span></label>
											<div class="col-md-6">
												<select id="is_gst_invoice_needed" name="is_gst_invoice_needed" class="form-control" onchange="showInvoiceData();" required>
													<option value="">--Select--</option>
													<option value="Yes" <?php echo (isset($_SESSION['is_gst_invoice_needed']) && $_SESSION['is_gst_invoice_needed'] == 'Yes' ? 'selected="selected"' : ''); ?>>Yes </option>
													<option value="No" <?php echo (isset($_SESSION['is_gst_invoice_needed']) && $_SESSION['is_gst_invoice_needed'] == 'No' ? 'selected="selected"' : ''); ?>>No </option>
												</select>
											</div>
										</div>
										<div id="gst-div">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea name="gst_inv_addr" id="gst_inv_addr" rows="" cols="" class="form-control"><?php echo (isset($_SESSION['gst_inv_addr']) ? $_SESSION['gst_inv_addr'] : ''); ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">Organisation GST Registration No<span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="gst_inv_reg_no" id="gst_inv_reg_no" value="<?php echo (isset($_SESSION['gst_inv_reg_no']) ? $_SESSION['gst_inv_reg_no'] : ''); ?>" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">Organisation Pan No<span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="gst_inv_pan" id="gst_inv_pan" value="<?php echo (isset($_SESSION['gst_inv_pan']) ? $_SESSION['gst_inv_pan'] : ''); ?>" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">State<span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="gst_inv_state" id="gst_inv_state" value="<?php echo (isset($_SESSION['gst_inv_state']) ? $_SESSION['gst_inv_state'] : ''); ?>" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">Contact Person Name <span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="gst_inv_cp" id="gst_inv_cp" value="<?php echo (isset($_SESSION['gst_inv_cp']) ? $_SESSION['gst_inv_cp'] : ''); ?>" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">Phone No <span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="text" class="form-control" name="gst_inv_phone" id="gst_inv_phone" value="<?php echo (isset($_SESSION['gst_inv_phone']) ? $_SESSION['gst_inv_phone'] : ''); ?>" onkeyup="checkPhoneNumber(event, 'gst_inv_phone');" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">Email Address <span class="dips-required"> * </span></label>
												<div class="col-md-6">
													<input type="email" class="form-control" name="gst_inv_email" id="gst_inv_email" value="<?php echo (isset($_SESSION['gst_inv_email']) ? $_SESSION['gst_inv_email'] : ''); ?>" />
												</div>
											</div>
										</div>
										<?php /*?><div class="form-group">
				...
				<?php } else { ?>
					<h1>Delegate Registration for Bengaluru Tech Summit 2023 has been Closed.
						Please Visit Website For Latest Updates.<br /><a href="https://bengalurutechsummit.com/" target="_blank"> (Click Here to Visit Website)</a><strong><?php //echo $EVENT_VENUE;
																																											?></strong>
					</h1>
				<?php } ?>
			</div>
