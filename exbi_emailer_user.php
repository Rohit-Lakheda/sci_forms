		  ...
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              ...
              <td valign='top' style='font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;'><span >Dear Sponsor/Exhibitor,<br />
                  <br />
We are thankful for your participation in ".$EVENT_NAME." ".$EVENT_YEAR.".
<br />
Thanks for submitting the form, we shall confirm the receipt of the details shortly.<br />
For any queries please contact us on <a href='mailto:".$EVENT_ENQUIRY_EMAIL."'>".$EVENT_ENQUIRY_EMAIL."</a><br />
<br />
...
<area shape='rect' coords='200,20,357,175' href='http://www.bangalorenano.in/' target='_blank' />
	...
	//<a href='".$EVENT_DB_COMP_LINK."?exhi=E34XH3IDf6gyy77&assoc_nm=$assoc_nm&exhibitor_id=$exhibitor_id_ex' target='_blank'>Click Here</a> for Complimentary delegate registrations.<br><br />
?>