<?php
	...
	{  
		...
		if(!empty($assoc_name)) {
			echo "<script language='javascript'>window.location = 'registration-premium-premium.php?en=$en&assoc_name=$assoc_name';</script>";
		} else {
	...
	<div class="col-md-12">
		<div class="portlet light bordered" id="registration_form_2">
			...
			<div class="portlet-body form">
				<form action="registration-premium4.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_2" id="reg_registration_form_2" method="post" onsubmit="return validate_registration_form_2();">
...
<script>var assoc_name = '<?php echo $qr_gt_user_data_ans_row['assoc_name'];?>';
	var a = '<?php echo $a;?>';
	var en='<?php echo $en;?>';
</script>
...
<script>
    ...
    function go_back11() {
    	...
    	if(assoc_name != '') {
    		...
    		window.location = ('registration-premium.php?ret=retds4fu324rn_ed24d3it' + assoc_nameurl + '&en=' + en);
    	} else {
    		if(a != '') {
    			a = '&a=' + a;		
    		}
    		window.location = ('registration-premium.php?ret=retds4fu324rn_ed24d3it' + a + assoc_nameurl + '&en=' + en);
    	}
