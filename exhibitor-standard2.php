<?php
	...
	$temp_del_fname = mysqli_real_escape_string($link,trim ( $temp_del_fname ));
	
	$temp_del_lname = @$_POST ['del_lname1'];
	$temp_del_lname = mysqli_real_escape_string($link,trim ( $temp_del_lname ));
	...
	$temp_del_fname2 = mysqli_real_escape_string($link,trim ( $temp_del_fname2 ));	
	$temp_del_lname2 = @$_POST ['del_lname2'];
	$temp_del_lname2 = mysqli_real_escape_string($link,trim ( $temp_del_lname2 ));
	...
	$temp_del_fname3 = mysqli_real_escape_string($link,trim ( $temp_del_fname3 ));
	$temp_del_lname3 = @$_POST ['del_lname3'];
	$temp_del_lname3 = mysqli_real_escape_string($link,trim ( $temp_del_lname3 ));
	...
	$temp_del_fname4 = mysqli_real_escape_string($link,trim ( $temp_del_fname4 ));
	$temp_del_lname4 = @$_POST ['del_lname4'];
	$temp_del_lname4 = mysqli_real_escape_string($link,trim ( $temp_del_lname4 ));
	...
	$temp_part_fname = mysqli_real_escape_string($link,trim ( $temp_part_fname ));
	
	$temp_part_lname = @$_POST ['part_lname'];
	$temp_part_lname = mysqli_real_escape_string($link,trim ( $temp_part_lname ));
	...
	if( ($temp_exhi_name == "") || ($temp_addr1 == "") || ($temp_city == "")  || ($temp_state == "")  || ($temp_country == "")  || ($temp_zip == "") || ($temp_email == "") || ($temp_del_title == "") || ($temp_del_fname == "") || ($temp_del_lname == "") || ($temp_del_email == "") || ($temp_del_mob == "")){
		...
		echo "<script language='javascript'>window.location = 'exhibitor-standard.php?rt=retds4fn324rn_ed24d3it';</script>";
		exit; 
	}
	...
	echo "<script language='javascript'>window.location = 'exhibitor-standard3.php';</script>";
	exit;
?>