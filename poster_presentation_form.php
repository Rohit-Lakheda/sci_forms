...
if ($ret == "retds4fu324rn_ed24d3it") {
	...
	if ((!isset($session_ver)) || ($session_ver == '')) {
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="portlet light bordered" id="enq_form_1">
			...
			<div class="portlet-body form">
				...
				<?php if (date('Y-m-d H:i') <= '2025-09-25 11:59') { ?>
							...
							<div class="form-body">
								...
								<div class="tab-content">
									...
									<div class="tab-pane active">
												...
												<table class="table table-hover1 table-bordered teriff-table col-md-offset-1 col-md-7 main-tariff-table">
													...
													<tbody>
														...
														<tr class="international-tariff" style="background-color: #e1e1e1;">
															...
															<td colspan="1" class="align-td">USD 50</td>
										...
										<div class="form-group form-md-radios" id="nom_gend">
											...
											<div class="col-md-8">
												...
												<div class="md-radio-inline" style="display: none;">
													...
													<input type="radio" name="theme" id="theme<?php echo $index; ?>" value="Breaking Boundaries" checked="checked" />
										...
										<label class="col-md-3 control-label">Abstract <span class="dips-required"> * </label>

										<div class="col-md-6">

											<textarea name="abstract_text" id="abstract_text" rows="5" cols="50" required="required" class="form-control" oninput="checkWordLimit(this, 250)" onkeydown="preventExcessWords(event, this, 250)"><?php if (isset($qr_gt_user_data_ans_row['abstract_text'])) echo htmlspecialchars($qr_gt_user_data_ans_row['abstract_text']); ?></textarea>

											<p id="word-count">Words: 0 / 250</p>
											...
											function checkWordLimit(textarea, limit) {
												...
												document.getElementById('word-count').textContent = 'Words: ' + wordCount + ' / ' + limit;

											}



											function preventExcessWords(event, textarea, limit) {

												var text = textarea.value.trim();

												var words = text.split(/\s+/);

												if (words.length >= limit && event.key !== 'Backspace' && event.key !== 'Delete') {
											...
											window.onload = function() {
												...
												checkWordLimit(document.getElementById('abstract_text'), 250);
    ...
    <label class="col-md-3 control-label">
        ...
        Abstract / Description of the Session (Limited to: 200 Words / 1 page) 
    ...
    <div class="col-md-6">
        ...
        <div class="input-group">
            ...
            <input type="file" id="sess_abstract" name="sess_abstract" class="form-control">

            <div class="input-group-append">

                <a href="/web/it_forms/upload1/Abstract_sample.docx" download="Sample_Abstract_Document.docx" class="btn btn-link">Download a sample of the abstract document follow the format strictly </a>
...
function show_cata() {
    ...
    const isIndian = document.getElementById("Indian").checked;
    ...
    $('.indian-tariff').toggle(isIndian);

    $('.international-tariff').toggle(isForeign);



    // Show/hide payment options

    const ccRadio = document.getElementById("Cc").closest('.md-radio');

    const paypalRadio = document.getElementById("paypal").closest('.md-radio');



    if (isIndian) {

        ccRadio.style.display = "block";

        paypalRadio.style.display = "none";

        document.getElementById("Cc").checked = true;

    } else if (isForeign) {

        ccRadio.style.display = "none";

        paypalRadio.style.display = "block";
