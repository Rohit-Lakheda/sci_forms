		...
		<div class="portlet light bordered" id="registration_form_4">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Exhibitor Registration
					</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="exhibitor_payment_form_op4.php" class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">
														...
														<table class="table table-striped table-bordered table-hover">
															<tbody>
																...
																<tr>
																	...
																	<td> <?php echo $qr_gt_user_data_ans_row['booth_area']; ?> </td>
																</tr>
																<tr>
																	<td> <strong>Booth Space</strong> </td>
																	<td> <?php echo $qr_gt_user_data_ans_row['booth_space']; ?> </td>
																</tr>
																<tr>
																	<td> <strong>Category </strong> </td>
																	<td> <?php echo $qr_gt_user_data_ans_row['delegate_type']; ?> </td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td> <?php echo $qr_gt_user_data_ans_row['tan_no']; ?> </td>
																<tr>
																...
																<tr>
																	...
																	<td> <?php echo $qr_gt_user_data_ans_row['sales_exec']; ?> </td>
																</tr>
																<?php /*
										                                            	<tr>
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									<a href="exhibitor_payment_form_op.php?rt=retds4fn324rn_ed24d3it" class="btn default">
