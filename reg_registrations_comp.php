<?php 
	...
	$qr_chk_exbhi_id = mysqli_query($link,$qr_chk_exbhi);
	$qr_chk_exbhi_ans_res = mysqli_fetch_array($qr_chk_exbhi_id);
	$total_del_comp = $qr_chk_exbhi_ans_res['total_exbhitors'];
...
<table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1" style=" margin-top:20px; margin-left:400px;">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><?php echo $EVENT_NAME; ?>: Online Complimentary Delegate Registration Form</div>
  ...
  <tr align="left" valign="top"> 
	...
	<?php ?><form action="reg_registrations2_comp.php?ret=<?php echo $ret; ?>&exhi=<?php echo $exhi;?>&exhibitor_id=<?php echo $exhibitor_id;?>" method="post" enctype="multipart/form-data" name="bio_registration_form_1" id="bio_registration_form_1" onSubmit="return validate_reg_registration_form_1()">
        ...
        <td height="291" align="left" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <input type="hidden" name="ticket_type" id="ticket_type" value="<?php echo $temp_ticket_type;?>" />
             <input  type="hidden" name="paymode" class="border_style1_1" id="Cc"  onclick="showTxt()" value="Complimentary" />
            </td>
          </tr>
          <?php 
		  if($exhi== "E34XH3IDf6gyy77"){
...
Request you to kindly fill the details of Complimentary Delegate Registration.<br></td>
        </tr>
    </table></td>
  </tr>
</table></td>
                                             ...
                                             <tr valign="middle">
                                               <td align="center"><table width="96%"  cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" border="1">
                                                 ...
                                                 <tr bgcolor="#FFFFEC">
												   ...
												   if(($assoc_nm != "") && ($exhi == "") ){
												   ?>
												   <input name="cata" type="radio" class="style56" value="Complimentary Exhibitors Delegate" id="cata1" onClick="show_div_user_grp_type()" disabled="disabled"   />
												    <?php 
												   }
												   elseif(($exhi != "") && ($assoc_nm == "")){
												   ?>
												   <input name="cata" type="radio" class="style56" value="Complimentary Exhibitors Delegate" id="cata1" onClick="show_div_user_grp_type()" checked="checked"  />
												   <?php 
												   }
												   else{
												   ?>
												    <input name="cata" type="radio" class="style56" value="Complimentary Exhibitors Delegate" id="cata1" onClick="show_div_user_grp_type()"   />
													<?php
												   }
												   ?>
												   </td>
                                                 ...
                                                 <tr bgcolor="#FFFFEC">
                                                   ...
                                                   <td align="center" valign="middle" bgcolor="#DDDDDD" class="black_text_no_padding_13px" ><input name="cata" type="radio" class="style56" value="Complimentary Sponsor Delegate" id="cata2" onClick="show_div_user_grp_type()"  <?php if(($assoc_nm != "") || ($exhi != "")){?> disabled="disabled" <?php } ?> /></td>
                                                 </tr>
                                                 <tr bgcolor="#FFFFEC">
                                                   <td height="35" align="center" valign="middle" bordercolor="#FFFFFF" bgcolor="#DDDDDD" class="black_text_no_padding_13px" >Speaker</td>
                                                   <td align="center" valign="middle" bgcolor="#DDDDDD" class="black_text_no_padding_13px" ><input name="cata" type="radio" class="style56" value="Complimentary Speaker Delegate" id="cata3" onClick="show_div_user_grp_type()"  <?php if(($assoc_nm != "") || ($exhi != "") ){?> disabled="disabled" <?php } ?> /></td>
                                                 </tr>
                                                 <tr bgcolor="#FFFFEC">
												   ...
												   if(($assoc_nm != "") && ($exhi == "")){
												   ?>
												   <input name="cata" type="radio" class="style56" value="Complimentary Invitee Delegate" id="cata4" onClick="show_div_user_grp_type()" checked="checked"  />
												   <?php 
												   }
												   elseif(($assoc_nm == "") && ($exhi != "")){
												   ?>
												   <input name="cata" type="radio" class="style56" value="Complimentary Invitee Delegate" id="cata4" onClick="show_div_user_grp_type()" disabled="disabled" />
												   <?php 
												   }
												   else{
												   ?>
												    <input name="cata" type="radio" class="style56" value="Complimentary Invitee Delegate" id="cata4" onClick="show_div_user_grp_type()"  />
												   <?php 
												   }
												   ?>
												   </td>
              ...
              <tr>
                <td width="100%" height="63" align="left"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="392" align="left" valign="top"><input name="total_dele" type="text" class="border_style1_1" id="total_dele" size="50" maxlength="1"  onkeyup="check_num(event,total_dele)" <?php if(($exhi != "")){?> value="<?php echo $total_del_comp;?>"<?php } ?>/></td>
                    </tr>
                    <tr>
