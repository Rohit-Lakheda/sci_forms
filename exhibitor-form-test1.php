...
<style>
	...
	.multiselect-clear-filter {background-color: #d5d5d5 !important;}
</style>
<div class="row">
	<div class="col-md-12">
							...
							<div class="tab-content">
								<div class="tab-pane active">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Name of the Exhibitor <span style="font-size:10px;">&nbsp;(Organisation Name)</span><span class="dips-required"> * </span></label>
										<div class="col-md-6">
                                    ...
                                    <div class="form-group">
										<div class="col-md-6 col-md-offset-3">
											<div class="note note-success">
												...
												<p>	If you have any issue filling exhibitor directory, please contact <br />
