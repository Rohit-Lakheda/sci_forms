									...
									<div class="tab-pane active">
											...
											<table class="table table-bordered tariff-table" style="border: thin solid #dddddd; box-shadow: 5px 5px 5px 0 rgb(219, 219, 219);">
												<thead>
													<tr bgcolor="#E39101" style="color: #fff;">
		                                            	<th colspan="6" style="text-align: center;">Exhibition Tariff – StartUp Innovation Zone</th>
													</tr>
													<tr  bgcolor="#2fa0dd" style="color: #fff;">
														<th class="align-td" style="display:none1;" align="center">OPTION</th>
														<th class="align-td" align="center">BOOTH SIZE(SQM)</th>
												...
												<tbody>
													<tr class="indian-tariff" style="background-color: #e1e1e1;" >
														...
														<td class="align-td" align="center">4</td>
										...
										<div class="main-form">
											<div class="form-group">
												<label class="control-label col-md-3"> Select Booth Size <span class="required"> * </span>
												</label>
												<div class="col-md-6">
													<select id="booth_size" name="booth_size" class="form-control" required="required">
														...
														/*
															,
															'108' => '108sqm (108sqm x Rs. 10,500) = 11,34,000 + 18% GST',
															'216' => '216sqm (216sqm x Rs. 11,400) = 24,62,400 + 18% GST'
														*/

														//$countryList = array('Information Technology'=>'Information Technology', 'Bio Technology'=>'Bio Technology');
														$countryList = array(
															'9' => '9sqm (9sqm x Rs, 12,000) = 1,08,000 + 18% GST',
															'9c' => '9sqm (9sqm x Rs, 12,000) corner stall 10% extra = 1,18,800 + 18% GST',
															'15' => '15sqm (15sqm x Rs. 12,000) = 1,80,000 + 18% GST',
															'18r' => '18sqm (18sqm x Rs. 11,000) Raw Stall = 1,98,000 + 18% GST',
															'18' => '18sqm (18sqm x Rs. 12,000) = 2,16,000 + 18% GST',
															'18c' => '18sqm (18sqm x Rs, 12,000) corner stall 10% extra = 2,37,600 + 18% GST',
															'27' => '27sqm (27sqm x Rs. 12,000) = 3,24,000 + 18% GST',
															'36' => '36sqm (36sqm x Rs. 11,000) = 3,96,000 + 18% GST',
															'36i' => '36sqm (36sqm x Rs. 12,000) = 4,32,000 + 18% GST',
															'48' => '48sqm (48sqm x Rs. 11,000) = 5,28,000 + 18% GST',
															'54' => '54sqm (54sqm x Rs. 11,000) = 5,94,000 + 18% GST',
															'72' => '72sqm (72sqm x Rs. 11,000) = 7,92,000 + 18% GST',
															'100' => '100sqm (100sqm x Rs. 11,000) = 11,00,000 + 18% GST'
														); //,'Digital Learning','Electronics','FinTech','Robo & Drone','Gaming','Mobility','IT Services','BioTech','AgriTech','MedTech','Healthtech','SmartTech','Cyber security & Human Resource','Other');
										...
										<div class="form-group">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">Sales Executive Name <span style="font-size:11px;">&nbsp;(From Bengaluru Tech Summit Team)</span> <span class="dips-required"> * </span></label>
												<div class="col-md-6">
