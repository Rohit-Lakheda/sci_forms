		...
		<div class="portlet light bordered" id="registration_form_2">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> STANDARD DELEGATE REGISTRATION (FREE)</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="registration-conference4.php?assoc_name=<?php echo $qr_gt_user_data_ans_row['assoc_name'];?><?php echo !empty($ret) ? '&ret=' . $ret : ''; ?>" class="form-horizontal" name="reg_registration_form_2" id="reg_registration_form_2" method="post" onsubmit="return validate_registration_form_2();">
...
<script>
	...
	function go_back11() {
    	...
    	if(assoc_name != '') {
    		...
    		window.location = ('registration-conference.php?ret=retds4fu324rn_ed24d3it' + assoc_nameurl + '&en=' + en);
    	} else {
    		if(a != '') {
    			a = '&a=' + a;		
    		}
    		window.location = ('registration-conference.php?ret=retds4fu324rn_ed24d3it' + a + assoc_nameurl + '&en=' + en);
    	}
    }
</script>
