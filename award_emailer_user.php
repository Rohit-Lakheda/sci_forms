<?php
	...
	$enq_rsvp_mail_msg_user = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
		...
		<form id='form1' action='' method='post'>
		  <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
              ...
              <td width='845' align='center' valign='top' class='style4'><a href='".$EVENT_WEBSITE_LINK."' target='_blank'><img src='".$EVENT_LOGO_LINK."' title='".$EVENT_NAME."' alt='".$EVENT_NAME."' border='0' align='middle'/></a></td>
            </tr>
            <tr>
            ...
            <tr>
              <td valign='top' style='font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;'>&nbsp;</td>
              <td valign='top' style='font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;'>Dear <strong>".$name." </strong>,
                <br>
                <br>
                  Thank you for submitting your information. We look forward to meeting you at BengaluruITE.biz 2016.<br/><br/>
                     Thank You,</p>
                     <p>Best Regards,<br/>BengaluruITE.BIZ Secretariat,<br/>"
