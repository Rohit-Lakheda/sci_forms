...
require "it_sec_meet_inv_reg_captcha.php";
$page = basename($_SERVER['SCRIPT_NAME']); 

//$IT_SEC_MEET_INV_REG_city = $_REQUEST['it_sec_meet_inv_reg_city'];
$IT_SEC_MEET_INV_REG_city = "Bangalore";
 ...
 <table width="675" border="0" cellpadding="0" cellspacing="0" class="border_style1" style=" margin-top:20px;" align="center">
  <tr align="left" valign="top">
    <td width="601" height="35">
      <div class="style2" style="margin-left:20px;"><strong class="small_button"><?php echo $EVENT_NAME;?> : </strong><strong>Invitation to attend IT Secretaries Meet</strong></div>
...
<form id="form1" name="form1" method="post" onsubmit="return validate_asscn_atndes_ceo()" action="it_sec_meet_inv_reg_2.php?enq_emler=<?php echo $emler?>">
	...
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="border_style2">
      <tr>
        <td height="291" align="left" valign="top"><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="631" height="16"><input type="hidden" name="it_sec_meet_inv_reg_city" id="it_sec_meet_inv_reg_city" value="<?php echo $IT_SEC_MEET_INV_REG_city;?>" /></td>
          </tr>
          <tr>
