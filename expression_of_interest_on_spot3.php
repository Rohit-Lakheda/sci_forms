<?php 
	...
	if((!isset($_SESSION["vercode_exp"]))||($_SESSION["vercode_exp"]==''))
	{
		session_destroy();
			...
			<div class="page-container">
	            ...
	            <div class="page-content-wrapper">
	                ...
	                <div class="page-content dips-page-content">
	                    <!-- BEGIN PAGE TITLE-->
	                    <h3 class="page-title"> <strong>Bengaluru ITE.BIZ 2016:</strong>&nbsp;Expression of Interest Form for Registering On Spot </h3>
	                    <!-- END PAGE TITLE-->
	                    <!-- END PAGE HEADER-->
	                    <div class="row">
	                        <div class="col-md-12">
	                                                ...
	                                                <div class="tab-content">
														<div class="tab-pane active">
															<div class="note note-success">
						                                        <h5 class="block">Thank you for your expression of interest for registering on spot. Request you to kindly carry this acknowledgement at the spot registration counter for us to process your registration.</h5>
