<?php
$assoc_logo = '&nbsp;';
if(!empty($res['user_type']) && $res['user_type'] == 'BTSFI') {
	$assoc_logo = '<img src="https://bengalurutechsummit.com/web/it_forms/images/BTSFI.png?asdfasdf" title="Bengaluru Tech Summit 2019" alt="Bengaluru Tech Summit 2019" width="50%" border="0" align="middle">';
}
...
if(!empty($res['user_type'])) {
	$mail_body .= "<tr bgcolor='#FFFFFF'>
            <td width='23%' height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;Assocication Name</td>
...
if(!empty($res['booth_size'])) {
	$mail_body .= "<tr bgcolor='#FFFFFF'>
            ...
            <td height='22' align='center' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>:</td>
            <td width='75%' height='22' align='left' valign='middle' bgcolor='#F9F8F2'  style='font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;'>&nbsp;".$res['booth_size']."</td>
          </tr>";
}
