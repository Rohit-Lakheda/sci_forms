		...
		<div class="portlet light bordered" id="registration_form_4">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-red bold uppercase"> Exhibitor Registration For NAIN Colleges
					</span>
				</div>
			</div>
			<div class="portlet-body form">
				<form action="exhibitor_payment_form_nain4.php" class="form-horizontal" name="reg_registration_form_4" id="reg_registration_form_4" method="post" onsubmit="return validate_registration_form_4()">
						...
						<div class="form-actions">
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									<a href="exhibitor_payment_form_nain.php?rt=retds4fn324rn_ed24d3it" class="btn default">
