								...
								<div class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                    	...
                                    	<div class="col-md-6">
                                    		...
                                    		<span class="help-block">(If you don't belong to any organization then write 'Not Applicable')</div>
                                    	</div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                    	...
                                    	<div class="col-md-6">
                                    		...
                                    		<br>
                                    		Note: <br>1. Photos dimension should be <strong>width:400px & height: 400px</strong><br>2. Photos size should be <strong>less than 1MB</strong>
                                    	</div>
                                    </div>
                                    <div class="form-group">
                                    	...
                                    	<div class="col-md-6">
                                    		...
                                    		<span class="help-block"><?php /*?>Total word count: <span id="display_count">0</span> words.<?php */?> Maximum Profile characters Limit : <span id="word_left">750</span></span>
                                    	</div>
                                    </div>
                                    <?php /*?>
                                    <div class="form-group">
