...
function go_back(){
	...
	window.location=('reg_registrations_comp.php?ret=retds4fu324rn_ed24d3it');
}
...
<?php ?>	
<form action="reg_registrations4_comp.php?exhi=<?php echo $exhi;?>&exhibitor_id=<?php echo $exhibitor_id;?>" method="post" enctype="multipart/form-data" name="bio_registration_form_3" id="bio_registration_form_3" onSubmit="return validate_bio_registration_form_3()">
