...
$ses_ver = mysqli_real_escape_string($link, htmlspecialchars($_SESSION['vercode_ex']));
...
if (isset($_POST['make_payment'])) {
	...
	//$recipients = array('test.interlinks@gmail.com', $EVENT_ENQUIRY_EMAIL, 'ambika.kiran@mmactiv.com', 'chandrachood.as@mmactiv.com', $res['cp_email'], 'vibha.kalasi@mmactiv.com', 'adarsh.accounts@mmactiv.com');

	$recipients = array('test.interlinks@gmail.com', 'sathyakanth.manukar@mmactiv.com','sanjeevbrao@gmail.com');
	...
	// $mail->Subject = "For Invoice Information, Thank you for Initiating Exhibitor registration on " . $EVENT_NAME . " " . $EVENT_YEAR;
	...
	$Subject = "For Invoice Information, Thank you for Initiating Exhibitor registration on " . $EVENT_NAME . " " . $EVENT_YEAR;
	...
	echo "<script language='javascript'>window.location = ('exhibitor_payment_form_op5_no_pg.php?id=" . $qr_gt_user_data_ans_row['tin_no'] . "');</script>";
	...
	*/
	...
	//echo "<script language='javascript'>window.location = 'exhibitor_payment_form_op5.php?id=" . $qr_gt_user_data_ans_row['tin_no'] . "';</script>";
	...
	// $mail->Subject = "Thank you for Exhibitor registration on " . $EVENT_NAME . " " . $EVENT_YEAR;
